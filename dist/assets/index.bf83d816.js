var Za=Object.defineProperty;var es=(e,t,n)=>t in e?Za(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var ts=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports);var we=(e,t,n)=>(es(e,typeof t!="symbol"?t+"":t,n),n);var gy=ts((by,mn)=>{const ns=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function n(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerpolicy&&(a.referrerPolicy=o.referrerpolicy),o.crossorigin==="use-credentials"?a.credentials="include":o.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(o){if(o.ep)return;o.ep=!0;const a=n(o);fetch(o.href,a)}};ns();var is=[{number:1,name:"Chien",description:"The Creative",trigrams:{above:{title:"chien",description:"THE CREATIVE, HEAVEN"},below:{title:"chien",description:"THE CREATIVE, HEAVEN"}},interpretation:{oracle:`	Works sublime success,
	Furthering through perseverance.`,resume:`The first hexagram is made up of six unbroken lines. These unbroken lines 
...
awakens and develops their higher nature.
	`,judgment:`According to the original meaning, the attributes (sublimity, potentiality of 
...
rain does its work, and all individual beings flow into their forms."  Applies to the human world, these attributes show the great man the way to 
...
does it show itself to further through perseverance."  In relation to the human sphere, this shows how the great man brings peace 
and security to the world through his activity in creating order: "He towers 
high above the multitude of beings, and all lands are united in peace."  Another line of speculation goes still further in separating the words 
...
broached in the commentary called W\xEAn Yen , later formed the bridge 
...
thought opened the way for an increasingly intricate number symbolism.
	`,image:{oracle:`The movement of heaven is full of power. 
	Thus the superior man makes himself strong and 
	untiring.`,image:`Since there is only one heaven, the doubling of the trigram Ch'ien, of which 
...
Arrogant dragon will have cause to repent.`,expl:"When a man seeks to climb so high that he loses touch with the rest of mankind, he becomes isolated, and this necessarily leads to failure. This line warns against titanic aspirations that exceed one's power. A precipitous fall would follow. 	When all the lines are nines, it means:"}]}},{number:2,name:"Kun",description:"The Receptive",trigrams:{above:{title:"kun",description:"THE RECEPTIVE, EARTH"},below:{title:"kun",description:"THE RECEPTIVE, EARTH"}},interpretation:{oracle:`	Brings about sublime success,
	...
	Quiet perseverance brings good fortune.`,resume:`This hexagram is made up of broken lines only. The broken lines represents 
...
evil to both.
	`,judgment:`The four fundamental aspects of the Creative\u2014"sublime success, furthering 
...
hates and favoritism.
	`,image:{oracle:`	The earth's condition is receptive devotion.
	Thus the superior man who has breadth of character
	Carries the outer world.`,image:`Just as there is only one heaven, so too there is only one earth. In the 
...
support and to bear with people and things.
		`},lines:[{poem:`Six at the beginning means:
When there is hoarfrost underfoot,
Solid ice is not far off.`,expl:"Just as the light-giving power represents life, so the dark power, the shadowy, represents death. When the first hoarfrost comes in the autumn, the power of darkness and cold is just at its beginning. After these first warnings, signs of death will gradually multiply, until, in obedience to immutable laws, stark winter with its ice is here.  In life it is the same. After certain scarcely noticeable signs of decay have appeared, they go on increasing until final dissolution comes. But in life precautions can be taken by heeding the first signs of decay and checking them in time."},{poem:`\xB0Six in the second place means:
Straight, square, great.
Without purpose,
Yet nothing remains unfurthered.`,expl:"The symbol of heaven is the circle, and that of earth is the square. Thus squareness is a primary quality of the earth. On the other hand, movement in a straight line, as well as magnitude, is a primary quality of the Creative. But all square things have their origin in a straight line and into turn form solid bodies. In mathematics, when we discriminate between lines, planes and solids, we find that rectangular planes result from straight lines, and cubic magnitudes from rectangular planes. The Receptive accommodates itself to the qualities of the Creative and makes them its own. Thus a square develops out of a straight line and a cube out of a square. This is compliance with the laws of the Creative; nothing is taken away, nothing added. Therefore the Receptive has no need of a special purpose of its own, nor of any effort' yet everything turns out as it should.  Nature creates all beings without erring: this is its foursquareness. It tolerates all creatures equally: this is its greatness. Therefore it attains what is right for all without artifice or special intentions. Man achieves the height of wisdom when all that he does is as self-evident as what nature does."},{poem:`Six in the third place means:
Hidden lines.
One is able to remain persevering.
If by chance you are in the service of a king,
Seek not works, but bring to completion.`,expl:"If a man is free of vanity he is able to conceal his abilities and keep them from attracting attention too soon; thus he can mature undisturbed.  If conditions demand it, he can also enter public life, but that too he does with restraint. The wise man gladly leaves fame to others. He does not seek to have credited to himself things that stand accomplished, but hopes to release active forces; that is, he completes his works in such a manner that they may bear fruit for the future."},{poem:`Six in the fourth place means:
A tied-up sack. No blame, no praise.`,expl:"The dark element opens when it moves and closes when at rest. The strictest reticence is indicated here. The time is dangerous , because any degree of prominence leads either to the enmity of irresistible antagonists if one challenges them or to misconceived recognition if one is complaisant. Therefore a man ought to maintain reserve, be it in solitude or in the turmoil of the world, for there too he can hide himself so well that no one knows him."},{poem:`Six in the fifth place means:
A yellow lower garment brings supreme good fortune.`,expl:"Yellow is the color of the earth and of the middle; it is the symbol of that which is reliable and genuine. The lower garment is inconspicuously decorated\u2014the symbol of aristocratic reserve. When anyone is called upon to work in a prominent but not independent position, true success depends on the utmost discretion. A man's genuineness and refinement should not reveal themselves directly; they should express themselves only indirectly as an effect from within."}]}},{number:3,name:"Chun",description:"Difficulty at the Beginning",trigrams:{above:{title:"kan",description:"THE ABYSMAL, WATER"},below:{title:"chen",description:"THE AROUSING, THUNDER"}},interpretation:{oracle:`	Works supreme success,
	Furthering through perseverance.
	Nothing should be undertaken.
	It furthers one to appoint helpers.`,resume:`The name of the hexagram, Chun, really connotes a blade of grass pushing 
...
which is beset with difficulties. The lower trigram Ch\xEAn is the Arousing; its 
...
release from tension, and all things breathe freely again.
	`,judgment:`Times of growth are beset with difficulties. They resemble a first birth. But 
...
participate with inspiration and guidance.
	`,image:{oracle:`	Clouds and thunder:
	The image of DIFFICULTY AT THE BEGINNING.
	Thus the superior man
	Brings order out of confusion.`,image:`Clouds and thunder are represented by definite decorative lines; this means 
...
progress, and success is attained.
	`,judgment:`In the time of youth, folly is not an evil. One may succeed in spite of it, 
...
counsels the teacher as well as the pupil.
	`,image:{oracle:`	A spring wells up at the foot of the mountain:
	The image of YOUTH.
	Thus the superior man fosters his character
	By thoroughness in all that he does.`,image:`A spring succeeds in flowing on and escapes stagnation by filling up all the 
...
To go on in this way bring humiliation.`,expl:"Law is the beginning of education. Youth in its inexperience is inclined at first to take everything carelessly and playfully.  It must be shown the seriousness of life. A certain measure of taking oneself in hand, brought about by strict discipline, is a good thing. He who plays with life never amounts to anything. However, discipline should not degenerate into drill. Continuous drill has a humiliating effect and cripples a man's powers."},{poem:`Nine in the second place means:
To bear with fools in kindliness brings good fortune.
To know how to take women
Brings good fortune.
The son is capable of taking charge of the household.`,expl:"These lines picture a man who has no external power, but who has enough strength of mind to bear his burden of responsibility. He has the inner superiority and that enable him to tolerate with kindliness the shortcomings of human folly. The same attitude is owed to women as the weaker sex. One must understand them and give them recognition in a spirit of chivalrous consideration. Only this combination of inner strength with outer reserve enables one to take on the responsibility of directing a larger social body with real success."},{poem:`Six in the third place means:
Take not a maiden who. When she sees a man of bronze,
Loses possession of herself.
Nothing furthers.`,expl:"A weak, inexperienced man, struggling to rise, easily loses his own individuality when he slavishly imitates a strong personality of higher station. He is like a girl throwing herself away when she meets a strong man. Such a servile approach should not be encouraged, because it is bad both for the youth and the teacher. A girl owes it to her dignity to wait until she is wooed. In both cases it is undignified to offer oneself, and no good comes of accepting such an offer."},{poem:`Six in the fourth place means:
Entangled folly bring humiliation.`,expl:"	For youthful folly it is the most hopeless thing to entangle itself in empty imaginings. The more obstinately it clings to such unreal fantasies, the more certainly will humiliation overtake it. Often the teacher, when confronted with such entangled folly, has no other course but to leave the fool to himself for a time, not sparing him the humiliation that results. This is frequently the only means of rescue."},{poem:`Six in the fifth place means:
Childlike folly brings good fortune. `,expl:"An inexperienced person who seeks instruction in a childlike and unassuming way is on the right path, for the man devoid of arrogance who subordinated himself to his teacher will certainly be helped."}]}},{number:5,name:"Hs\xFC",description:"Waiting",trigrams:{above:{title:"kan",description:"THE ABYSMAL, WATER"},below:{title:"chien",description:"THE CREATIVE, HEAVEN"}},interpretation:{oracle:`	If you are sincere, 
	You have light and success.
	Perseverance brings good fortune.
	It furthers one to cross the great water.`,resume:`All beings have need of nourishment from above. But the gift of food comes 
...
in the face of danger grows agitated and has not the patience to wait.
	`,judgment:`Waiting is not mere empty hoping. It has the inner certainty of reaching the 
...
decision and of surmounting the danger.
	`,image:{oracle:`	Clouds rise up to heaven:
	The image of WAITING.
	Thus the superior man eats and drinks,
	Is joyous and of good cheer. `,image:`When clouds rise in the sky, it is a sign that it will rain. There is nothing to 
...
person of this character will certainly be quarrelsome.
	`,judgment:`Conflict develops when one feels himself to be in the right and runs into 
...
conquer danger without.
	`,image:{oracle:`	Heaven and water go their opposite ways:
	The image of CONFLICT.
	Thus in all his transactions the superior man
	Carefully considers the beginning.`,image:`The image indicates that the causes of conflict are latent in the opposing 
...
maintains obedience in the army by his authority.
	`,judgment:`An army is a mass that needs organization in order to become a fighting force.  
...
as a last recourse.
	`,image:{oracle:`	In the middle of the earth is water:
	The image of THE ARMY.
	Thus the superior man increases his masses
	By generosity toward the people.`,image:`Ground water is invisibly present within the earth. In the same way the 
...
If the order is not good, misfortune threatens.`,expl:"At the beginning of a military enterprise, order is imperative. A just and valid cause must exist, and the obedience and coordination of the troops must be well organized, otherwise the result is inevitably failure."},{poem:`Nine in the second place means:
In the midst of the army.
Good fortune. No blame.
The king bestows a triple decoration.`,expl:`The leader should be in the midst of his army, in touch with it, sharing good and bad with the masses he leads. This alone makes him equal to the heavy demands made upon him. He needs also the recognition of the ruler. The decorations he receives are justified, because there is no question of personal preferment here: the whole army, whose center he is, is honored in his person. 	Six in the third place means:	Perchance the army carries corpses in the wagon.	Misfortune.Here we have a choice of two explanations. One points to defeat because someone other than the chosen leader interferes with the command; the other is similar in its general meaning, but the expression, "carries corpses in the wagon," is interpreted differently. At burials and at sacrifices to the dead it was customary in China for the deceased to whom the sacrifice was made to be represented by a boy of the family, who sat in the dead man's place and was honored as his representative. On the basis of this custom the text is interpreted as meaning that a "corpse boy" is sitting in the wagon, or, in other words, that authority is not being exercised by the proper leaders but has been usurped by others. Perhaps the whole difficulty clears up if it is inferred that there has been an error in copying. The character fan, meaning "all," may have been misread as shih, which means "corpse." Allowing for this error, the meaning would be that if the multitude assumes leadership of the army (rides in the wagon), misfortune will ensue.`},{poem:`Six in the fourth place means:
The army retreats. No blame.`,expl:"In the face of a superior enemy, with whom it would be hopeless to engage in battle, an orderly retreat is the only correct procedure, because it will save the army from defeat and disintegration. It is by no means a sign of courage or strength to insist upon engaging in a hopeless struggle regardless of circumstances."},{poem:`Six in the fifth place means:
There is game in the field.
It furthers one to catch it.
Without blame.
Let the eldest lead the army.
The younger transports corpses;
Then perseverance brings misfortune.`,expl:"Game is in the field\u2014it has left its usual haunts in the forest and is devastating the fields. This points to an enemy invasion. Energetic combat and punishment are here thoroughly justified, but they must not degenerate into a wild melee in which everyone fends for himself. Despite the greatest degree of perseverance and bravery, this would lead to misfortune. The army must be directed by an experienced leader. It is a matter of waging war, not of permitting the mob to slaughter all who fall into their hands; if they do, defeat will be the result, and despite all perseverance there is danger of misfortune."}]}},{number:8,name:"Pi",description:"Union",trigrams:{above:{title:"kan",description:"THE ABYSMAL, WATER"},below:{title:"kun",description:"THE RECEPTIVE, EARTH"}},interpretation:{oracle:`	Holding together brings good fortune.
	Inquire of the oracle once again
	Whether you possess sublimity, constancy, and perseverance;
	Then there is no blame.
	Those who are uncertain gradually join.
	Whoever come too late
	Meets with misfortune.`,resume:`The waters on the surface of the earth flow together wherever they can, as for 
...
nature.
	`,judgment:`What is required is that we unite with others, in order that all may 
...
other organic fellowship.
	`,image:{oracle:`	On the earth is water:
	The image of HOLDING TOGETHER.
	Thus the kings of antiquity
	Bestowed the different states as fiefs
	And cultivated friendly relations
	With the feudal lords.`,image:`Water fills up all the empty places on the earth and clings fast to it. The social 
...
Truth, like a full earthen bowl"Thus in the end
Good fortune comes from without.`,expl:"Fundamental sincerity is the only proper basis for forming relationships. This attitude, symbolized by a full earthen bowl, in which the content is everything and the empty form nothing, shows itself not in clever words but through the strength of what lies within the speaker. This strength is so great that it has power to attract good fortune to itself from without."},{poem:`Six in the second place means:
Hold to him inwardly.
Perseverance brings good fortune.`,expl:"	If a person responds perseveringly and in the right way to the behests from above that summon him to action, his relations with others are intrinsic and he does not lose himself. But if a man seeks association with others as if he were an obsequious office hunter, he throws himself away. He does not follow the path of the superior man, who never loses his dignity."},{poem:`Six in the third place means:
You hold together with the wrong people.`,expl:"We are often among people who do not belong to our own sphere. In that case we must beware of being drawn into false intimacy through force of habit. Needless to say, this would have evil consequences. Maintaining sociability without intimacy is the only right attitude toward people, because otherwise we should not be free to enter into relationship with people of our own kind later on."},{poem:`Six in the fourth place means:
Hold to him outwardly also.
Perseverance brings good fortune.`,expl:"Here the relations with a man who is the center of union are well established. Then we may, and indeed we should, show our attachment openly. But we must remain constant and not allow ourselves to be led astray."}]}},{number:9,name:"Hsiao Chu",description:"The Taming Power of the Small",trigrams:{above:{title:"sun",description:"THE GENTLE, WIND"},below:{title:"chien",description:"THE CREATIVE, HEAVEN"}},interpretation:{oracle:`	Has success.
	Dense clouds, no rain from our western region.`,resume:`This hexagram means the force of the small\u2014the power of the shadowy\u2014that 
...
only through gentleness that this can have a successful outcome.
	`,judgment:`This image refers to the state of affairs in China at the time when King W\xEAn, 
...
arrived. King W\xEAn could only keep the tyrant somewhat in check by friendly 
...
in external relations.
	...
	The image of THE TAMING POWER OF THE SMALL.
 	...
 	Thus the superior man
	Refines the outward aspect of his nature.`,image:`The wind can indeed drive the clouds together in the sky; yet, being nothing 
...
Good fortune.`,expl:"It lies in the nature of a strong man to press forward. In so doing he encounters obstructions. Therefore he returns to the way suited to his situation, where he is free to advance or to retreat. In the nature of things this will bring good fortune, for it is wise and reasonable not to try to obtain anything by force."},{poem:`Nine in the second place means:
He allows himself to be drawn into returning.
Good fortune.`,expl:"One would like to press forward, but before going farther one sees from the example of others like oneself that this way is blocked. In such a case, if the effort to push forward is not in harmony with the time, a reasonable and resolute man will not expose himself to a personal rebuff, but will retreat with others of like mind. This brings good fortune, because he does not needlessly jeopardize himself."},{poem:`Nine in the third place means:
The spokes burst out of the wagon wheels.
Man and wife roll their eyes.`,expl:"	Here an attempt is made to press forward forcibly, in the consciousness that the obstructing power is slight. But since, under the circumstances, power actually lies with the weak, this sudden offensive is doomed to failure. External conditions hinder the advance, just as loss of the wheel spokes stops the progress of a wagon. We do not yet heed this hint form fate, hence there are annoying arguments like those of a married couple. Naturally this is not a favorable state of thing, for though the situation may enable the weaker side to hold its ground, the difficulties are too numerous to permit of a happy result. In consequence even the strong man cannot so use his power as to exert the right influence on those around him. He experiences a rebuff where he expected an easy victory, and he thus compromises his dignity."},{poem:`\xB0Six in the fourth place means:
If you are sincere, blood vanishes and fear gives way.
No blame.`,expl:"	If one is in the difficult and responsible position of counselor to a powerful man, on should restrain him in such a way that the threat of actual bloodshed may arise. Nonetheless, the power of disinterested truth is greater than all theses obstacles. It carries such weight that the end is achieved, and all danger of bloodshed and all fear disappear."}]}},{number:10,name:"L\xFC",description:"Conduct",trigrams:{above:{title:"chien",description:"THE CREATIVE, HEAVEN"},below:{title:"tui",description:"THE JOYOUS, LAKE"}},interpretation:{oracle:`	Treading upon the tail of the tiger.
	It does not bite the man. Success.`,resume:`The name of the hexagram means on the one hand the right way of 
...
takes it all in good part.
	`,judgment:`The situation is really difficult. That which is strongest and that which is 
...
Pleasant manners succeed even with irritable people.
	`,image:{oracle:`	Heaven above, the lake below:
	The image of TREADING.
	Thus the superior man discriminates between high and low,
	And thereby fortifies the thinking of the people.`,image:`Heaven and the lake show a difference of elevation that inheres in the 
...
criterion of external rank, people acquiesce and order reigns in society.
		`},lines:[{poem:`Nine at the beginning means:
Simple conduct. Progress without blame.`,expl:"The situation is one in which we are still not bound by any obligations of social intercourse. If our conduct is simple, we remain free of them We can quietly follow our predilections as long as we are content and make not demands on people.  The meaning of the hexagram is not standstill but progress. A man finds himself in an altogether inferior position at the start. However, he has the inner strength that guarantees progress. If he can be content with simplicity, he can make progress without blame. When a man is dissatisfied with modest circumstances, he is restless and ambitious and tries to advance, not for the sake of accomplishing anything worth while, but merely in order to escape from lowliness and poverty by dint of his conduct. Once his purpose is achieved, he is certain to become arrogant and luxury-loving. Therefore blame attaches to his progress. On the other hand, a man who is good at his work is content to behave simply. He wishes to make progress in order to accomplish something. When he attains his goal, he does something worth while, an all is well."},{poem:`Nine in the second place means:
Treading a smooth, level course.
The perseverance of a dark man
Brings good fortune.`,expl:"The situation of a lonely sage is indicated here. He remains withdrawn from the bustle of life, seeks nothing, asks nothing of anyone, and travels through life unassailed, on a level road. Since he is content and does not challenge fate, he remains free of entanglements."},{poem:`\xB0Six in the third place means:
A one-eyed man is able to see,
A lame man is able to tread.
He treads on the tail of the tiger.
The tiger bites the man.
Misfortune.
Thus does a warrior act on behalf of his great prince.`,expl:"A one-eyed man can indeed see, but not enough for clear vision. A lame man can indeed treat, but not enough to make progress. If in spite of such defects a man considers himself strong and consequently exposes himself to danger, he is inviting disaster, for he is undertaking something beyond his strength. This reckless way of plunging ahead, regardless of the adequacy of one's powers, can be justified only in the case of a warrior battling for his prince."},{poem:`Nine in the fourth place means:
He treads on the tail of the tiger.
Caution and circumspection
Lead ultimately to good fortune.`,expl:"This text refers to a dangerous enterprise. The inner power to carry it through is there, but this inner power is combined with hesitating caution in one's external attitude. This line contrasts with the preceding line, which is weak within but outwardly presses forward. Here one is sure of ultimate success, which consists in achieving one's purpose, that is, in overcoming danger by going forward."},{poem:`Nine in the fifth place means:
Resolute conduct.
Perseverance with awareness of danger.`,expl:"This refers to the ruler of the hexagram as a whole. One sees that one has to be resolute in conduct. But at the same time one must remain conscious of the danger connected with such resoluteness, especially if it is to be persevered in. Only awareness of the danger makes success possible."}]}},{number:11,name:"Tai",description:"Peace",trigrams:{above:{title:"kun",description:"THE RECEPTIVE, EARTH"},below:{title:"chien",description:"THE CREATIVE, HEAVEN"}},interpretation:{oracle:`	The small departs,
	The great approaches.
	Good fortune. Success.`,resume:`The Receptive, which moves downward, stands above; the Creative, which 
...
new spring. 
	...
	`,judgment:`This hexagram denotes a time in nature when heaven seems to be on earth. 
...
brings good fortune and success.
	`,image:{oracle:`	Heaven and earth unite: the image of PEACE.
	Thus the ruler
	Divides and completes the course of heaven and earth,
	And so aids the people.`,image:`Heaven and earth are in contact and combine their influences, producing a 
...
Undertakings bring good fortune.`,expl:"In times of prosperity every able man called to fill an office draws like minded people along with him, just as in pulling up ribbon grass one always pulls up a bunch of it, because the stalks are connected by their roots. In such times, when it is possible to extend influence widely, the mind of an able man is set upon going out into life and accomplishing something."},{poem:`Nine in the second place means:
Bearing with the uncultured in gentleness,
Fording the river with resolution,
Not neglecting what is distant,
Not regarding one's companions:
Thus one may manage to walk in the middle.`,expl:"In times of prosperity it is important and above all to possess enough greatness of soul to bear with imperfect people. For in the hands of a great master no material is unproductive; he can find use for everything. But this generosity is by no means laxity or weakness. It is during times of prosperity especially that we must always be ready to risk even dangerous undertakings, such as the crossing of a river, if they are necessary. So too we must not neglect what is distant but must attend scrupulously to everything. Factionalism and the dominance of cliques are especially to be avoided. Even if people of like mind come forward together, they ought not to form a faction by holding together for mutual advantage; instead, each man should do is duty. Theses are four ways in which one can overcome the hidden danger of a gradual slackening that always lurks in any time of peace. And that is how one finds the middle way for action."},{poem:`Nine in the third place means:
No plain not followed by a slope.
No going not followed by a return.
He who remains persevering in danger
Is without blame.
Do not complain about this truth;
Enjoy the good fortune you still possess.`,expl:"		Everything on earth is subject to change. Prosperity is followed by decline: this is the eternal law on earth. Evil can indeed be held in check but not permanently abolished. It always returns. This conviction might induct melancholy, but it should not; it ought only to keep us from falling into illusion when good fortune comes to us. If we continue mindful of the danger, we remain persevering and make no mistakes. As long as a man's inner nature remains stronger and richer than anything offered by external fortune, as long as he remains inwardly superior to fate, fortune will not desert him."},{poem:`Six in the fourth place means:
He flutters down, not boasting of his wealth,
Together with his neighbor,
Guileless and sincere.`,expl:"In times of mutual confidence, people of high rank come in close contact with the lowly quite simply and without boasting of their wealth. This is not due to the force of circumstances but corresponds with their inmost sentiment. The approach is made quite spontaneously, because it is based on inner conviction."},{poem:`Six in the fifth place means:
The sovereign I
Gives his daughter in marriage.
And supreme good fortune.`,expl:"The sovereign I is T'ang the Completer. By his decree the imperial princesses, although higher in rank than their husbands, had to obey them like all other wives. Here too we are shown a truly modest union of high and low that brings happiness and blessings."}]}},{number:12,name:"Pi",description:"Stagnation",trigrams:{above:{title:"chien",description:"THE CREATIVE, HEAVEN"},below:{title:"kun",description:"THE RECEPTIVE, EARTH"}},interpretation:{oracle:`	Evil people do not further
	The perseverance of the superior man.
	The great departs; the small approaches.`,resume:`This hexagram is the opposite of the preceding one. Heaven is above, 
...
in. 
	...
	`,judgment:`Heaven and earth are out of communion and all things are benumbed. What 
...
principles and withdraw into seclusion.
	`,image:{oracle:`	Heaven and earth do not unite:
	The image of STANDSTILL.
	Thus the superior man falls back upon his inner worth 
	In order to escape the difficulties.
	He does not permit himself to be honored with revenue.`,image:`When, owing to the influence of inferior men, mutual mistrust prevails in 
...
hold together, needs one yielding nature among many firm persons.
	`,judgment:`True fellowship among men must be based upon a concern that is universal. 
...
means clarity; the outer, strength.)
	`,image:{oracle:`	Heaven together with fire:
	The image of FELLOWSHIP WITH MEN.
	Thus the superior man organizes the clans
	And makes distinctions between things.`,image:`Heaven has the same direction of movement as fire, yet it is different from 
...
in graceful and controlled way. This brings supreme success and wealth.
	`,image:{oracle:"",image:`	Fire in heaven above:
...
One remains without blame.`,expl:"Great possession that is still in its beginnings and that has not yet been challenged brings no blame, since there has been no opportunity to make mistakes. Yet there are many difficulties to be overcome. It is only by remaining conscious of theses difficulties that one can keep inwardly free of possible arrogance and wastefulness, and thus in principle overcome all cause for blame."},{poem:`Nine in the second place means:
A big wagon for loading.
One may undertake something.
No blame.`,expl:"Great possession consists not only in the quantity of goods at one's disposal, but first and foremost, in their mobility and utility, for then they can be used in undertakings, and we remain free of embarrassment and mistakes. The big wagon, which will carry a heavy load and in which one can journey farm means that there are at hand able helpers who give their support t and are equal to their task. One can load great responsibility upon such persons, and this is necessary in important undertakings."},{poem:`Nine in the third place means:
A prince offers it to the Son of Heaven.
A petty man cannot do this.`,expl:"A magnanimous, liberal-minded man should not regard what he possesses as his exclusive personal property , but should place it at the disposal of the ruler or of the people at large. In so doing, he takes the right attitude toward his possession, which as private property can never endure. A petty man is incapable of this. He is harmed by great possessions, because instead of sacrificing them, he would keep them for himself."},{poem:`Nine in the fourth place means:
He makes a difference
Between himself and his neighbor.
No blame.`,expl:"This characterizes the position of a man placed among rich and powerful neighbors. It is a dangerous position. He must look neither to the right nor to the left, and must shun envy and the temptation to vie with others. In this way he remains free of mistakes."},{poem:`\xB0Six in the fifth place means:
He whose truth is accessible, yet dignified,
Has good fortune.`,expl:"The situation is very favorable. People are being won not by coercion but by unaffected sincerity, so that they are attached to us in sincerity and truth. However, benevolence alone is not sufficient at the time of POSSESSION IN GREAT MEASURE. For insolence might begin to spread. Insolence must be kept in bounds by dignity; then good fortune is assured."}]}},{number:15,name:"Chien",description:"Modesty",trigrams:{above:{title:"kun",description:"THE RECEPTIVE, EARTH"},below:{title:"ken",description:"KEEPING STILL, MOUNTAIN"}},interpretation:{oracle:`	Modesty creates success.
	The superior man carries things through.`,resume:`This hexagram is made up of the trigrams K\xEAn, Keeping Still, mountain, and 
...
lowly, simple people: they are lifted up by it.
	`,judgment:`It is the law of heaven to make fullness empty and to make full what is 
...
without boasting of what he has achieved.
	`,image:{oracle:`	Within the earth, a mountain:
	The image of MODESTY.
	Thus the superior man reduces that which is too much,
	And augments that which is too little.
	He weighs things and makes them equal.`,image:`The wealth of the earth in which a mountain is hidden is not visible to the 
...
Good fortune.`,expl:"A dangerous enterprise, such as the crossing of a great stream, is made much more difficult if many claims and considerations have to be taken into account. On the other hand, the task is easy if it is attended to quickly and simply. Therefore the unassuming attitude of mind that goes with modesty fits a man to accomplish even difficult undertakings: he imposes no demands or stipulations but settles matters easily and quickly. Where no claims are put forward, no resistances arise."},{poem:`Six in the second place means:
Modesty that comes to expression. Perseverance brings good fortune.`,expl:`"Out of the fullness of the heart the mouth speaketh." When a man's attitude of mind is so modest that this expresses itself in his outward behavior, it is a source of good fortune to him. For the possibility of exerting a lasting influence arises of itself and no one can interfere.`},{poem:`\xB0Nine in the third place means:
A superior man of modesty and merit
Carries things to conclusion.
Good fortune.`,expl:"This is the center of the hexagram, where its secret is disclosed. A distinguished name is readily earned by great achievements. If a man allows himself to be dazzled by fame, he will soon be criticized, and difficulties will arise. If, on the contrary, he remains modest despite his merit, he makes himself beloved and wins the support necessary for carrying his work through to the end."},{poem:`Six in the fourth place means:
Nothing that would not further modesty
In movement.`,expl:"Everything has its proper measure. Even modesty in behavior can be carried too far. Here, however, it is appropriate, because the place between a worthy helper below and a kindly ruler above carries great responsibility. The confidence of the man in superior place must not be abused nor the merits of the man in inferior placed concealed. There are officials who indeed do not strive for prominence; they hide behind the letter of ordinances, decline all responsibility, accept pay without giving its equivalent in work, and bear empty titles. This is the opposite of what is meant here by modesty. In such a position, modesty is shown by interest in one's work."},{poem:`Six in the fifth place means:
No boasting of wealth before one's neighbor. 
It is favorable to attack with force.
Nothing that would not further.`,expl:"Modesty is not to be confused with weak good nature that lets things take their own course. When a man holds a responsible position, he must at times resort to energetic measures. In doing so he must not try to make an impression by boasting of his superiority but must make certain of the people around him. The measures taken should be purely objective and in no way personally offensive. Thus modesty manifests itself even in severity."}]}},{number:16,name:"Y\xFC",description:"Enthusiasm",trigrams:{above:{title:"chen",description:"THE AROUSING, THUNDER"},below:{title:"kun",description:"THE RECEPTIVE, EARTH"}},interpretation:{oracle:`	It furthers one to install helpers
	And to set armies marching.`,resume:`The strong line in the fourth place, that of the leading official, meets with 
response and obedience from all the other lines, which are all weak. The 
attribute of the upper trigram, Ch\xEAn, is movement; the attributes of K'un, the 
...
and for human life.
	`,judgment:`The time of ENTHUSIASM derives from the fact that there is at hand an 
...
can unify mass movements, as in war, so that they achieve victory.
	`,image:{oracle:`	Thunder comes resounding out of the earth:
	The image of ENTHUSIASM.
	Thus the ancient kings made music 
	In order to honor merit,
	And offered it with splendor
	To the Supreme Deity,
	Inviting their ancestors to be present.`,image:`When, at the beginning of summer, thunder\u2014electrical energy\u2014comes 
...
spinning on his hand."		`},lines:[{poem:`Six at the beginning means:
Enthusiasm that expresses itself
Brings misfortune.`,expl:"A man in an inferior position has aristocratic connections about which he boasts enthusiastically. This arrogance inevitably invites misfortune.  Enthusiasm should never be an egotistic emotion; it is justified only when it is a general feeling that unites one with others."},{poem:`Six in the second place means:
Firm as a rock. Not a whole day.
Perseverance brings good fortune.`,expl:'This describes a person who does not allow himself to be misled by any illusions. While others are letting themselves be dazzled by enthusiasm, he recognizes with perfect clarity the first signs of the time. Thus he neither flatters those above nor neglects those beneath him; he is as firm as a rock. When the first sign of discord appears, he knows the right moment for withdrawing and does not delay even for a day. Perseverance in such conduct will bring good fortune. Confucius says about this line:To know the seeds, that is divine indeed. In his association with those above him, the superior man does not flatter. In his association with those beneath him, he is not arrogant. For he knows the seeds. The seeds are the first imperceptible beginning of movement, the first trace of good fortune (or misfortune) that shows itself. The superior man perceives the seeds and immediately takes actin. He does not wait even a whole day. In the Book of Changes it is said: "Firm as a rock. Not a whole day. Perseverance brings good fortune."	Firm as a rock, what need of a whole day?	The judgment can be known.	The superior man knows what is hidden and what is evident.	He knows weakness, he knows strength as well.	Hence the myriads look up to him.'},{poem:`Six in the third place means:
Enthusiasm that looks upward creates remorse.
Hesitation brings remorse.`,expl:"This line is the opposite of the preceding one: the latter bespeaks self-reliance, while here there is enthusiastic looking up to a leader. If a man hesitates too long, this also will bring remorse. The right moment for approach must be seized: only then will he do the right thing."},{poem:`\xB0Nine in the fourth place means:
The source of enthusiasm.
He achieves great things.
Doubt not.
You gather friends around you
As a hair clasp gathers the hair.`,expl:"This describes a man who is able to awaken enthusiasm through his own sureness and freedom from hesitation. He attracts people because he has no doubts and is wholly sincere. Owing to his confidence in them he wins their enthusiastic co-operation and attains success. Just as a clasp draws the hair together and hold it, so he draws man together by the support he gives them."},{poem:`Six in the fifth place means:
Persistently ill, and still does not die.`,expl:"Here enthusiasm is obstructed. A man is under constant pressure, which prevents him from breathing freely. However, this pressure has its advantage\u2014it prevents him from consuming his powers in empty enthusiasm. Thus constant pressure can actually serve to keep one alive."}]}},{number:17,name:"Sui",description:"Following",trigrams:{above:{title:"tui",description:"THE JOYOUS, LAKE"},below:{title:"chen",description:"THE AROUSING, THUNDER"}},interpretation:{oracle:`	Following  has supreme success.
	Perseverance furthers. No blame.`,resume:`The trigram Tui, the Joyous, whose attribute is gladness, is above; Ch\xEAn, the 
...
consideration. By this he moves her to follow him.
	`,judgment:`In order to obtain a following one must first know how to adapt oneself. If a 
...
so favorable.
	`,image:{oracle:`	Thunder in the middle of the lake:
	The image of FOLLOWING.
	Thus the superior man at nightfall
	Goes indoors for rest and recuperation.`,image:`In the autumn electricity withdraws into the earth again and rests. Here it is 
...
Produces deeds.`,expl:"There are exceptional conditions in which the relation between leader and followers changes. It is implicit in the idea of following and adaptation that if one wants to lead others, one must remain accessible and responsive to the views of those under him. At the same time, however, he must have firm principles, so that he does not vacillate where there is only a question of current opinion. Once we are ready to listen to the opinions of others, we must not associate exclusively with people who share our views or with members of our own party; instead, we must go out and mingle freely with all sorts of people, friends or foes. That is the only way to achieve something."},{poem:`Six in the second place means:
If one clings to the little boy,
One loses the strong man.`,expl:"In friendships and close relationships an individual must make a careful choice. He surrounds himself either with good or with bad company; he cannot have both at once. If he throws himself away on unworthy friends he loses connection with people of intellectual power who could further him in the good."},{poem:`Six in the third place means:
If one clings to the strong man,
One loses the little boy.
Through following one finds what one seeks.
It furthers one to remain persevering.`,expl:"When the right connection with distinguished people has been found, a certain loss naturally ensues. A man must part company with the inferior and superficial. But in his heart he will feel satisfied, because he seeks and needs for the development of his personality. The important thing is to remain firm. He must know what he wants and not be led astray by momentary inclinations."},{poem:`Nine in the fourth place means:
Following creates success.
Perseverance brings misfortune.
To go one's way with sincerity brings clarity.
How could there be blame in this?`,expl:"It often happens, when a man exerts a certain amount of influence, that he obtains a following by condescension toward inferiors. But the people who attach themselves to him are not honest in their intentions. They seek personal advantage and try to make themselves indispensable through flattery and subservience. If one becomes accustomed to such satellites and cannot do without them, it brings misfortune. Only when a man is completely free from his ego, and intent, by conviction, upon what is right and essential, does he acquire the clarity that enables him to see through such people, and become free of blame."},{poem:`\xB0Nine in the fifth place means:
Sincere in the good. Good fortune.`,expl:"Every man must have something he follows\u2014something that serves him as a lodestar. He who follows with conviction the beautiful and the good may feel himself strengthened by this saying."}]}},{number:18,name:"Ku",description:"Decay",trigrams:{above:{title:"ken",description:"KEEPING STILL, MOUNTAIN"},below:{title:"sun",description:"THE GENTLE, WIND"}},interpretation:{oracle:`	Has supreme success.
	It furthers one to cross the great water.
	Before the starting point, three days.
	After the starting point, three days.`,resume:`The Chinese character ku represents a bowl in whose contents worms are 
...
simply "what has been spoiled" but "work on what has been spoiled".  
	...
	`,judgment:`What has been spoiled through man's fault can be made good again through 
...
by a new beginning. 
	...
	`,image:{oracle:`	The wind blows low on the mountain:
	The image of DECAY.
	Thus the superior man stirs up the people
	And strengthens their spirit.`,image:`When the wind blow s slow on the mountain, it is thrown back and spoils 
...
the winter solstice, the light power begins to ascend again.
	...
	`,judgment:`The hexagram as a whole points to a time of joyous, hopeful progress. Spring 
...
can master it.
	`,image:{oracle:`	The earth above the lake:
	The image of APPROACH.
	Thus the superior man is inexhaustible
	In his will to teach,
	And without limits
	In his tolerance and protection of the people.`,image:`The earth borders upon the lake from above. This symbolizes the approach 
...
Joint approach.
Good fortune.
Everything furthers.`,expl:"When the stimulus to approach comes from a high place, and when a man has the inner strength and consistency that need no admonition, good fortune will ensue. Nor need the future cause any concern. He is well aware that everything earthly is transitory, and that a descent follows upon every rise, but need not be confused by this universal law of fate. Everything serves to further. Therefore he will travel the paths of life swiftly, honestly, and valiantly."},{poem:`Six in the third place means:
Comfortable approach.
Nothing that would further.
If one is induced to grieve over it,
One becomes free of blame.`,expl:"Things are going well for a man: he achieves power and influence. But in this lies the danger that he may relax, and confident of his position, allow the easygoing, careless mood to show itself in his dealings with other people. This would inevitably be harmful. But there is possibility of a change of mood. If he regrets his mistaken attitude and feels the responsibility of an influential position, he frees himself of faults."},{poem:`Six in the fourth place means:
Complete approach.
No blame.`,expl:"	While the three lower lines indicate rise to power and influence, the three upper lines show the attitude of persons in higher position toward those of lower rank for whom they procure influence. Here is shown the open-minded approach of a person of high rank to a man of ability whom he draws in to his own circle, regardless of class prejudice. This is very favorable. 	 	Six in the fifth place means:	Wise approach.	This is right for a great prince.	Good fortune.A prince, or anyone in a leading position, must have the wisdom to attract to himself people of ability who are expert in directing affairs. His wisdom consists both in selecting the right people and in allowing those chosen to have a free hand without interference from him.  For only through such self-restraint will he find the experts needed to satisfy all of his requirements."}]}},{number:20,name:"Kuan",description:"Contemplation",trigrams:{above:{title:"sun",description:"THE GENTLE, WIND"},below:{title:"kun",description:"THE RECEPTIVE, EARTH"}},interpretation:{oracle:`The ablution has been made, 
	But not yet the offering.
	Full of trust they look up to him.`,resume:`A slight variation of tonal stress gives the Chinese name for this hexagram a 
...
whole.
	`,judgment:`The sacrificial ritual in China began with an ablution and a libation by which 
...
others without their being aware of how it happens. 
	...
	`,image:{oracle:`	The wind blows over the earth:
	The image of CONTEMPLATION.
	Thus the kings of old visited the regions of the world,
	Contemplated the people,
	And gave them instruction.`,image:`When the wind blows over the earth it goes far and wide, and the grass must 
...
CONFLICT (6), which refers to civil suits.
	`,judgment:`When an obstacle to union arises, energetic biting through brings success. 
...
combines Li, clarity, and Ch\xEAn, excitement. Li is yielding, Ch\xEAn is hard. 
...
commands respect by his conduct in his position.
	`,image:{oracle:`	Thunder and lighting:
	The image of BITING THROUGH.
	Thus the kings of former times made firm the laws
	Through clearly defined penalties.`,image:`	
...
ordered and pleasing rather than disordered and chaotic.
	`,judgment:`Grace brings success. However, it is not the essential or fundamental thing; it 
...
human society it becomes possible to shape the world.
	`,image:{oracle:`	Fire at the foot of the mountain:
	The image of GRACE.
	Thus does the superior man proceed 
	When clearing up current affairs.
	But he dare not decide controversial issues in this way.`,image:`The fire, whose light illuminates the mountain and makes it pleasing, does 
...
be decided in this way. They require greater earnestness.
		...
		`},lines:[{poem:`Nine at the beginning means:
He lends grace to his toes, leaves the carriage, and walks.`,expl:"A beginner in subordinate place must take upon himself the labor of advancing. There might be an opportunity of surreptitiously easing the way-symbolized by the carriage-but a self-contained man scorns help gained in a dubious fashion. He thinks it more graceful to go on foot than to drive in a carriage under false pretenses."},{poem:`Six in the second place means:
Lends grace to the beard on his chin.`,expl:"The beard is not an independent thing; it moves only with the chin. The image therefore means that form is to be considered only as a result and attribute of content. The beard is a superfluous ornament. To devote care to it for its own sake, without regard for the inner content of which it is an ornament, would bespeak a certain vanity."},{poem:`Nine in the third place means:
Graceful and moist.
Constant perseverance brings good fortune.`,expl:"This represents a very charming life situation. One is under the spell of grace and the mellow mood induced by wine. This grace can adorn, but it can also swamp us. Hence the warning not to sink into convivial indolence but to remain constant in perseverance. Good fortune depends on this."},{poem:`Six in the fourth place means:
Grace or simplicity?
A white horse comes as if on wings.
He is not a robber,
He will woo at the right time.`,expl:"An individual is in a situation in which doubts arise as to which is better-to pursue the grace of external brilliance, or to return to simplicity. The doubt itself implies the answer. Confirmation comes from the outside; it comes like a white winged horse. The white color indicates simplicity. At first it may be disappointing to renounce the comforts that might have been obtained, yet one finds peace of mind in a true relationship with the friend who courts him. The winged horse is the symbol of the thoughts that transcend all limits of space and time."},{poem:`Six in the fifth place means:
Grace in the hills and gardens.
The roll of silk is meager and small.
Humiliation, but in the end good fortune.`,expl:"A man withdraws from contact with people of the lowlands, who seek nothing but magnificence and luxury, in to the solitude of the heights. There he finds an individual to look up to, whom he would like to have as a friend. But the gifts he has to offer are poor and few, so that he feels ashamed. However, it is not the material gifts that count, but sincerity of feeling, and so all goes well in the end."}]}},{number:23,name:"Po",description:"Splitting Apart",trigrams:{above:{title:"ken",description:"KEEPING STILL, MOUNTAIN"},below:{title:"li",description:"THE CLINGING, FIRE"}},interpretation:{oracle:`	It does not further one 
	To go anywhere.`,resume:`The dark lines are about to mount upward and overthrow the last firm, light 
...
altogether.
	`,judgment:`This pictures a time when inferior people are pushing forward and are about 
...
time. Hence it is not cowardice but wisdom to submit and avoid action.
	`,image:{oracle:`	The mountain rests on the earth:
	The image of SPLITTING APART.
	Thus those above can ensure their position
	Only by giving generously to those below.`,image:`The mountain rests on the earth. When it is steep and narrow, lacking a 
...
Misfortune.`,expl:"Inferior people are on the rise and stealthily begin their destructive burrowing from below in order to undermine the place where the superior man rests. Those followers of the ruler who remain loyal are destroyed by slander and intrigue. The situation bodes disaster, yet there is nothing to do but wait."},{poem:`Six in the second place means:
The bed is split at the edge.
Those who persevere are destroyed.
Misfortune.`,expl:"The power of the inferior people is growing. The danger draws close to one's person; already there are clear indication, and rest is disturbed. Moreover, in this dangerous situation one is as yet without help or friendly advances from above or below. Extreme caution is necessary in this isolation. One must adjust to the time and promptly avoid the danger. Stubborn perseverance in maintaining one's standpoint would lead to downfall."},{poem:`Six in the third place means:
He splits with them. No blame.`,expl:"An individual finds himself in an evil environment to which he is committed by external ties. But he has an inner relationship with a superior man, and through this he attains the stability to free himself from the way of the inferior people around him. This brings him into opposition to them of course, but that is not wrong."},{poem:`Six in the fourth place means:
The bed is split up to the skin.
Misfortune.`,expl:"Here the disaster affects not only the resting place but even the occupant. No warning or other comment is added. Misfortune has reached its peak: it can no longer be warded off."},{poem:`Six in the fifth place means:
A shoal of fishes. Favor comes through the court ladies.
Everything acts to further.`,expl:"Here, in immediate proximity to the strong, light-giving principle at the top, the nature of the dark force undergoes a change. It no longer opposes the strong principle by means of intrigues but submits to its guidance. Indeed, as the head of the other weak lines, it leads all of these to the strong line, just as a princess leads her maids-in-waiting like a shoal of fishes to her husband and thus gains his favor. Inasmuch as the lower element thus voluntarily places itself under the higher, it attains happiness and the higher also receives its due. Therefore all goes well."}]}},{number:24,name:"Fu",description:"Return",trigrams:{above:{title:"kun",description:"THE RECEPTIVE, EARTH"},below:{title:"chen",description:"THE AROUSING, THUNDER"}},interpretation:{oracle:`	Success.
	Going out and coming in without error.
	Friends come without blame.
	To and fro goes the way.
	On the seventh day comes return.
	It furthers one to have somewhere to go.`,resume:`The idea of a turning point arises from the fact that after the dark lines have 
...
eleventh month, the month of the solstice (December-January).
	`,judgment:`After a time of decay comes the turning point. The powerful light that has 
...
increased by one. In this way the state of rest gives place to movement.
	`,image:{oracle:`	Thunder within the earth:
	The image of THE TURNING POINT.	
	Thus the kings of antiquity closed the passes 
	At the time of solstice.
	Merchants and strangers did not go about,
	And the ruler
	Did not travel through the provinces.`,image:`The winter solstice has always been celebrated in China as the resting time of 
...
No need for remorse.
Great good fortune.`,expl:"Slight digressions from the good cannot be avoided, but one must turn back in time, before going too far. This is especially important in the development of character; every faintly evil thought must be put aside immediately, before it goes too far and takes root in the mind. Then there is no cause for remorse, and all goes well."},{poem:`Six in the second place means:
Quiet return. Good fortune.`,expl:"Return always calls for a decision and is an act of self-mastery. It is made easier if a man is in good company. If he can bring himself to put aside pride and follow the example of good men, good fortune results."},{poem:`Six in the third place means:
Repeated return. Danger. No blame.`,expl:"There are people of a certain inner instability who feel a constant urge to reverse themselves. There is danger in continually deserting the good because of uncontrolled desires, then turning back to it again because of a better resolution. However, since this does not lead to habituation in evil, a general inclination to overcome the defect is not wholly excluded/"},{poem:`Six in the fourth place means:
Walking in the midst of others,
One returns alone.`,expl:"A man is in a society composed of inferior people, but is connected spiritually with a strong and good friend, and this makes him turn back alone. Although nothing is said of reward and punishment, this return is certainly favorable, for such a resolve to choose the good brings its own reward. 			Six in the fifth place means:	Noblehearted return. No remorse.When the time for return has come, a man should not take shelter in trivial excuses, but should look within and examine himself. And if he has done something wrong he should make a noblehearted resolve to confess his fault. No one will regret having taken this road."}]}},{number:25,name:"Wu Wang",description:"Innocence",trigrams:{above:{title:"chien",description:"THE CREATIVE, HEAVEN"},below:{title:"chen",description:"THE AROUSING, THUNDER"}},interpretation:{oracle:`	Supreme success.
	Perseverance furthers.
	If someone is not as he should be,
	He has misfortune,
	And it does not further him
	To undertake anything.`,resume:`Ch'ien, heaven is above; Ch\xEAn, movement, is below. The lower trigram 
Ch\xEAn is under the influence of the strong line it has received form above, 
...
fundamental or unexpected.
	`,judgment:`Man has received from heaven a nature innately good, to guide him in all his 
...
with his deeds."	`,image:{oracle:`	Under heaven thunder rolls:
	All things attain the natural state of innocence.
	Thus the kings of old,
	Rich in virtue, and in harmony with the time,
	Fostered and nourished all beings.`,image:`In springtime when thunder, life energy, begins to move again under the 
...
everything to further them, and at the proper time.
		`},lines:[{poem:`Nine at the beginning means:
Innocent behavior brings good fortune.`,expl:"The original impulses of the heart are always good, so that we may follow them confidently, assured of good fortune and achievement of our aims."},{poem:`Six in the second place means:
If one does not count on the harvest while plowing,
Nor on the use of the ground while clearing it,
It furthers one to undertake something.`,expl:"We should do every task for its own sake as time and place demand and not with an eye to the result. Then each task turns out well, and anything we undertake succeeds."},{poem:`Six in the third place means:
Undeserved misfortune.
The cow that was tethered by someone
Is the wanderer's gain, the citizen's loss.`,expl:"Sometimes undeserved misfortune befalls a man at the hands of another, as for instance when someone passes by and takes a tethered cow along with him. His gain is the owner's loss. In all transactions, no matter how innocent, we must accommodate ourselves to the demands of the time, otherwise unexpected misfortune overtakes us."},{poem:`Nine in the fourth place means:
He who can be persevering 
Remains without blame.`,expl:"	We cannot lose what really belongs to us, even if we throw it away. Therefore we need have no anxiety. All that need concern us is that we should remain true to our own natures and not listen to others."},{poem:`Nine in the fifth place means:
Use no medicine in an illness
Incurred through no fault of your own.
It will pass of itself.`,expl:"An unexpected evil may come accidentally from without. If it does not originate in one's own nature or have a foothold there, one should not resort to external means to eradicate it, but should quietly let nature take its course. Then improvement will come of itself."}]}},{number:26,name:"Ta Chu",description:"The Taming Power of the Great",trigrams:{above:{title:"ken",description:"KEEPING STILL, MOUNTAIN"},below:{title:"chien",description:"THE CREATIVE, HEAVEN"}},interpretation:{oracle:`	Perseverance furthers.
	Not eating at home brings good fortune.
	It furthers one to cross the great water.`,resume:`The Creative is tamed by K\xEAn, Keeping Still.  This produces great power, a 
...
holding firm in the sense of holding together; the trigram K\xEAn which holds 
...
which represents the sage.
	`,judgment:`To hold firmly to great creative powers and store them up, as set forth in this 
hexagram, there is need of a strong, clear-headed man who is honored by the 
ruler. The trigram Ch'ein points to strong creative power; K\xEAn indicates 
...
and difficult undertakings, such as crossing the great water, succeed.
	`,image:{oracle:`	Heaven within the mountain:
	The image of THE TAMING POWER OF THE GREAT.
	Thus the superior man acquaints himself with many sayings of antiquity
	And many deeds of the past,
	In order to strengthen his character thereby.`,image:`Heaven within the mountain points to hidden treasures. In the words and 
...
knowledge, to give actuality to the past.
		`},lines:[{poem:`Nine at the beginning means:
Danger is at hand. It furthers one to desist.`,expl:"A man wishes to make vigorous advance, but circumstances present an obstacle. He sees himself held back firmly. If he should attempt to fore an advance, it would lead him into misfortune. Therefore it is better for him to compose himself and to wait until an outlet is offered for release of his stored-up energies."},{poem:`Nine in the second place means:
The axletrees are taken from the wagon.`,expl:"Here advance is checked just as in the third line of THE TAMING POWER OF THE SMALL (9). However, in the later the restraining force is slight; thus a conflict arises between the propulsive and the restraining movement, as a result of which the spokes fall out of the wagon wheels, while here the restraining force is absolutely superior; hence no struggle takes place. One submits and removes the axletrees from the wagon -in other words, contents himself with waiting. In this way energy accumulates for a vigorous advance later on."},{poem:`Nine in the third place means.
A good horse that follows others.
Awareness of danger,
With perseverance, furthers.
Practice chariot driving and armed defense daily. 
It furthers one to have somewhere to go.`,expl:"The way opens; the hindrance has been cleared away. A man is in contact with a strong will acting in the same direction as his own, and goes forward like one good horse following another. But danger still threatens, and he must remain aware of it, or he will be robbed of his firmness. Thus he must acquire skill on the one hand in what will take him forward, and on the other in what will protect him against unforeseen attacks. It is good in such a pass to have a goal toward which to strive."},{poem:`Six in the fourth place means:
The headboard of a young bull.
Great good fortune.`,expl:"This line and the one following it are the two that tame the forward-pushing lower lines. Before a bull's horns grow out, a headboard is fastened to its forehead, so that later when the horns appear they cannot do harm. A good way to restrain wild force is to forestall it. By so doing one achieves an easy and great success."},{poem:`Six in the fifth place means:
The tusk of a gelded boar.
Good fortune.`,expl:"Here the restraining of the impetuous forward drive is achieved in an indirect way. A boar's tusk is in itself dangerous, but if the boar's nature is altered, the tusk is no longer a menace. Thus also where men are concerned, wild force should not be combated directly; instead, its roots should be eradicated."}]}},{number:27,name:"I",description:"Corners of the Mouth",trigrams:{above:{title:"ken",description:"KEEPING STILL, MOUNTAIN"},below:{title:"chen",description:"THE AROUSING, THUNDER"}},interpretation:{oracle:`	Perseverance brings good fortune.
	Pay heed to the providing of nourishment
	And to what a man seeks
	To fill his own mouth with.`,resume:`This hexagram is a picture of an open mouth; above and below are firm lines 
...
care of others, in a higher, spiritual sense.
	`,judgment:`In bestowing care and nourishment, it is important that the right people 
...
nature is a superior man.
	`,image:{oracle:`	At the foot of the mountain, thunder:
	The image of PROVIDING NOURISHMENT.
	Thus the superior man is careful of his words
	And temperate in eating and drinking.`,image:`"God comes forth in the sign of the Arousing": when in the spring the life 
...
Misfortune.`,expl:"The magic tortoise is a creature possessed of such supernatural powers that it lives on air and needs no earthly nourishment. The image means that a man fitted by nature and position to live freely and independently renounces this self-reliance and instead looks with envy and discontent at others who are outwardly in better circumstances. But such base envy only arouses derision and contempt in those others. This has bad results."},{poem:`Six in the second place means:
Turning to the summit for nourishment,
Deviating from the path
To seek nourishment from the hill.
Continuing to do this brings misfortune.`,expl:"Normally a person either provides his own means of nourishment or is supported in a proper way by those whose duty of privilege it is to provide for him. If, owing to weakness of spirit, a man cannot support himself, a feeling of uneasiness comes over him; this is because in shirking the proper way of obtaining a living, he accepts support as a favor from those in higher place. This is unworthy, for he is deviating from his true nature. Kept up indefinitely, this course leads to misfortune."},{poem:`Six in the third place means:
Turning away from nourishment.
Perseverance brings misfortune.
Do not act thus for ten years.
Nothing serves to further.`,expl:"	He who seeks nourishment that does not nourish reels from desire to gratification and in gratification craves desire. Mad pursuit of pleasure for the satisfaction of the senses never brings one to the goal. One should never (ten years is a complete cycle of time) follow this path, for nothing good can come of it."},{poem:`Six in the fourth place means:
Turning to the summit
For provision of nourishment
Brings good fortune.
Spying about with sharp eyes
Like a tiger with insatiable craving.
No blame.`,expl:"In contrast to the six in the second place, which refers to a man bent exclusively on his own advantage, this line refers to one occupying a high position and striving to let his light sine forth. To do this he needs helpers, because he cannot attain his lofty aim alone. With the greed of a hungry tiger he is on the lookout for the right people. Since he is not working for himself but for the good of all, there is no wrong in such zeal."},{poem:`Six in the fifth place means:
Turning away from the path.
To remain persevering brings good fortune.
One should not cross the great water.`,expl:"A man may be conscious of a deficiency in himself. He should be undertaking the nourishment of the people, but he has not the strength to do it. Thus he must turn from his accustomed path and beg counsel and help from a man who is spiritually his superior but undistinguished outwardly. If he maintains this attitude of mind perseveringly, success and good fortune are his. But he must remain aware of his dependence. He must not put his own person forward nor attempt great labors, such as crossing the great water."}]}},{number:28,name:"Ta Kuo",description:"Preponderance of the Great",trigrams:{above:{title:"tui",description:"THE JOYOUS, LAKE"},below:{title:"sun",description:"THE GENTLE, WIND, WOOD"}},interpretation:{oracle:`	The ridgepole sags to the breaking point.
	It furthers one to have somewhere to go.
	Success.`,resume:`This hexagram consists of four strong lines inside and two weak lines outside. 
...
that cannot last; it must be changed, must pass, or misfortune will result.
	`,judgment:`The weight of the great is excessive. The load is too heavy for the strength of 
...
time.
	`,image:{oracle:`	The lake rises above the trees:
	The image of PREPONDERANCE OF THE GREAT.
	Thus the superior man, when he stands alone,
	Is unconcerned,
	And if he has to renounce the world,
	He is undaunted.`,image:`Extraordinary times when the great preponderates are like flood times when 
...
No blame.`,expl:"When a man wishes to undertake an enterprise in extraordinary times, he must be extraordinarily cautious, just as when setting a heavy thing down on the floor, one takes care to put rushes under it, so that nothing will break. This caution, though it may seem exaggerated, is not a mistake. Exceptional enterprises cannot succeed unless utmost caution is observed in their beginnings and in the laying of their foundations."},{poem:`Nine in the second place means:
A dry poplar sprouts at the root.
An older man takes a young wife.
Everything furthers.`,expl:"Wood is near water; hence the image of an old poplar sprouting at the root. This means an extraordinary situation arises when an older man marries a young girl who suits him. Despite the unusualness of the situation, all goes well.  From the point of view of politics, the meaning is that in exceptional times one does well to join with the lowly, for this affords a possibility of renewal.		Nine in the third place means:	The ridgepole sags to the breaking point.	Misfortune.	This indicates a type of man who in times of preponderance of the great insists on pushing ahead. He accepts no advice from others, and therefore they in turn are not willing to lend him support. Because of this the burden grows, until the structure of things bends or breaks. Plunging willfully ahead in times of danger only hastens the catastrophe."},{poem:`Nine in the fourth place means:
The ridgepole is braced. Good fortune.
If there are ulterior motives, it is humiliating.`,expl:"Through friendly relations with people of lower rank, a responsible man succeeds in becoming master of the situation. But if, instead of working for the rescue of the whole, he were to misuse his connections to obtain personal power and success, it would lead to humiliation."},{poem:`Nine in the fifth place means:
A withered poplar puts forth flowers.
An older woman takes a husband. 
No blame. No praise.`,expl:"A withered poplar that flowers exhausts its energies thereby and only hastens its end. An older woman may marry once more, but no renewal takes place. Everything remains barren. Thus, though all the amenities are observed, the net result is only the anomaly of the situation.  Applied to politics, the metaphor means that if in times of insecurity we give up alliance with those below us and keep up only the relationships we have with people of higher rank, an unstable situation is created."}]}},{number:29,name:"Kan",description:"The Abysmal",trigrams:{above:{title:"kan",description:"THE ABYSMAL, WATER"},below:{title:"kan",description:"THE ABYSMAL, WATER"}},interpretation:{oracle:`	The Abysmal repeated.
	If you are sincere, you have success in your heart,
	And whatever you do succeeds.`,resume:`This hexagram consists of a doubling of the trigram K'an. It is one of the 
...
he can escape if he behaves correctly.
	`,judgment:`Through repetition of danger we grow accustomed to it. Water sets the 
...
protect themselves against attacks from without and against turmoil within.
	`,image:{oracle:`	Water flows on uninterruptedly and reaches its foal:
	The image of the Abysmal repeated.
	Thus the superior man walks in lasting virtue
	And carries on the business of teaching.`,image:`Water reaches its goal by flowing continually. It fills up every depression 
...
Misfortune.`,expl:"By growing used to what is dangerous, a man can easily allow it to become part of him. He is familiar with it and grows used to evil. With this he has lost the right way, and misfortune is the natural result."},{poem:`Nine in the second place means:
The abyss is dangerous.
One should strive to attain small things only.`,expl:"When we are in danger we ought not to attempt to get out of it immediately, regardless of circumstances; at first we must content ourselves with not being overcome by it. We must calmly weigh the conditions of the time and by satisfied with small gains, because for the time being a great success cannot be attained. A spring flows only sparingly at first, and tarries for some time before it makes its way in to the open."},{poem:`Six in the third place means:
Forward and backward, abyss on abyss.
In danger like this, pause at first and wait,
Otherwise you will fall into a pit in the abyss.
Do not act this way.`,expl:"Here every step, forward or backward, leads into danger. Escape is out of the question. Therefore we must not be misled into action, as a result of which we should only bog down deeper in the danger; disagreeable as it may be to remain in such a situation, we must wait until a way out shows itself."},{poem:`Six in the fourth place means:
A jug of wine, a bowl of rice with it;
Earthen vessels
Simply handed in through the Window.
There is certainly no blame in this.`,expl:"In times of danger ceremonious forms are dropped. What matters most is sincerity. Although as a rule it is customary for an official to present certain introductory gifts and recommendations before he is appointed, here everything is simplified to the utmost. The gifts are insignificant, there is no one to sponsor him, he introduces himself; yet all this need not be humiliating if only there is the honest intention of mutual help in danger. Still another idea is suggested. The window is the place through which light enters the room. If in difficult times we want to enlighten someone, we must begin with that which is in itself lucid and proceed quite simply from that point on."},{poem:`Nine in the fifth place means:
The abyss is not filled to overflowing,
It is filled only to the rim.
No blame.`,expl:"Danger comes because one is too ambitious. In order to flow out of a ravine, water does not rise higher than the lowest point of the rim. So likewise a man when in danger has only to proceed along the line of least resistance; thus he reaches the goal. Great labors cannot be accomplished in such times; it is enough to get out of the danger."}]}},{number:30,name:"Li",description:"The Clinging, Fire",trigrams:{above:{title:"li",description:"THE CLINGING, FIRE"},below:{title:"li",description:"THE CLINGING, FIRE"}},interpretation:{oracle:`	Perseverance furthers.
	It brings success.
	Care of the cow brings good fortune.`,resume:`This hexagram is another double sign. The trigram Li means "to cling to 
...
shut within the body, Li stands for nature in its radiance.
	`,judgment:`What is dark clings to what is light and so enhances the brightness of the 
...
clarity without sharpness and finds his place in the world.
	`,image:{oracle:`	That which is bright rises twice:
	The image of FIRE.
	Thus the great man, by perpetuating this brightness,
	Illumines the four quarters of the world.`,image:`Each of the two trigrams represents the sun in the course of a day. The two 
...
If one is seriously intent, no blame.`,expl:"It is early morning and work begins. The mind has been closed to the outside world in sleep; now its connections with the world begin again. The traces of one's impressions run crisscross. Activity and haste prevail. It is important then to preserve inner composure and not to allow oneself to be swept along by the bustle of life. If one is serious and composed, he can acquire the clarity of mind needed for coming to terms with the innumerable impressions that pour in. It is precisely at the beginning that serious concentration is important, because the beginning holds the seed of all that is to follow."},{poem:`Six in the second place means:
Yellow light. Supreme good fortune.`,expl:"Midday has come; the sun shines with a yellow light. Yellow is the color of measure and mean. Yellow light is therefore a symbol of the highest culture and art, whose consummate harmony consists in holding to the mean."},{poem:`Nine in the third place means:
In the light of the setting sun,
Men either beat the pot and sing
Or loudly bewail the approach of old age.
Misfortune.`,expl:"Here the end of the day has come. The light of the setting sun calls to mind the fact that life is transitory and conditional. Caught in this external bondage, men are usually robbed of their inner freedom as well. The sense of the transitoriness of life impels them to uninhibited revelry in order to enjoy life while it lasts, or else they yield to melancholy and spoil the precious time by lamenting the approach of old age. Both attitudes are wrong. To the superior man it makes no difference whether death comes early or late. He cultivates himself, awaits his allotted time, and in this way secures his fate."},{poem:`Nine in the fourth place means:
Its coming is sudden;
It flames up, dies down, is thrown away.`,expl:"Clarity of mind has the same relation to life that fire has to wood. Fire clings to wood, but also consumes it. Clarity of mind is rooted in life but can also consume it. Everything depends upon how the clarity functions. Here the image used is that of a meteor or a straw fire. A man who is excitable and restless may rise quickly to prominence but produces no lasting effects. Thus matters end badly when a man spends himself too rapidly and consumes himself like a meteor."}]}},{number:31,name:"Hsien",description:"Influence",trigrams:{above:{title:"tui",description:"THE JOYOUS, LAKE"},below:{title:"ken",description:"KEEPING STILL, MOUNTAIN"}},interpretation:{oracle:`	Influence. Success.
	Perseverance furthers.
	To take a maiden to wife brings good fortune.`,resume:`The name of the hexagram means "universal," "general," and in a figurative 
sense "to influence," "to stimulate." The upper trigram is Tui, the Joyous; the 
lower is K\xEAn, Keeping still. By its persistent, quiet influence, the lower, rigid 
trigram stimulates the upper, weak trigram, which responds to this 
stimulation cheerfully and joyously. K\xEAn, the lower trigram, is the youngest 
...
relationships.
	`,judgment:`The weak element is above, the strong below; hence their powers attract each 
...
earth.
	`,image:{oracle:`	A lake on the mountain:
	The image of influence.
	Thus the superior man encourages people to approach him
	By his readiness to receive them.`,image:`A mountain with a lake on its summit is stimulated by the moisture from 
...
counseling a man who thinks that he knows everything better than anyone 
		...
		`},lines:[{poem:`Six at the beginning means:
The influence shows itself in the big toe.`,expl:"A movement, before it is actually carried out, shows itself first in the toes. The idea of an influence is already present, but is not immediately apparent to others. As long as the intention has no visible effect, it is of no importance to the outside world and leads neither to good nor to evil."},{poem:`Six in the second place means:
The influence shows itself in the calves of the legs.
Misfortune.
Tarrying brings good fortune.`,expl:"In movement, the calf of the leg follows the foot; by itself it can neither go forward nor stand still. Since the movement is not self-governed, it bodes ill. One should wait quietly until one is impelled to action by a real influence. Then one remains uninjured."},{poem:`Nine in the third place means:
The influence shows itself in the thighs.
Holds to that which follows it.
To continue is humiliating.`,expl:"	Every mood of the heart influences us to movement. What the heart desires, the thighs run after without a moment's hesitation; they hold to the heart, which they follow. In the life of man, however, acting on the spur of every caprice is wrong and if continued leads to humiliation. Three considerations suggest themselves here. First, a man should not run precipitately after all the persons whom he would like to influence, but must be able to hold back under certain circumstances. As little should he yield immediately to every whim of those in whose service he stands. Finally, where the moods of his own heart are concerned, he should never ignore the possibility of inhibition, for this is the basis of human freedom."},{poem:`Nine in the fourth place means:
Perseverance brings good fortune.
Remorse disappears.
...
submissive.
	`,judgment:`Duration is a state whose movement is not worn down by hindrances. It is 
...
on earth.
	`,image:{oracle:`	Thunder and wind: the image of DURATION.
	Thus the superior man stands firm 
	And does not change has direction.`,image:`Thunder rolls, and the wind blows; both are examples of extreme mobility 
...
Nothing that would further.`,expl:'Whatever endures can be created only gradually by long-continued work and careful reflection. In the same sense Lao-tse says: "If we wish to compress something, we must first let it fully expand." He who demands too much at once is acting precipitately, and because he attempts too much, he ends by succeeding in nothing.'},{poem:`Nine in the second place means:
Remorse disappears.`,expl:"	 The situation is abnormal. A man's force of character is greater than the available material power. Thus he might be afraid of allowing himself to attempt something beyond his strength. However, since it is the time of DURATION, it is possible for him to control his inner strength and so to avoid excess. Cause for remorse then disappears."},{poem:`Nine in the third place means:
He who does not give duration to his character
Meets with disgrace.
Persistent humiliation.`,expl:"If a man remains at the mercy of moods of hope or fear aroused by the outer world, he loses his inner consistency of character. Such inconsistency invariably leads to distressing experiences. These humiliations often come from an unforeseen quarter. Such experiences are not merely effects produced by the external world, but logical consequences evoked by his own nature."},{poem:`Nine in the fourth place means:
No game in the field.`,expl:"If we are in pursuit of game and want to get a shot at a quarry, we must set about it in the right way. A man who persists in stalking game in a place where there is none may wait forever without finding any. Persistence in search is not enough. What is not sought in the right way is not found."},{poem:`Six in the fifth place means:
Giving duration to one's character through perseverance.
This is good fortune for a woman, misfortune for a man.`,expl:"A woman should follow a man her whole life long, but a man should at all times hold to what is his duty at the given moment. Should he persistently seek to conform to the woman, it would be a mistake for him. Accordingly it is altogether right for a woman to hold conservatively to tradition, but a  man must always be flexible and adaptable and allow himself to be guided solely by what his duty requires of him at the moment."}]}},{number:33,name:"TUN",description:"Retreat",trigrams:{above:{title:"chien",description:"THE CREATIVE, HEAVEN"},below:{title:"ken",description:"KEEPING STILL, MOUNTAIN"}},interpretation:{oracle:`Success.
	In what is small, perseverance furthers.`,resume:`The power of the dark is ascending. The light retreats to security, so that the 
...
in which the forces of winter are already showing their influence.
	`,judgment:`Conditions are such that the hostile forces favored by the time are advancing. 
...
not easy. The meaning that lies hidden in such a time is important.
	`,image:{oracle:`	Mountain under heaven: the image of RETREAT.
	Thus the superior man keeps the inferior man at a distance,
	Not angrily but with reserve.`,image:`The mountain rises up under heaven, but owing to its nature it finally comes 
...
standstill (mountain) by his dignified reserve.
		`},lines:[{poem:`\xB0Six at the beginning means:
At the tail in retreat. This is dangerous.
One must not wish to undertake anything.`,expl:"Since the hexagram is the picture of something that is retreating, the lowest line represents the tail and the top line the head. In a retreat it is advantageous to be at the front. Here one is at the back, in immediate contact with the pursuing enemy. This is dangerous, and under such circumstances it is not advisable to undertake anything. Keeping still is the easiest way of escaping from the threatening danger."},{poem:`Six in the second place means:
he holds him fast with yellow oxhide.
No one can tear him loose.`,expl:'Yellow is the color of the middle. It indicates that which is correct and in line with duty. Oxhide is strong and not to be torn.  While the superior men retreat and the inferior press after them, the inferior man represented here holds on so firmly and tightly to the superior man that the latter cannot shake him off. And because he is in quest of what is right an so strong in purpose, he reaches his goal. Thus the line confirms what is said in the Judgment: "In what is small" \u2014here equivalent to "in the inferior man" \u2014 "perseverance furthers."'},{poem:`Nine in the third place means:
A halted retreat 
Is nerve-wracking and dangerous.
To retain people as men- and maidservants
Brings good fortune.`,expl:"When it is time to retreat it is both unpleasant and dangerous to be held back, because then one no longer has freedom of action. In such a case the only expedient is to take into one's service, so to speak, those who refuse to let one go, so that one may at least keep one's initiative and not fall helplessly under their domination. But even with this expedient the situation is far from satisfactory\u2014for what can one hope to accomplish with such servants?"},{poem:`Nine in the fourth place means:
Voluntary retreat brings good fortune to the superior man
And downfall to the inferior man.`,expl:"In retreating the superior man is intent on taking his departure willingly and in all friendliness. He easily adjusts his mind to retreat, because in retreating he does not have to do violence to his convictions. The only one who suffers is the inferior man from whom he retreats, who will degenerate when deprived of the guidance of the superior man."},{poem:`Nine in the fifth place means:
Friendly retreat. Perseverance brings good fortune.`,expl:"It is the business of the superior man to recognize in time that the moment for retreat has come. If the right moment is chosen, the retreat can be carried out within the forms of perfect friendliness, without the necessity of disagreeable discussions. Yet, for all the observance of amenities, absolute firmness of decision is necessary if one is not to be led astray by irrelevant considerations."}]}},{number:34,name:"Ta Chuang",description:"The Power of the Great",trigrams:{above:{title:"chen",description:"THE AROUSING, THUNDER"},below:{title:"chien",description:"THE CREATIVE, HEAVEN"}},interpretation:{oracle:"Perseverance furthers.",resume:`The great lines, that is, the light, strong lines, are powerful. Four light lines 
have entered the hexagram from below and are about to ascend higher. The 
upper trigram is Ch\xEAn, the Arousing; the lower is ch'ien, the Creative. 
Ch'ien is strong, Ch\xEAn produces movement. The union of movement and 
strength gives the meaning of THE POWER OF THE GREAT. The hexagram 
is linked with the second month (March-April).
	`,judgment:`The hexagram points to a time when inner worth mounts with great force 
...
understand the true meaning of all that happens in heaven and on earth.
	`,image:{oracle:`	Thunder in heaven above:
	The image of THE POWER OF THE GREAT.
	Thus the superior man does not tread upon paths
	That do not accord with established order.`,image:`Thunder\u2014electrical energy\u2014mounts upward in the spring. The direction of 
...
This is certainly true.`,expl:"The toes are in the lowest place and are ready to advance. So likewise great power in lowly station is inclined to effect advance by force. This, if carried further, would certainly lead to misfortune, and therefore by way of advice a warning is added."},{poem:`Nine in the second place means:
...
And gets its horns entangled.`,expl:"Making a boast of power leads to entanglements, just as a goat entangles its horns when it butts against a hedge. Whereas an inferior man revels in power when he comes into possession of it, the superior man never makes this mistake. He is conscious at all times of the danger of pushing ahead regardless of circumstances, and therefore renounces in good time the empty display of force."},{poem:`Nine in the fourth place means:
Perseverance brings good fortune.
Remorse disappears.
The hedge opens; there is no entanglement.
Power depends upon the axle of a big cart.`,expl:"If a man goes on quietly and perseveringly working at the removal of resistances, success comes in the end. The obstructions give way and all occasion for remorse arising from excessive use of power disappears.Such a man's power does not show externally, yet it can move heavy loads, like a big cart whose real strength lies in its axle. The less that power is applied outwardly, the greater its effect."},{poem:`Six in the fifth place means:
Loses the goat with ease.
No remorse.`,expl:"The goat is noted for hardness outwardly and weakness within. Now the situation is such that everything is easy; there is no more resistance. One can give up a belligerent, stubborn way of acting and will not have to regret it."}]}},{number:35,name:"Chin",description:"Progress",trigrams:{above:{title:"li",description:"THE CLINGING, FIRE"},below:{title:"kun",description:"THE RECEPTIVE, EARTH"}},interpretation:{oracle:`The powerful prince
	Is honored with horses in large numbers.
	In a single day he is granted audience three times.`,resume:`The hexagram represents the sun rising over the earth. It is therefore the 
symbol of rapid, easy progress, which at the same time means ever widening 
expansion and clarity.
	`,judgment:`As an example of progress, this pictures a time when a powerful feudal lord 
...
depends.
	`,image:{oracle:`	The sun rises over the earth:
	The image of PROGRESS.
	Thus the superior man himself
	Brightens his bright virtue.`,image:`The light of the sun rises over the earth is by nature clear. The higher the sun 
...
No mistake.`,expl:"At a time when all elements are pressing for progress, we are still uncertain whether in the course of advance we may not meet with a rebuff. Then the thing to do is simply continue in what is right; in the end this will bring good fortune. It may be that we meet with no confidence. In this case we ought not to try to win confidence regardless of the situation, but should remain calm and cheerful and refuse to be roused to anger. Thus we remain free of mistakes."},{poem:`Six in the second place means:
Progressing, but in sorrow.
Perseverance brings good fortune.
Then one obtains great happiness from one's ancestress.`,expl:"Progress is halted; an individual is kept from getting in touch with the man in authority with whom he has a connection. When this happens, he must remain persevering, although he is grieved; then with a maternal gentleness the man in question will bestow great happiness upon him. This happiness comes to him-and is well deserved-because in this case mutual attraction does not rest on selfish or partisan motives but on firm and correct principles."},{poem:`Six in the third place means:
All are in accord. Remorse disappears.`,expl:"A man strives onward, in association with others whose backing encourages him. This dispels any cause for regret over the fact that he does not have enough independence to triumph unaided over every hostile turn of fate."},{poem:`Nine in the fourth place means:
Progress like a hamster.
Perseverance brings danger.`,expl:"In times of progress it is easy for strong men in the wrong places to amass great possessions. But such conduct shuns the light. And since times of progress are inevitably brought to the light, perseverance in such action always leads to danger."}]}},{number:36,name:"Ming I",description:"Darkening of the light",trigrams:{above:{title:"kun",description:"THE RECEPTIVE, EARTH"},below:{title:"li",description:"THE CLINGING, FIRE"}},interpretation:{oracle:`In adversity
	It furthers one to be persevering.`,resume:`Here the sun has sunk under the earth and is therefore darkened. The name 
...
face of difficulties.
	`,image:{oracle:`	The light has sunk into the earth:
	The image of DARKENING OF THE LIGHT.
	Thus does the superior man live with the great mass:
	He veils his light, yet still shines.`,image:`In a time of darkness it is essential to be cautious and reserved. One should 
...
The host has occasion to gossip about him.`,expl:"With grandiose resolve a man endeavors to soar above all obstacles, but thus encounters a hostile fate. He retreats and evades the issue. The time is difficult. Without rest, he must hurry along, with no permanent abiding place. If he does not want to make compromises within himself, but insists on remaining true to his principles, he suffers deprivation. Never the less he has a fixed goal to strive for even though the people with whom he lives do not understand him and speak ill of him."},{poem:`Six in the second place means:
Darkening of the light injures him in the left thigh.
He gives aid with the strength of a horse.
Good fortune.`,expl:"Here the Lord of Light is in a subordinate place and is wounded by the Lord of Darkness. But the injury is not fatal; it is only a hindrance. Rescue is still possible. The wounded man gives no thought to himself; he thinks only of saving the others who are also in danger. Therefore he tries with all his strength to save all that can be saved. There is good fortune in thus acting according to duty."},{poem:`Nine in the third place means:
Darkening of the light during the hunt in the south.
Their great leader is captured.
One must not expect perseverance too soon.`,expl:"It seems as if chance were at work. While the strong, loyal man is striving eagerly and in good faith to create order, he meets the ringleader of the disorder, as if by accident, and seizes him. Thus victory is achieved. But in abolishing abuses one must not be too hasty.  This would turn out badly because the abuses have been in existence so long."},{poem:`Six in the fourth place means:
He penetrates the left side of the belly.
One gets at the very heart of the darkening of the light.`,expl:"We find ourselves close to the commander of darkness and so discover his mot secret thoughts. In this way we realize that there is no longer any hope of improvement, and thus we are enabled to leave the scene of disaster before the storm breaks."},{poem:`Six in the fifth place means:
Darkening of the light as with Prince Chi.
Perseverance furthers.`,expl:"Prince Chi lived at the court of the evil tyrant Chou Hsin, who, although not mentioned by name, furnished the historical example on which this whole situation is based. Prince Chi was a relative of the tyrant and could not withdraw from the court; therefore he concealed his true sentiments and feigned insanity. Although he was held a slave, he did not allow external misery to deflect him from his convictions.  This provides a teaching for those who cannot leave their posts in times of darkness. In order to escape danger, they need invincible perseverance of spirit and redoubled caution in their dealings with the world."}]}},{number:37,name:"Chia J\xEAn",description:"The Family",trigrams:{above:{title:"sun",description:"THE GENTLE, WIND"},below:{title:"li",description:"THE CLINGING, FIRE"}},interpretation:{oracle:"The perseverance of the woman furthers.",resume:`The hexagram represents the laws obtaining within the family. The strong 
...
the symbol of the wind created by fire.
	`,judgment:`The foundation of the family is the relationship between husband and wife. 
...
in general.
	`,image:{oracle:`	Wind comes forth from fire:
	The image of THE FAMILY.

 	Thus the superior man has substance in his words
	And duration in his way of life.`,image:`Heat creates energy: this is signified by the wind stirred up by the fire and 
...
divergently directed.
	`,judgment:`When people live in opposition and estrangement they cannot carry out a 
...
differentiation by categories through which order is brought into the world.
	`,image:{oracle:`	Above, fire; below. The lake.
	The image of OPPOSITION.
	Thus amid all fellowship 
	The superior man retains his individuality.`,image:`The two elements, fire and water, never mingle but even when in contact 
...
them.
	`,judgment:`The southwest is the region of retreat, the northeast that of advance. Here an 
...
adversity. 
	...
	`,image:{oracle:`	Water on the mountain:
	The image of OBSTRUCTION.
	Thus the superior man turns his attention to himself
	And molds his character.`,image:`Difficulties and obstructions throw a man back upon himself. While the 
...
Coming meets with praise.`,expl:"When one encounters an obstruction, the important thing is to reflect on how best to deal with it. When threatened with danger, one should not strive blindly to go ahead, for this only leads to complications. The correct thing is, on the contrary, to retreat for the time being, not in order to give up the struggle but to await the right moment for action."},{poem:`Six in the second place means:
The King's servant is beset by obstruction upon obstruction,
But it is not his own fault.`,expl:"Ordinarily it is best to go around an obstacle and try to overcome it along the line of least resistance. But there is one instance in which a man must go out to meet the trouble, even though difficulty piles upon difficulty: this is when the path of duty leads directly to it-in other words, when he cannot act of his own volition but is duty bound to go and seek out danger in the service of a higher cause. Then he may do it without compunction, because it is not through any fault of his that he is putting himself in this difficult situation."},{poem:`Nine in the third place means:
Going leads to obstructions;
Hence he comes back.`,expl:"While the preceding line shows the official compelled by duty to follow the way of danger, this line shows the man who must act as father of a family or as head of his kin. If he were to plunge recklessly in to danger, it would be a useless act, because those entrusted to his care cannot get along by themselves. But if he withdraws and turns back to his own, they welcome him with great joy."},{poem:`Six in the fourth place means:
Going leads to obstructions,
Coming leads to union.`,expl:"This too describes a situation that cannot be managed single-handed. In such a case the direct way is not the shortest. If a person were to forge ahead on his own strength and without the necessary preparations, he would not find the support he needs and would realize too late that he has been mistaken in his calculations, inasmuch as the conditions on which he hoped he could rely would prove to be inadequate. In this case it is better, therefore, to hold back for the time being and to gather together trustworthy companions who can be counted upon for help in overcoming the obstructions."},{poem:`Nine in the fifth place means:
In the midst of the greatest obstructions,
Friends come.`,expl:"Here we see a man who is called to help in an emergency. He should not seek to evade the obstructions, no matter how dangerously they pile up before him. But because he is really called to the task, the power of his spirit is strong enough to attract helpers whom he can effectively organize, so that through the well-directed co-operation of all participants the obstruction is overcome."}]}},{number:40,name:"Hsieh",description:"Deliverance",trigrams:{above:{title:"chen",description:"THE AROUSING, THUNDER"},below:{title:"kan",description:"THE ABYSMAL, WATER"}},interpretation:{oracle:`The southwest furthers.
	If there is no longer anything where one has to go,
	Return brings good fortune.
	If there is still something where one has to go,
	Hastening brings good fortune.`,resume:`Here the movement goes out of the sphere of danger. The obstacle has been 
...
it is just in its beginning, and the hexagram represents its various stages.
	`,judgment:`This refers to a time in which tensions and complications begin to be eased. 
...
quickly as possible, so that a clean sweep is made and no retardations occur.
	`,image:{oracle:`	Thunder and rain set in:
	The image of DELIVERANCE.
	Thus the superior man pardons mistakes 
	And forgives misdeeds.`,image:`A thunderstorm has the effect of clearing the air; the superior man produces 
...
causing the sources of wealth in the nation and its lower classes to fail.
	`,judgment:`Decrease does not under all circumstances mean something bad. Increase 
...
sentiment of the heart can be expressed.
	`,image:{oracle:`	At the foot of the mountain, the lake:
	The image of DECREASE.
	Thus the superior man controls his anger
	And restrains his instincts.`,image:`The lake at the foot of the mountain evaporates. In this way it decreases to 
...
Is without blame.
But one must reflect on how much one may decrease others.`,expl:"It is unselfish and good when a man, after completing his own urgent tasks, uses his strength in the service of others, and without bragging or making much of it, helps quickly where help is needed. But the man in a superior position who is thus aided must weigh carefully how much he can accept without doing the helpful servant or friend real harm. Only where such delicacy of feeling exists can one give oneself unconditionally and without hesitation."},{poem:`Nine in the second place means:
Perseverance furthers.
To undertake something brings misfortune.
Without decreasing oneself,
One is able to bring increase to others.`,expl:"A high-minded self-awareness and a consistent seriousness with no forfeit of dignity are necessary if a man wants to be of service to others. He who throw himself away in order to do the bidding of a superior diminishes his own position without thereby giving lasting benefit to the other. This is wrong. To render true service of lasting value to another, one must serve him without relinquishing oneself."},{poem:`\xB0Six in the third place means:
When three people journey together,
Their number increases by one.
When one man journeys alone,
He finds a companion.`,expl:"When there are three people together, jealousy arises. One of them will have to go. Avery close bond is possible only between two people. But when one man is lonely, he is certain to find a companion who complements him."},{poem:`Six in the fourth place means:
If a man deceases his faults,
It makes the other hasten to come and rejoice.
No blame.`,expl:"A man's faults often prevent even well-disposed people from coming closer to him. His faults are sometimes reinforced by the environment in which he lives. But if in humility he can bring himself to the point of giving them up, he frees his well-disposed friends from an inner pressure and causes them to approach the more quickly, and there is mutual joy."},{poem:`Six in the fifth place means:
Someone does indeed increase him.
Ten pairs of tortoises cannot oppose it.
Supreme good fortune.`,expl:"	If someone is marked out by fate for good fortune, it comes without fail. All oracles-as for instance those that are read from the shells of tortoises-are bound to concur in giving him favorable signs. He need fear nothing, because his luck is ordained from on high."}]}},{number:42,name:"I",description:"Increase",trigrams:{above:{title:"sun",description:"THE GENTLE, WIND"},below:{title:"chen",description:"THE AROUSING, THUNDER"}},interpretation:{oracle:`It furthers one
	To undertake something.
	It furthers one to cross the great water.`,resume:`The idea of increase is expressed in the fact that the strong lowest line of the 
...
help the world.
	`,judgment:`Sacrifice on the part of those above for the increase of those below fills the 
...
lasts.
	`,image:{oracle:`	Wind and thunder: the image of INCREASE.
	Thus the superior man:
	If he sees good, he imitates it;
	If he has faults, he rids himself of them.`,image:`While observing how thunder and wind increase and strengthen each other, 
...
(April-May).
	`,judgment:`Even if only one inferior man is occupying a ruling position in a city, he is 
...
energetic progress in the good.
	...
	And refrains from resting on his virtue.`,image:`When the water of a lake has risen up to heaven, there is reason to fear a 
...
No blame.`,expl:"Here we have a man in an ambiguous situation. While all others are engaged in a resolute fight against all that is inferior, he alone has a certain relationship with an inferior man. If he were to show strength outwardly and turn against this man before the time is ripe, he would only endanger the entire situation, because the inferior man would too quickly have recourse to countermeasures. The task of the superior man becomes extremely difficult here. He must be firmly resolved within himself and, while maintaining association with the inferior man, avoid any participation in his evilness. He will of course be misjudged. It will be thought that he belong to the party of the inferior man. He will be lonely because no one will understand him. His relations with the inferior man will sully him in the eyes of the multitude, and they will turn against him, grumbling. But he can endure this lack of appreciation and makes no mistake, because he remains true to himself."},{poem:`Nine in the fourth place means:
There is no skin on his thighs,
And walking comes hard.
If a man were to let himself be led like a sheep,
Remorse would disappear.
But if these words are heard
They will not be believed.`,expl:"Here a man is suffering from inner restlessness and cannot abide in his place. He would like to push forward under any circumstances, but encounters insuperable obstacles. Thus his situation entails an inner conflict. This is due to the obstinacy with which he seeks to enforce his will.  If he would desist from this obstinacy, everything would go well. But this advice, like so much other good counsel, will be ignored. For obstinacy makes a man unable to hear, for all that he has ears."},{poem:`Nine in the fifth place means:
In dealing with weeds,
Firm resolution is necessary.
Walking in the middle
Remains free of blame.`,expl:"Weeds always grow back again and are difficult to exterminate. So too the struggle against an inferior man in a high position demands firm resolution. One has certain relations with him, hence there is danger that one may give up the struggle as hopeless. But this must not be. One must go on resolutely and not allow himself to be deflected from him course. Only in this way does one remain free of blame."}]}},{number:44,name:"Kou",description:"Coming to Meet",trigrams:{above:{title:"chien",description:"THE CREATIVE, HEAVEN"},below:{title:"sun",description:"THE GENTLE, WIND"}},interpretation:{oracle:`	The maiden is powerful.
	One should not marry such a maiden.`,resume:`This hexagram indicates a situation in which the principle of darkness, after 
...
summer solstice the principle of darkness gradually becomes ascendant again. 
	...
	`,judgment:`The rise of the inferior element is pictured here in the image of a bold girl 
...
ulterior motives, otherwise harm will result.
	`,image:{oracle:`	Under heaven, wind:
	The image of COMING TO MEET.
	Thus does the prince act when disseminating his commands
	And proclaiming them to the four quarters of heaven.`,image:`The situation here resembles that in hexagram 20, Kuan, CONTEMPLATION 
...
Even a lean pig has it in him to rage around.`,expl:"If an inferior element has wormed its way in, it must be energetically checked at once. By consistently checking it, bad effects can be avoided. If it is allowed to take its course, misfortune is bound to result; the insignificance of that which creeps in should not be a temptation to underrate it. A pig that is still young and lean cannot rage around much, but after it has eaten its fill and become strong, its true nature comes out if it has not previously been curbed."},{poem:`Nine in the second place means:
There is a fish in the tank. No blame.
Does not further guests.`,expl:"The inferior element is not overcome by violence but is kept under gentle control. Then nothing evil is to be feared. But care must be taken not to let it come in contact with those further away, because once free it would unfold its evil aspects unchecked."},{poem:`Nine in the third place means: 
 There is no skin on his thighs,
And walking comes hard.
If one is mindful of the danger,
No great mistake is made.`,expl:"There is a temptation to fall in with the evil element offering itself-a very dangerous situation. Fortunately circumstances prevent this; one would like to do it, but cannot. This leads to painful indecision in behavior. But if we gain clear insight into the danger of the situation, we shall at least avoid more serious mistakes."},{poem:`Nine in the fourth place means:
No fish in the tank.
This leads to misfortune.`,expl:"Insignificant people must be tolerated in order to keep them well disposed. Then we can make use of them if we should need them. If we become alienated from them and do not meet them halfway, they turn their backs on us and are not at our disposal when we need them. But this is our own fault."},{poem:`Nine in the fifth place means:
A melon covered with willow leaves.
Hidden lines.
Then it drops down to one from heave.`,expl:"The melon, like the fish, is a symbol of the principle of darkness. It is sweet but spoils easily and for this reason is protected with a cover of willow leaves. This is a situation in which a strong, superior, well-poised man tolerates and protects the inferiors in his charge.  He has the firm lines of order an beauty within himself but he does not lay stress upon them. He does not bother his subordinates with outward show or tiresome admonitions but leaves them quite free, putting his trust in the transforming power of a strong and upright personality. And behold! Fate is favorable. His inferiors respond to his influence and fall to his disposition like ripe fruit."}]}},{number:45,name:"Tsui",description:"Gathering Together",trigrams:{above:{title:"tui",description:"THE JOYOUS, LAKE"},below:{title:"kun",description:"THE RECEPTIVE, EARTH"}},interpretation:{oracle:`	Success.
	The king approaches his temple.
	It furthers one to see the great man.
	This brings success. Perseverance furthers.
	To bring great offerings creates good fortune.
	It furthers one to undertake something.`,resume:`This hexagram is related in form and meaning to Pi, HOLDING TOGETHER (8). 
...
former case one strong line (the fifth) stands in the midst of weak lines.
	`,judgment:`The gathering together of people in large communities is either a natural 
...
TOGETHER.
	`,image:{oracle:`	Over the earth, the lake:
	The image of GATHERING TOGETHER.
	Thus the superior man renews his weapons
	In order to meet the unforeseen.`,image:`If the water in the lake gathers until it rises above the earth, there is danger of 
...
Regret not. Going is without blame.`,expl:"The situation is this:  People desire to gather around a leader to whom they look up. But they are in a large group, by which they allow themselves to be influenced, so that they waver in their decision. Thus they lack a firm center around which to gather. But if expression is given to this need, and if they call for help, one grasp of the hand from the leader is enough to turn away all distress. Therefore they must not allow themselves to be led astray. It is undoubtedly right that they should attach themselves to this leader."},{poem:`Six in the second place means:
Letting oneself be drawn
Brings good fortune and remains blameless.
If one is sincere,
It furthers one to bring even a small offering.`,expl:"In the time of GATHERING TOGETHER, we should make no arbitrary choice of the way. There are secret forces at work, leading together those who belong together. We must yield to this attraction; then we make no mistakes. Where inner relationships exist, no great preparations and formalities are necessary. People understand one another forthwith, just as the Divinity graciously accepts a small offering if it comes from the heart."},{poem:`Six in the third place means:
Gathering together amid sighs.
Nothing that would further.
Going is without blame.
Slight humiliation.`,expl:"Often a man feels an urge to unite with others, but the individuals around him have already formed themselves into a group, so that he remains isolated. The whole situation proves untenable. Then he ought to choose the way of progress, resolutely allying himself with a man who stands nearer to the center of the group, and can help him to gain admission to the closed circle. This is not a mistake, even though at first his position as an outsider is somewhat humiliating."},{poem:`Nine in the fourth place means:
Great good fortune. No blame.`,expl:"This describes a man who gathers people around him in the name of his ruler. Since he is not striving for any special advantages for himself but is working unselfishly to bring about general unity, his work is crowned with success, and everything becomes as it should be."},{poem:`Nine in the fifth place means:
If in gathering together one has position,
This brings no blame.
If there are some who are not yet sincerely in the work,
Sublime and enduring perseverance is needed.
Then remorse disappears.`,expl:"When people spontaneously gather around a man, it is only a good. It gives him a certain influence that can be altogether useful.. But of course there is also the possibility that many may gather around him not because of a feeling of confidence but merely because of his influential position. This is certainly to be regretted. The only means of dealing with such people is to gain their confidence through steadfastness an intensified, unswerving devotion to duty. In this way secret mistrust will gradually be overcome, and there will be no occasion for regret."}]}},{number:46,name:"Sh\xEAng",description:"Pushing Upward",trigrams:{above:{title:"kun",description:"THE RECEPTIVE, EARTH"},below:{title:"sun",description:"THE GENTLE, WIND, WOOD"}},interpretation:{oracle:`	Pushing upward has supreme success.
	One must see the great man.
	Fear not.
	Departure toward the south
	Brings good fortune.`,resume:`The lower trigram, Sun, represents wood, and the upper, K'un, means the 
...
from obscurity and lowliness to power and influence.
	`,judgment:`The pushing upward of the good elements encounters no obstruction and is 
...
south") brings good fortune.
	`,image:{oracle:`	Within the earth, wood grows:
	The image of PUSHING UPWARD.
	Thus the superior man of devoted character
	Heaps up small things
	In order to achieve something high and great.`,image:`Adapting itself to obstacles and bending around them, wood in the earth 
...
Brings great good fortune.`,expl:"This situation at the beginning of ascent. Just as wood draws strength for its upward push from the root, which in itself is in the lowest place, so the power to rise comes from this low and obscure station. But there is a spiritual affinity with the rulers above, and this solidarity creates the confidence needed to accomplish something."},{poem:`Nine in the second place means:
If one is sincere,
It furthers one to bring even a small offering.
No blame.`,expl:"Here a strong man is presupposed. It is true that he does not fit in with his environment, inasmuch as he is too brusque and pays too little attention to form. But as he is upright in character, he meets with response, and his lack of outward form does no harm. Here uprightness is the outcome of sound qualities of character, whereas in the corresponding line of the preceding hexagram it is the result of innate humility."},{poem:`Nine in the third place means:
One pushes upward into an empty city.`,expl:"	All obstructions that generally block progress fall away here. Things proceed with remarkable ease. Unhesitatingly one follows this road, in order to profit by one's success. Seen from without, everything seems to be in the best of order. However, no promise of good fortune is added.  It is a question how long such unobstructed success can last. But it is wise not to yield to such misgivings, because they only inhibit one's power. Instead, the point is to profit by the propitiousness of time."},{poem:`Six in the fourth place means:
The king offers him Mount Ch'i.
Good fortune. No blame.`,expl:"Mount Ch'i is in the western China, the homeland of King W\xEAn, whose son, the Duke of Chou, added the words to the individual lines. The pronouncement takes us back to a time when the Chou dynasty was coming into power. At that time King W\xEAn introduced his illustrious helpers to the god of his native mountain, and they received their places in the halls of the ancestors by the side of the ruler. This indicates a stage in which pushing upward attains its goal. One acquires fame in the sight of gods and men, is received into the circle of those who foster the spiritual life of the nation, and thereby attains a significance that endures beyond time."},{poem:`Six in the fifth place means:
Perseverance brings good fortune.
One pushes upward by steps.`,expl:"When a man is advancing farther and farther, it is important for him not to become intoxicated by success. Precisely when he experiences great success it is necessary to remain sober and not to try to skip any stages; he must go on slowly, step by step, as though hesitant. Only such calm, steady progress, overleaping nothing, leads to the goal."}]}},{number:47,name:"Kun",description:"Oppression",trigrams:{above:{title:"tui",description:"THE JOYOUS, LAKE"},below:{title:"kan",description:"THE ABYSMAL, WATER"}},interpretation:{oracle:`	Success. Perseverance.
	The great man brings about good fortune.
	No blame.
	When one has something to say,
	It is not believed.`,resume:`The lake is above, water below; the lake is empty, dried up. Exhaustion is 
...
inferior men.
	`,judgment:`Times of adversity are the reverse of times of success, but they can lead to 
...
sparing of words.
	`,image:{oracle:`	There is not water in the lake:
	The image of EXHAUSTION.
	Thus the superior man stakes his life
	On following his will.`,image:`When the water has flowed out below, the lake must dry up and become 
...
For three years one sees nothing.`,expl:"When adversity befalls a man, it is important above all things for him to be strong and to overcome the trouble inwardly. If he is weak, the trouble overwhelms him. Instead of proceeding on his way, he remains sitting under a bare tree and falls ever more deeply into gloom and melancholy. This makes the situation only more and more hopeless. Such an attitude comes from an inner delusion that he must by all means overcome."},{poem:`Nine in the second place means:
One is oppressed while at meat and drink.
The man with the scarlet knee bands is just coming.
It furthers one to offer sacrifice.
To set forth brings misfortune.
No blame.`,expl:"This pictures a state of inner oppression. Externally, all is well, one has meat and drink. But one is exhausted by the commonplaces of life, and there seems to be no way of escape. Then help comes from a high place. A prince-in ancient China princes wore scarlet knee bands- is in search of able helpers. But there are still obstructions to be overcome. Therefore it is important to meet these obstructions in the visible realm by offerings and prayer. To set forth without being prepared would be disastrous, though not morally wrong. Here a disagreeable situation must be overcome by patience of spirit."},{poem:`Six in the third place means:
A man permits himself to be oppressed by stone,
And leans on thorns and thistles.
He enters the house and does not see his wife.
Misfortune.`,expl:"This shows a man who is restless and indecisive in times of adversity. At first he wants to push ahead, then he encounters obstructions that, it is true, mean oppression only when recklessly dealt with. He butts his head against a wall and in consequence feels himself oppressed by the wall. Then he leans on things that have in themselves no stability and that are merely a hazard for him who leans on them.  Thereupon he turns back irresolutely and retires into his house, only to find, as a fresh disappointment, that his wife is not there. Confucius says about this line: If a man permits himself to be oppressed by something that ought not to oppress him, his name will certainly be disgraced. If he leans on things upon which one cannot lean, his life will certainly be endangered. For him who is in disgrace and danger, the hour of death draws near; how can he then still see his wife?"},{poem:`Nine in the fourth place means:
He comes very quietly, oppressed in a golden carriage.
Humiliation, but the end is reached.`,expl:"A well-to-do man sees the need of the lower classes and would like very much to be of help. But instead of proceeding with speed and energy where their is need, he begins in a hesitant and measured way. Then he encounters obstructions. Powerful and wealthy acquaintances draw him into their circle; he has to do as they do and cannot withdraw from them. Hence he finds himself in great embarrassment. But the trouble is transitory. The original strength of his nature offsets the mistake he has made, and the goal is reached."},{poem:`Nine in the fifth place means:
His nose and feet are cut off.
Oppression at the hands of the man with the purple knee bands.
Joy comes softly.
It furthers one to make offerings and libations.`,expl:"An individual who has the good of mankind at heart is oppressed from above and below (this is the meaning of the cutting off of nose an defeat). He finds no help among the people whose duty it would be to aid in the work of rescue (ministers wore purple knee bands). But little by little, things take a turn for the better. Until that time, he should turn to God, firm in his inner composure, and pray and offer sacrifice for the general well-being."}]}},{number:48,name:"Ching",description:"The Well",trigrams:{above:{title:"kan",description:"THE ABYSMAL, WATER"},below:{title:"sun",description:"THE GENTLE, WIND, WOOD"}},interpretation:{oracle:`	The town may be changed,
	But the well cannot be changed.
	It neither decreases nor increases.
	They come and go and draw from the well.
	If one gets down almost to the water
	And the rope does not go all the way,
	Or the jug breaks, it brings misfortune.`,resume:`Wood is below, water above. The wood goes down into the earth to bring up 
...
inexhaustible dispensing of nourishment.
	`,judgment:`In ancient China the capital cities were sometimes moved, partly for the sake 
...
and neglect his self-development.
	`,image:{oracle:`	Water over wood: the image of THE WELL.
	Thus the superior man encourages the people at their work,
	And exhorts them to help one another.`,image:`The trigram Sun, wood, is below, and the trigram K'an, water, is above it. 
...
No animals come to an old well.`,expl:"If a man wanders around in swampy lowlands, his life is submerged in mud. Such a man loses all significance for mankind. He who throws himself away is no longer sought out by others. In the end no one troubles about him any more."},{poem:`Nine in the second place means:
At the well hole one shoots fishes.
The jug is broken and leaks.`,expl:"The water itself is clear, but it is not being used. Thus the well is a place where only fish will stay, and whoever comes to it, comes only to catch fish. But the jug is broken, so that the fish cannot be kept in it.  This describes the situation of a person who possesses good qualities but neglects them. No one bothers about him. As a result he deteriorates in mind. He associates with inferior men and can no longer accomplish anything worth while."},{poem:`Nine in the third place means:
The well is cleaned, but no one drinks from it.
This is my heart's sorrow,
For one might draw from it.
If the king were clear-minded,
Good fortune might be enjoyed in common.`,expl:"An able man is available. He is like a purified well whose water is drinkable. But no use is made of him. This is the sorrow of those who know him. One wishes that the prince might learn about it; this would be good fortune for all concerned."},{poem:`Six in the fourth place means:
The well is being lined. No blame.`,expl:"True, if a well is being lined with sone, it cannot be used while the work is going on. But the work is not in vain; the result is that the water stays clear. In life also there are times when a man must put himself in order. During such a time he can do nothing for others, but his work is nonetheless valuable, because by enhancing his powers and abilities through inner development, he can accomplish all the more later on."},{poem:`Nine in the fifth place means:
In the well there is a clear, cold spring
From which one can drink.`,expl:'A well that is fed by a spring of living water is a good well. A man who has virtues like a well of this sort is born to be a leader and savior of men, for he has the water of life. Nevertheless, the character for "good fortune" is left out here. The all-important thing about a well is that its water be drawn. The best water is only a potentiality for refreshment as long as it is not brought up. So too with leaders of mankind: it is all-important that one should drink from the spring of their words and translate them into life.'}]}},{number:49,name:"Ko",description:"Revolution",trigrams:{above:{title:"tui",description:"THE JOYOUS, LAKE"},below:{title:"li",description:"THE CLINGING, FIRE"}},interpretation:{oracle:`	On your own day
	You are believed.
	Supreme success,
	Furthering through perseverance.
	Remorse disappears.`,resume:`The Chinese character for this hexagram means in its original sense an 
...
revolution.
	`,judgment:`Political revolutions are extremely grave matters. They should be undertaken 
...
the life of peoples and nations, and these call for social transformations.
	`,image:{oracle:`	Fire in the lake: the image of REVOLUTION.
	Thus the superior man
	Sets the calendar in order
	And makes the seasons clear.`,image:`Fire below and the lake above combat and destroy each other. So too in the 
...
preparing food.
	`,judgment:`While THE WELL relates to the social foundation of our life, and this 
...
good fortune and success.
	`,image:{oracle:`	Fire over wood:
	The image of THE CALDRON.
	Thus the superior man consolidates his fate 
	By making his position correct.`,image:`The fate of fire depends on wood; as long as there is wood below, the fire 
...
No blame.`,expl:"If a ting is turned upside down before being used, no harm is done-on the contrary, this clears it of refuse. A concubine's position is lowly, but because she has a son she comes to be honored.  These two metaphors express the idea that in a highly developed civilization, such as that indicated by this hexagram, every person of good will can in some way or other succeed. No matter how lowly he may be, provided he is ready to purify himself, he is accepted. He attains a station in which he can prove himself fruitful in accomplishment, and as a result he gains recognition."},{poem:`Nine in the second place means:
There is food in the ting.
My comrades are envious,
But they cannot harm me.
Good fortune.`,expl:"In a period of advanced culture, it is of the greatest importance that one should achieve something significant. If a man concentrates on such real undertakings, he may indeed experience envy and disfavor, but that is not dangerous. The more he limits himself to his actual achievements, the less harm the envious inflict on him."},{poem:`Nine in the third place means:
The handle of the ting is altered.
One is impeded in his way of life.
The fat of the pheasant is not eaten.
Once rain falls, remorse is spent.
Good fortune comes in the end.`,expl:"The handle is the means for lifting up the ting. If the handle is altered, the ting cannot be lifted up and used, and, sad to say, the delicious food in it, such as pheasant fat, cannot be eaten by anyone.  This describes a man who, in a highly evolved civilization, finds himself in a place where no one notices or recognizes him. This is a severe block to his effectiveness. All of his good qualities and gifts of mind thus needlessly go to waste. But if he will only see to it that he is possessed of something truly spiritual, the time is bound to come, sooner or later, when the difficulties will be resolved and all will go well. The fall of rain symbolizes here, as in other instances, release of tension."},{poem:`Nine in the fourth place means:
The legs of the ting are broken.
The prince's meal is spilled
And his person is soiled.
Misfortune.`,expl:'A man has a difficult and responsible task to which he is not adequate. Moreover, he does not devote himself to it with all his strength but goes about with inferior people; therefore the execution of the work fails. In this way he also incurs personal opprobrium.  Confucius says about this line:  "Weak character coupled with honored place, meager knowledge with large plans, limited powers with heavy responsibility, will seldom escape disaster."'},{poem:`Six in the fifth place means:
The ting has yellow handles, golden carrying rings.
Perseverance furthers.`,expl:"Here we have, in a ruling position, a man who is approachable and modest in nature. As a result of this attitude he succeeds in finding strong and able helpers who complement and aid him in his work. Having achieved this attitude, which requires constant self-abnegation, it is important for him to hold to it and not to let himself be led astray."}]}},{number:51,name:"Ch\xEAn",description:"The Arousing",trigrams:{above:{title:"chen",description:"THE AROUSING, THUNDER"},below:{title:"chen",description:"THE AROUSING, THUNDER"}},interpretation:{oracle:`	Shock brings success.
	Shock comes-oh, oh!
	Laughing words -ha, ha!
	The shock terrifies for a hundred miles,
	And he does not let fall the sacrificial spoon and chalice.`,resume:`The hexagram Ch\xEAn represents the eldest son, who seizes rule with energy 
...
trembling.
	`,judgment:`The shock that comes from the manifestation of God within the depths of the 
...
inner seriousness from which all terrors glance off harmlessly.
	`,image:{oracle:`	Thunder repeated: the image of SHOCK.
	Thus in fear and trembling
	The superior man sets his life in order
	And examines himself.`,image:`The shock of continuing thunder brings fear and trembling. The superior 
...
Good fortune.`,expl:"The fear and trembling engendered by shock come to an individual at first in such a way that he sees himself placed at a disadvantage as against others. But this is only transitory. When the ordeal is over, he experiences relief, and thus the very terror he had to endure at the outset brings good fortune in the long run."},{poem:`Six in the second place means:
Shock comes bringing danger.
A hundred thousand times
You lose your treasures
And must climb the nine hills.
Do not go in pursuit of them.
After seven days you will get them back again.`,expl:"This pictures a situation in which a shock endangers a man and he suffers great losses. Resistance would be contrary to the movement of the time and for this reason unsuccessful. Therefore he must simply retreat to heights inaccessible to the threatening forces of danger. He must accept his loss of property without worrying too much about it. When the time of shock and upheaval that has robbed him of his possessions has passed, he will get them back again without going in pursuit of them."},{poem:`Six in the third place means:
Shock comes and makes one distraught.
If shock spurs to action
One remains free of misfortune.`,expl:"	There are three kinds of shock-the shock of heaven, which is thunder, the shock of fate, and, finally, the shock of the heart. The present hexagram refers less to inner shock than to the shock of fate. In such times of shock, presence of mind is all too easily lost: the individual overlooks all opportunities for action and mutely lets fate take its course. But if he allows the shocks of fate to induce movement within his mind, he will overcome these external blows with little effort."},{poem:`Nine in the fourth place means:
Shock is mired.`,expl:"Movement within the mind depends for its success partly on circumstances. If there is neither a resistance that might be vigorously combated, nor yet a yielding that permits of victory-if, instead, everything is tough and inert like mire-movement is crippled."},{poem:`Six in the fifth place means:
Shock goes hither and thither.
Danger.
However, nothing at all is lost.
Yet there are things to be done.`,expl:"This is a case not of a single shock but of repeated shocks with no breathing space between. Nonetheless, the shock causes no loss, because one takes care to stay in the center of movement and in this way to be spared the fate of being helplessly tossed hither and thither."}]}},{number:52,name:"K\xEAn",description:"Keeping Still, Mountain",trigrams:{above:{title:"ken",description:"KEEPING STILL, MOUNTAIN"},below:{title:"ken",description:"KEEPING STILL, MOUNTAIN"}},interpretation:{oracle:`	Keeping his back still
	So that he no longer feels his body.
	He goes into his courtyard
	And does not see his people.
	No blame.`,resume:`The image of this hexagram is the mountain, the youngest son of heaven and 
...
embody directions for the practice of yoga.
	`,judgment:`True quiet means keeping still when the time has come to keep still, and 
...
makes no mistakes.
	`,image:{oracle:`	Mountains standing close together:
	The image of KEEPING STILL.
	Thus the superior man
	Does not permit his thoughts 
	To go beyond his situation.`,image:`The heart thinks constantly. This cannot be changed, but the movements of 
...
No blame.
Continued perseverance furthers.`,expl:"Keeping the toes still means halting before one has even begun to move. The beginning is the time of few mistakes. At that time one is still in harmony with primal innocence. Not yet influenced by obscuring interests and desires, one sees things intuitively as they really are. A man who halts at the beginning, so long as he has not yet abandoned the truth, finds the right way. But persisting firmness is needed to keep one from drifting irresolutely.		Six in e second place means:	Keeping his calves still.	He cannot rescue him whom he follows.	His heart is not glad.The leg cannot move independently; it depends on the movement of the body. If a leg is suddenly stopped while the whole body is in vigorous motion, the continuing body movement will make one fall.  The same is true of a man who serves a master stronger than himself. He is swept along, and even though he may himself halt on the path of wrongdoing, he can no longer check the other in his powerful movement. Where the master presses forward, the servant, no matter how good his intentions, cannot save him."},{poem:`Nine in the third place means:
Keeping his hips still.
Making his sacrum stiff.
Dangerous. The heart suffocates.`,expl:"This refers to enforced quiet. The restless heart is to be subdued by forcible means. But fire when it is smothered changes into acrid smoke that suffocates as it spreads.  Therefore, in exercises in meditation and concentration, one ought not to try to force results. Rather, calmness must develop naturally out of a state of inner composure. If one tries to induce calmness by means of artificial rigidity, meditation will lead to very unwholesome results."},{poem:`Six in the fourth place means:
Keeping his trunk still.
No blame.`,expl:"As has been pointed out above in the comment on the Judgment, keeping the back at rest means forgetting the ego. This is the highest stage of rest. Here this stage has not yet been reached: the individual in this instance, though able to keep the ego, with its thoughts and impulses, in a state of rest, is not yet quite liberated from its dominance. Nonetheless, keeping the heart at rest is an important function, leading in the end to the complete elimination of egotistic drives. Even though at this point one does not yet remain free from all the dangers of doubt and unrest, this frame of mind is not a mistake, as it leads ultimately to that other, higher level."},{poem:`Six in the fifth place means:
Keeping his jaws still.
The words have order.
Remorse disappears.`,expl:"A man in a dangerous situation, especially when he is not adequate to it, is inclined to be very free with talk and presumptuous jokes. But injudicious speech easily leads to situations that subsequently give much cause for regret. However, if a man is reserved in speech, his words take ever more definite form, and every occasion for regret vanishes."}]}},{number:53,name:"Chien",description:"Development",trigrams:{above:{title:"sun",description:"THE GENTLE, WIND, WOOD"},below:{title:"ken",description:"KEEPING STILL, MOUNTAIN"}},interpretation:{oracle:`	The maiden
	Is given in marriage.
	Good fortune.
	Perseverance furthers.`,resume:`This hexagram is made up of Sun (wood, penetration) above, i.e., without, 
and K\xEAn (mountain, stillness) below, i.e., within. A tree on a mountain 
...
penetration, which makes development and progress possible.
	`,judgment:`The development of events that leads to a girl's following a man to his home 
...
to nothing.
	`,image:{oracle:`	On the mountain, a tree:
	The image of DEVELOPMENT.
	Thus the superior man abides in dignity and virtue,
	In order to improve the mores.`,image:`The tree on the mountain is visible from afar, and its development 
...
There is talk. No blame.`,expl:"All the individual lines in this hexagram symbolize the gradual flight of the wild goose. The wild goose is the symbol of conjugal fidelity, because it is believed that this bird never takes another mate after the death of the first.  The initial line suggests the first resting place in the flight of water birds from the water to the heights. The shore is reached. The situation is that of a lonely young man who is just starting out to make his way in life. Since no one comes to help him, his first steps are slow and hesitant, and he is surrounded by danger. Naturally he is subjected to much criticism. But these very difficulties keep him from being too hasty, and his progress is successful."},{poem:`Six in the second place means:
The wild goose gradually draws near the cliff.
Eating and drinking in peace and concord.
Good fortune.`,expl:"The cliff is a safe place on shore. The development has gone a step further. The initial insecurity has been overcome, and a safe position in life has been found, giving one enough to live on. This first success, opening up a path to activity, brings a certain joyousness of mood, and one goes to meet the future reassured.  It is said of the wild goose that it calls to its comrades whenever it finds food; this is the symbol of peace and concord in good fortune. A man does not want to keep his good luck for himself only, but is ready to share it with others."},{poem:`Nine in the third place means:
The wild goose gradually draws near the plateau.
The man goes forth and does not return.
The woman carries a child but does not bring it forth.
Misfortune. 
It furthers one to fight off robbers.`,expl:"The high plateau is dry and unsuitable for the wild goose. If it goes there, it has lost its way and gone too far. This is contrary to the law of development.  It is the same in human life. If we do not let things develop quietly but plunge of our own choice too rashly into a struggle, misfortune results. A man jeopardizes his own life, and his family perishes thereby. However, this is not all necessary; it is only the result of transgressing the law of natural development. If one does not willfully provoke a conflict, but confines himself to vigorously maintaining his own position and to warding off unjustified attacks, all goes well."},{poem:`Six in the fourth place means:
The wild goose goes gradually draws near the tree.
Perhaps it will find a flat branch. No blame.`,expl:"A tree is not a suitable place for a wild goose. But if it is clever, it will find a flat branch on which it can get a footing. A man's life too, in the course of its development, often brings him into inappropriate situations, in which he finds it difficult to hold his own without danger. Then it is important to be sensible and yielding. This enables him to discover a safe place in which life can go on, although he may be surrounded by danger."},{poem:`Nine in the fifth place means:
The wild goose gradually draws near the summit.
For three years the woman has no child.
In the end nothing can hinder her.
Good fortune.`,expl:"The summit is a high place. In a high position one easily becomes isolated. One is misjudged by the very person on whom one is dependent-the woman by her husband, the official by his superior. This is the work of deceitful persons who have wormed their way in. The result is that relationships remain sterile, and nothing is accomplished. But in the course of further development, such misunderstandings are cleared away, and reconciliation is achieved after all."}]}},{number:54,name:"Kuei Mei",description:"The Marrying Maiden",trigrams:{above:{title:"chen",description:"THE AROUSING, THUNDER"},below:{title:"tui",description:"THE JOYOUS, LAKE"}},interpretation:{oracle:`	Undertakings bring misfortune.
	Nothing that would further.`,resume:`Above we have Ch\xEAn, the eldest son, and below, Tui, the youngest daughter. 
...
other; H\xEAng, DURATION (32), portrays the permanent relationships of 
...
the guidance of an older man who marries her.
	`,judgment:`A girl who is taken into the family, but not as the chief wife, must behave 
...
spontaneous affection is the all-inclusive principle of union.
	`,image:{oracle:`	Thunder over the lake:
	The image of THE MARRYING MAIDEN.
	Thus the superior man
	Understands the transitory
	In the light of the eternity of the end.`,image:`Thunder stirs the water of the lake, which follows it in shimmering waves. 
...
She marries as a concubine.`,expl:"A girl who is in a lowly position and finds no husband may, in some circumstances, still win shelter as a concubine.  This pictures the situation of a person who longs too much for joys that cannot be obtained in the usual way. He enters upon a situation not altogether compatible with self-esteem. Neither judgment nor warning is added to this line; it merely lays bare the actual situation, so that everyone may draw a lesson from it."},{poem:`Nine in the fourth place means:
The marrying maiden draws out the allotted time.
A late marriage comes in due course.`,expl:"The girl is virtuous. She does not wish to throw herself away, and allows the customary time for marriage to slip by. However, there is no harm in this; she is rewarded for her purity and, even though belatedly, finds the husband intended for her.	"},{poem:`Six in the fifth place means:
The sovereign I gave his daughter in marriage.
The embroidered garments of the princess
Were not as gorgeous
As those of the serving maid.
The moon that is nearly full
Brings good fortune.`,expl:"The sovereign I is T'ang the Completer. This ruler decreed that the imperial princesses should be subordinated to their husbands in the same manner as other women (cf. Hexagram 11, six in the fifth place). The emperor does not wait for a suitor to woo his daughter but gives her in marriage when he sees fit. Therefore it is in accord with custom for the girl's family to take the initiative here.  We see here a girl of aristocratic birth who marries a man of modest circumstances and understands how to adapt herself with grace to the new situation. She is free of all vanity of outer adornment, and forgetting her rank in her marriage, takes a place below that of her husband, just as the moon, before it is quite full, does not directly face the sun."}]}},{number:55,name:"F\xEAng",description:"Abundance",trigrams:{above:{title:"chen",description:"THE AROUSING, THUNDER"},below:{title:"li",description:"THE CLINGING, FIRE"}},interpretation:{oracle:`	Abundance has success.
	The king attains abundance.
	Be not sad.
	Be like the sun at midday.`,resume:`Ch\xEAn is movement; Li is flame, whose attribute is clarity. Clarity within, 
...
abundance cannot be maintained permanently.
	`,judgment:`It is not given to every mortal to bring about a time of outstanding greatness 
...
illuminating and gladdening everything under heaven.
	`,image:{oracle:`	Both thunder and lightning come:
	The image of ABUNDANCE.
	Thus the superior man decides lawsuits
	And carries out punishments.`,image:`This hexagram has a certain connection with Shih Ho, BITING THROUGH 
...
facts exactly, and shock (Ch\xEAn) without ensures a strict and precise carrying 
out of punishments.
		`},lines:[{poem:`Nine at the beginning means:
...
Good fortune comes.`,expl:"It often happens that plots and party intrigues, which have the darkening effect of an eclipse of the sun, come between a ruler intent on great achievement and the man who could effect great undertakings. Then, instead of the sun, we see the northern stars in the sky. The ruler is overshadowed by a party that has usurped power. If a man at such a time were to try to take energetic measures, he would encounter only mistrust and envy, which would prohibit all movement. The essential thing then is to hold inwardly to the power of truth, which in the end is so strong that it exerts an invisible influence on the ruler, so that all goes well."},{poem:`Nine in the third place means:
The underbrush is of such abundance
That the small stars can be seen at noon.
He breaks his right arm . No blame.`,expl:"The image is that of a progressive covering over of the sun.  Here the eclipse reaches totality, therefore even the small stars can be seen at noon.  In the sphere of social relationships, this means that the prince is now so eclipsed that even the most insignificant persons can push themselves into the foreground. This makes it impossible for an able man, though he might be the right hand of the ruler, to undertake anything. It is as though his arm were broken, but he is not to blame for being thus hindered in action."},{poem:`Nine in the fourth place means:
The curtain is of such fullness
That the polestars can be seen at noon.
He meets his ruler, who is of like kind.
Good fortune.`,expl:"Here the darkness is already decreasing, therefore interrelated elements come together. Here too the complement must be found-the necessary wisdom to complement joy of action. Then everything will go well. The complementary factor postulated here is the reverse of the one in the first line. In the latter, wisdom is to be complemented by energy, while here energy is complemented by wisdom."},{poem:`Six in the fifth place means:
Lines are coming,
Blessing and fame draw near.
Good fortune.`,expl:"The ruler is modest and therefore open to the counsel of able men. Thus he is surrounded by men who suggest to him the lines of action. This brings blessing, fame, and good fortune to him and all the people."}]}},{number:56,name:"L\xFC",description:"The Wanderer",trigrams:{above:{title:"li",description:"THE CLINGING, FIRE"},below:{title:"ken",description:"KEEPING STILL, MOUNTAIN"}},interpretation:{oracle:`	Success through smallness.
	Perseverence brings good fortune
	To the wanderer.`,resume:`The mountain, K\xEAn, stands still; above it fire, Li, flames up and does not tarry. 
...
wins success.
	`,judgment:`  A wanderer has no fixed abode; his home is the road. Therefore he must 
...
and can go his way unmolested.
	`,image:{oracle:`	Fire on the mountain:
	The image of THE WANDERER.
	Thus the superior man
	Is clear-minded and cautious
	In imposing penalties,
	And protracts no lawsuits.`,image:`When grass on a mountain takes fire, there is bright light. However, the fire 
...
He draws down misfortune upon himself.`,expl:"A wanderer should not demean himself or busy himself with inferior things he meets with along the way. The humbler and more defenseless his outward position, the more should he preserve his inner dignity. For a stranger is mistaken if he hopes to find a friendly reception through lending himself to jokes and buffoonery. The result will be only contempt and insulting treatment."},{poem:`Six in the second place means:
The wanderer comes to an inn.
He has his property with him.
He wins the steadfastness of a young servant.`,expl:"	The wanderer her described is modest and reserved. He does not lose touch with his inner being, hence he finds a resting place. In the outside world he does not lose the liking of other people, hence all persons further him, so that he can acquire property. Moreover, he wins the allegiance of a faithful and trustworthy servant-a thing of inestimable value to a wanderer."},{poem:`Nine in the third place means:
The wanderer's inn burns down.
He loses the steadfastness of his young servant.
Danger.`,expl:"A truculent stranger does not know how to behave properly. He meddles in affairs and controversies that do not concern him; thus he loses his resting place. He treats his servant with aloofness and arrogance; thus he loses the man's loyalty. When a stranger in a strange land has no one left on whom he can rely, the situation becomes very dangerous."},{poem:`Nine in the fourth place means:
The wanderer rests in a shelter.
He obtains his property and an ax.
My heart is not glad.`,expl:"This describes a wanderer who knows how to limit his desires outwardly, though he is inwardly strong and aspiring. Therefore he finds at least a place of shelter in which he can stay. He also succeeds in acquiring property, but even with this he is not secure. He must be always on guard, ready to defend himself with arms. Hence he is not at ease. He is persistently conscious of being a stranger in a strange land."},{poem:`Six in the fifth place means:
He shoots a pheasant.
It drops with the first arrow.
In the end this brings both praise and office.`,expl:"Traveling statesman were in the habit of introducing themselves to local princes with the gift of a pheasant, killing it at the first shot. Thus he finds friends who praise and recommend him, and in the end the prince accepts him and confers an office upon him.  Circumstances often cause a man to seek a home in foreign parts. If he knows how to meet the situation and how to introduce himself in the right way, he may find a circle of friends and a sphere of activity even in a strange country."}]}},{number:57,name:"Sun",description:"The Gentle",trigrams:{above:{title:"sun",description:"THE GENTLE, WIND, WOOD"},below:{title:"sun",description:"THE GENTLE, WIND, WOOD"}},interpretation:{oracle:`Success through what is small.
	It furthers one to have somewhere to go.
	It furthers one to see the great man.`,resume:`Sun is one of the eight doubled trigrams. It is the eldest daughter and 
...
which shun the light of day.
	`,judgment:`Penetration produces gradual and inconspicuous effects. It should be effected 
...
is capable of creating order.
	`,image:{oracle:`	Winds following one upon the other:
	The image of THE GENTLY PENETRATING.
	Thus the superior man 
	Spreads his commands abroad
	And carries out his undertakings.`,image:`The penetrating quality of the wind depends upon its ceaselessness. This is 
...
The perseverance of a warrior furthers.`,expl:"In born gentleness is often carried to the point of indecisiveness. One does not feel strong enough to advance resolutely. A thousand doubts crop up; one is, however, not minded to withdraw but drifts indecisively to and fro. In such a situation, a military decisiveness is the proper thing, so that one resolutely does what order demands. Resolute discipline is far better than irresolute license."},{poem:`Nine in the second place means:
Penetration under the bed.
Priests and magicians are used in great number.
Good fortune. No blame.`,expl:"At times one has to deal with hidden enemies, intangible influences that slink into dark corners and from this hiding affect people by suggestion. In instances like this, it is necessary to trace these things back to the most secret recesses, in order to determine the nature of the influences to be dealt with. This is the task of the priests; removing the influences is the task of the magicians. The very anonymity of such plotting requires an especially vigorous and indefatigable effort, but this is well worth while. For when such elusive influences are brought into the light and branded, they lose their power over people."},{poem:`Nine in the third place means:
Repeated penetration. Humiliation.`,expl:"Penetrating reflection must not be pushed too far, lest it cripple the power of decision. After a matter has been thoroughly pondered, it is essential to form a decision and to act. Repeated deliberation brings fresh doubts and scruples, and thereby humiliation, because one shows oneself unable to act."},{poem:`Six in the fourth place means:
Remorse vanishes.
During the hunt
Three kinds of game are caught.`,expl:"When a responsible position and accumulated experience lead one to combine innate modesty with energetic action, great success is assured. The three kinds of animals referred to served for offerings to the gods, for feasting guests, and for everyday consumption. When the catch answered all three purposes, the hunt was considered especially successful."},{poem:`Nine in the fifth place means:
Perseverance brings good fortune.
Remorse vanishes.
...
outwardly as yielding and gentle.
	`,judgment:`The joyous mood is infectious and therefore brings success. But joy must be 
...
will not shun death itself, so great is the power of joy over men.
	`,image:{oracle:`	Lakes resting one on the other:
	The image of THE JOYOUS.
	Thus the superior man joins with his friends
	For discussion and practice.`,image:`A lake evaporates upward and thus gradually dries up; but when two lakes 
...
sided about the learning of the self-taught.
		`},lines:[{poem:`Nine at the beginning means:
Contented joyousness. Good fortune.`,expl:"A quiet, wordless, self-contained joy, desiring nothing from without and resting content with everything, remains free of all egotistic likes and dislikes. In this freedom lies good fortune, because it harbors the quiet security of a heart fortified within itself."},{poem:`Nine in the second place means:
Sincere joyousness. Good fortune.
Remorse disappears.`,expl:"We often find ourselves associating with inferior people in whose company we are tempted by pleasures that are inappropriate for the superior man. To participate in such pleasures would certainly bring remorse, for a superior man can find no real satisfaction in low pleasures. When, recognizing this, a man does not permit his will to swerve, so that he does not find such ways agreeable, not even dubious companions will venture to proffer any base pleasures, because he would not enjoy them. Thus every cause for regret is removed."},{poem:`Six in the third place means:
Coming joyousness. Misfortune.`,expl:"True joy must spring from within. But if one is empty within and wholly given over to the world, idle pleasures come streaming in from without. This is what many people welcome as diversion. Those who lack inner stability and therefore need amusement, will always find opportunity of indulgence. They attract external pleasures by the emptiness of their natures. Thus they lose themselves more and more, which of course has bad results."},{poem:`Nine in the fourth place means:
Joyousness that is weighed is not at peace.
After ridding himself of mistakes a man has joy.`,expl:"Often a man finds himself weighing the choice between various kinds of pleasures, and so long as he has not decided which kind he will choose, the higher or the lower, he has no inner peace. Only when he clearly recognizes that passion brings suffering, can he make up his mind to turn away from the lower pleasures and to strive for the higher. Once this decision is sealed, he finds true joy and peace, and inner conflict is overcome."},{poem:`Nine in the fifth place means:
Sincerity toward disintegrating influences is dangerous.`,expl:"Dangerous elements approach even the far best of men. If a man permits himself to have anything to do with them, their disintegrating influence acts slowly but surely, and inevitable brings dangers in its train. But if he recognizes the situation and can comprehend the danger, he knows how to protect himself and remains unharmed."}]}},{number:59,name:"Huan",description:"Dispersion",trigrams:{above:{title:"sun",description:"THE GENTLE, WIND"},below:{title:"kan",description:"THE ABYSMAL, WATER"}},interpretation:{oracle:`Success.
	The king approaches his temple.
	It furthers one to cross the great water.
	Perseverance furthers.`,resume:`Wind blowing over water disperses it, dissolving it into foam and mist. This 
...
up and dissolve the blockage.
	`,judgment:`The text of this hexagram resembles that of Ts'ui, GATHERING TOGETHER (45). 
...
hardness of egotism.
	`,image:{oracle:`	The wind drives over the water:
	The image of DISPERSION.
	Thus the kings of old sacrificed to the Lord
	And built temples.`,image:`In the autumn and winter, water begins to freeze into ice. When the warm 
...
Good fortune.`,expl:"It is important that disunion should be overcome at the outset, before it has become complete-that the clouds should be dispersed before they have brought storm and rain. At such times when hidden divergences in temper make themselves felt and lead to mutual misunderstandings we must take quick and vigorous action to dissolve the misunderstandings and mutual distrust."},{poem:`Nine in the second place means:
At the dissolution
He hurries to that which supports him.
Remorse disappears.`,expl:"When an individual discovers within himself the beginnings of alienation from others, of misanthropy and ill humor, he must set about dissolving these obstructions. He must rouse himself inwardly, hasten to that which supports him. Such support is never found in hatred, but always in a moderate and just judgment of men, linked with good will. If he regains this unobstructed outlook on humanity, while at the same time all saturnine ill humor is dissolved, all occasion for remorse disappears."},{poem:`Six in the third place means:
He dissolves his self. No remorse.`,expl:"Under certain circumstances, a man's work may become so difficult that he can no longer think of himself. He must set aside all personal desires and disperse whatever the self gathers about it to serve as a barrier against others. Only on the basis of great renunciation can he obtain the strength for great achievements. By setting his goal in a great task outside himself, he can attain this standpoint."},{poem:`Six in the fourth place means:
He dissolves his bond with his group.
Supreme good fortune.
Dispersion leads in turn to accumulation.
This is something that ordinary men do not think of.`,expl:"When we are working at a task that affects the general welfare, we must leave all private friendships out of account. Only by rising above party interests can we achieve something decisive. He who has the courage thus to forego what is near wins what is afar. But in order to comprehend this standpoint, one must have a wide view of the interrelationships of life, such as only unusual men attain."}]}},{number:60,name:"Chieh",description:"Limitation",trigrams:{above:{title:"kan",description:"THE ABYSMAL, WATER"},below:{title:"tui",description:"THE JOYOUS, LAKE"}},interpretation:{oracle:`Success.
	Galling limitation must not be persevered in.`,resume:`A lake occupies a limited space. When more water comes into it, it 
...
disinterestedness.
	`,judgment:`Limitations are troublesome, but they are effective. If we live economically 
...
Therefore it is necessary to set limits even upon limitation.
	`,image:{oracle:`	Water over lake: the image of LIMITATION.
	Thus the superior man
	Creates number and measure,
	And examines the nature of virtue and correct conduct.`,image:`A lake is something limited. Water is inexhaustible. A lake can contain only 
...
these ideas.
	`,judgment:`Pigs and fishes are the least intelligent of all animals and therefore the most 
...
everything.
	`,image:{oracle:`	Wind over lake: the image of INNER TRUTH.
	Thus the superior man discusses criminal cases 
	In order to delay executions.`,image:`Wind stirs water by penetrating it. Thus the superior man, when obliged to 
...
If there are secret designs, it is disquieting.`,expl:"The force of inner truth depends chiefly on inner stability and preparedness. From this state of mind springs the correct attitude toward the outer world. But if a man should try to cultivate secret relationships of a special sort, it would deprive him of his inner independence. The more reliance he places on the support of others, the more uneasy and anxious he will become as to whether these secret ties are really tenable. In this way inner peace and the force of inner truth are lost."},{poem:`Nine in the second place means:
A crane calling in the shade.
Its young answers it.
I have a good goblet.
I will share it with you.`,expl:"This refers to the involuntary influence of a man's inner being upon persons of kindred spirit. The crane need not show itself on a high hill. It may be quite hidden when it sounds its call; yet its young will hear its not, will recognize it and give answer. Where there is a joyous mood, there a comrade will appear to share a glass of wine.  This is the echo awakened in men through spiritual attraction. Whenever a feeling is voiced with truth and frankness, whenever a deed is the clear expression of sentiment, a mysterious and far-reaching influence is exerted. At first it acts on those who are inwardly receptive. But the circle grows larger and larger. The root of all influence lies in one's own inner being: given true and vigorous expression in word and deed, its effect is great. The effect is but the reflection of something that emanates from one's own heart. Any deliberate intention of an effect would only destroy the possibility of producing it. Confucius says about this line:The superior man abides in his room. If his words are well spoken, he meets with assent at a distance of more than a thousand miles. How much more then from near by! If the superior man abides in his room and his words are not well spoken, he meets with contradiction at a distance of more than a thousand miles. How much more then from near by! Words go forth from one's own person and exert their influence on men. Deeds are born close at hand and become visible far away. Words and deeds are the hinge and bowspring of the superior man. As hinge and bowspring move, they bring honor or disgrace. Through words and deeds the superior man moves heaven and earth . Must one not, then, be cautious?"},{poem:`Six in the third place means:
He finds a comrade.
Now he beats the drum, now he stops.
Now he sobs, now he sings.`,expl:"Here the source of a man's strength lies not in himself but in his relation to other people. No matter how close to them he may be, if his center of gravity depends on them, he is inevitably tossed to and fro between joy and sorrow. Rejoicing to high heaven, then sad unto death-this is the fate of those who depend upon an inner accord with other persons whom they love. Here we have only the statement of the law that this is so. Whether this condition is felt to be an affliction of the supreme happiness of love, is left to the subjective verdict of the person concerned."},{poem:`Six in the fourth place means:
The moon nearly at the full.
The team horse goes astray.
No blame.`,expl:"To intensify the power of inner truth, a man must always turn to his superior, from whom he can receive enlightenment as the moon receives light form the sun. However, this requires a certain humility, like that of the moon when it is not yet quite full. At the moment when the moon becomes full and stands directly opposite the sun, it begins to wane. Just as on the one hand we must be humble and reverent when face to face with the source of enlightenment, so likewise must we on the other renounce factionalism among men. Only be pursuing one's course like a horse that goes straight ahead without looking sidewise at its mate, can one retain the inner freedom that helps one onward."},{poem:`Nine in the fifth place means:
He possesses truth, which links together.
No blame.`,expl:"This describes the ruler who holds all elements together by the power of his personality. Only when the strength of his character is so ample that he can influence all who are subject to him, is he as he needs to be. The power of suggestion must emanate from the ruler. It will firmly knit together and unite all his adherents. Without this central force, all external unity is only deception and breaks down at the decisive moment."}]}},{number:62,name:"Hsiao Kuo",description:"Preponderance of the Small",trigrams:{above:{title:"chen",description:"THE AROUSING, THUNDER"},below:{title:"ken",description:"KEEPING STILL, MOUNTAIN"}},interpretation:{oracle:`Success.
	Perseverance furthers.
	Small things may be done; great things should not be done.
	The flying bird brings the message:
	It is not well to strive upward,
	It is well to remain below.
	Great good fortune.`,resume:`While in the hexagram Ta Kuo, PREPONDERANCE OF THE GREAT (28), the 
...
is necessary.
	`,judgment:`Exceptional modesty and conscientiousness are sure to be rewarded with 
...
hexagram.
	`,image:{oracle:`	Thunder on the mountain:
	The image of PREPONDERANCE OF THE SMALL.
	Thus in his conduct the superior man gives preponderance to reverence.
	In bereavement he gives preponderance to grief.
	In his expenditures he gives preponderance to thrift.`,image:`Thunder on the mountain is different from thunder on the plain. In the 
...
which necessitate the utmost caution.
	`,judgment:`The transition from the old to the new time is already accomplished. In 
...
perseverance and caution.
	`,image:{oracle:`	Water over fire: the image of the condition 
	In AFTER COMPLETION.
	Thus the superior man 
	Takes thought of misfortune
	And arms himself against it in advance.`,image:`When water in a kettle hangs over fire, the two elements stand in relation 
...
come to its close.
	`,judgment:`The conditions are difficult. The task is great and full of responsibility. It is 
...
completion," deliberation and caution are the prerequisites of success.
	`,image:{oracle:`	Fire over water:
	The image of the condition before transition.
	Thus the superior man is careful
	In the differentiation of things,
	So that each finds its place.`,image:`When fire, which by nature flames upward, is above, and water, which flows 
...
only from this vantage can we work correctly.
		`},lines:[{poem:`Six at the beginning means:
He gets his tail in the water.
Humiliating.`,expl:"In times of disorder there is a temptation to advance oneself as rapidly as possible in order to accomplish something tangible. But this enthusiasm leads only to failure and humiliation if the time for achievement has not yet arrived. In such time it is wise to spare ourselves the opprobrium of failure by holding back."},{poem:`Nine in the second place means:
He brakes his wheels.
Perseverance brings good fortune.`,expl:"Here again the time to act has not yet come. But the patience needed is not that of idle waiting without thought of the morrow. Kept up indefinitely, this would not lead to any success. Instead, an individual must develop in himself the strength that will enable him to go forward. He must have a vehicle, as it were, to effect the crossing. But he must for the time being use the brakes. Patience in the highest sense means putting brakes on strength. Therefore he must not fall asleep and lose sight of the goal. If he remains strong and steadfast in his resolve, all goes well in the end."},{poem:`Six in the third place means:
Before completion, attack brings misfortune.
It furthers one to cross the great water.`,expl:"The time of transition has arrived, but one lacks the strength to complete the transition. If one should attempt to force it, disaster would result, because collapse would then be unavoidable. What is to be done? A new situation must be created; one must engage the energies of able helpers and in this fellowship take the decisive step-cross the great water. Then completion will become possible."},{poem:`Nine in the fourth place means:
Perseverance brings good fortune.
Remorse disappears.
Shock, thus to discipline the Devil's Country.
For three years, great realms are rewarded.`,expl:"Now it is the time of struggle. The transition must be completed. We must make ourselves strong in resolution; this brings good fortune. All misgivings that might arise in such grave times of struggle must be silenced. It is a question of a fierce battle to break and to discipline the Devil's Country, the forces of decadence. But the struggle also has its reward. Now is the time to lay the foundations of power and mastery for the future."},{poem:`Six in the fifth place means:
Perseverance brings good fortune.
No remorse.
The light of the superior man is true.
Good fortune.`,expl:"The victory has been won. The power of steadfastness has not been routed. Everything has gone well. All misgivings have been overcome. Success has justified the deed. The light of a superior personality shines forth anew and makes its influence felt among men who have faith in it and rally around it. The new time has arrived, and with it good fortune. And just as the sun shines forth in redoubled beauty after rain, or as a forest grows more freshly green from charred ruins after a fire, so the new era appears all the more glorious by contrast with the misery of the old."}]}}];console.info("Book loaded",performance.now());window.Book=is;const os="modulepreload",zn={},as="/",wo=function(t,n){return!n||n.length===0?t():Promise.all(n.map(i=>{if(i=`${as}${i}`,i in zn)return;zn[i]=!0;const o=i.endsWith(".css"),a=o?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${i}"]${a}`))return;const s=document.createElement("link");if(s.rel=o?"stylesheet":os,o||(s.as="script",s.crossOrigin=""),s.href=i,document.head.appendChild(s),o)return new Promise((l,d)=>{s.addEventListener("load",l),s.addEventListener("error",()=>d(new Error(`Unable to preload CSS for ${i}`)))})})).then(()=>t())};var Ge,b,bo,yo,Fe,vo,Yn,To,ot={},ko=[],ss=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;function ne(e,t){for(var n in t)e[n]=t[n];return e}function _o(e){var t=e.parentNode;t&&t.removeChild(e)}function J(e,t,n){var i,o,a,s={};for(a in t)a=="key"?i=t[a]:a=="ref"?o=t[a]:s[a]=t[a];if(arguments.length>2&&(s.children=arguments.length>3?Ge.call(arguments,2):n),typeof e=="function"&&e.defaultProps!=null)for(a in e.defaultProps)s[a]===void 0&&(s[a]=e.defaultProps[a]);return Le(e,s,i,o,null)}function Le(e,t,n,i,o){var a={type:e,props:t,key:n,ref:i,__k:null,__:null,__b:0,__e:null,__d:void 0,__c:null,__h:null,constructor:void 0,__v:o==null?++bo:o};return o==null&&b.vnode!=null&&b.vnode(a),a}function xo(){return{current:null}}function Y(e){return e.children}function H(e,t){this.props=e,this.context=t}function ve(e,t){if(t==null)return e.__?ve(e.__,e.__.__k.indexOf(e)+1):null;for(var n;t<e.__k.length;t++)if((n=e.__k[t])!=null&&n.__e!=null)return n.__e;return typeof e.type=="function"?ve(e):null}function Io(e){var t,n;if((e=e.__)!=null&&e.__c!=null){for(e.__e=e.__c.base=null,t=0;t<e.__k.length;t++)if((n=e.__k[t])!=null&&n.__e!=null){e.__e=e.__c.base=n.__e;break}return Io(e)}}function Vt(e){(!e.__d&&(e.__d=!0)&&Fe.push(e)&&!at.__r++||Yn!==b.debounceRendering)&&((Yn=b.debounceRendering)||vo)(at)}function at(){for(var e;at.__r=Fe.length;)e=Fe.sort(function(t,n){return t.__v.__b-n.__v.__b}),Fe=[],e.some(function(t){var n,i,o,a,s,l;t.__d&&(s=(a=(n=t).__v).__e,(l=n.__P)&&(i=[],(o=ne({},a)).__v=a.__v+1,pn(l,a,o,n.__n,l.ownerSVGElement!==void 0,a.__h!=null?[s]:null,i,s==null?ve(a):s,a.__h),No(i,a),a.__e!=s&&Io(a)))})}function Ao(e,t,n,i,o,a,s,l,d,u){var r,f,h,c,m,p,g,w=i&&i.__k||ko,v=w.length;for(n.__k=[],r=0;r<t.length;r++)if((c=n.__k[r]=(c=t[r])==null||typeof c=="boolean"?null:typeof c=="string"||typeof c=="number"||typeof c=="bigint"?Le(null,c,null,null,c):Array.isArray(c)?Le(Y,{children:c},null,null,null):c.__b>0?Le(c.type,c.props,c.key,null,c.__v):c)!=null){if(c.__=n,c.__b=n.__b+1,(h=w[r])===null||h&&c.key==h.key&&c.type===h.type)w[r]=void 0;else for(f=0;f<v;f++){if((h=w[f])&&c.key==h.key&&c.type===h.type){w[f]=void 0;break}h=null}pn(e,c,h=h||ot,o,a,s,l,d,u),m=c.__e,(f=c.ref)&&h.ref!=f&&(g||(g=[]),h.ref&&g.push(h.ref,null,c),g.push(f,c.__c||m,c)),m!=null?(p==null&&(p=m),typeof c.type=="function"&&c.__k===h.__k?c.__d=d=Eo(c,d,e):d=So(e,c,h,w,m,d),typeof n.type=="function"&&(n.__d=d)):d&&h.__e==d&&d.parentNode!=e&&(d=ve(h))}for(n.__e=p,r=v;r--;)w[r]!=null&&(typeof n.type=="function"&&w[r].__e!=null&&w[r].__e==n.__d&&(n.__d=ve(i,r+1)),Co(w[r],w[r]));if(g)for(r=0;r<g.length;r++)Ho(g[r],g[++r],g[++r])}function Eo(e,t,n){for(var i,o=e.__k,a=0;o&&a<o.length;a++)(i=o[a])&&(i.__=e,t=typeof i.type=="function"?Eo(i,t,n):So(n,i,i,o,i.__e,t));return t}function Q(e,t){return t=t||[],e==null||typeof e=="boolean"||(Array.isArray(e)?e.some(function(n){Q(n,t)}):t.push(e)),t}function So(e,t,n,i,o,a){var s,l,d;if(t.__d!==void 0)s=t.__d,t.__d=void 0;else if(n==null||o!=a||o.parentNode==null)e:if(a==null||a.parentNode!==e)e.appendChild(o),s=null;else{for(l=a,d=0;(l=l.nextSibling)&&d<i.length;d+=2)if(l==o)break e;e.insertBefore(o,a),s=a}return s!==void 0?s:o.nextSibling}function rs(e,t,n,i,o){var a;for(a in n)a==="children"||a==="key"||a in t||st(e,a,null,n[a],i);for(a in t)o&&typeof t[a]!="function"||a==="children"||a==="key"||a==="value"||a==="checked"||n[a]===t[a]||st(e,a,t[a],n[a],i)}function Vn(e,t,n){t[0]==="-"?e.setProperty(t,n):e[t]=n==null?"":typeof n!="number"||ss.test(t)?n:n+"px"}function st(e,t,n,i,o){var a;e:if(t==="style")if(typeof n=="string")e.style.cssText=n;else{if(typeof i=="string"&&(e.style.cssText=i=""),i)for(t in i)n&&t in n||Vn(e.style,t,"");if(n)for(t in n)i&&n[t]===i[t]||Vn(e.style,t,n[t])}else if(t[0]==="o"&&t[1]==="n")a=t!==(t=t.replace(/Capture$/,"")),t=t.toLowerCase()in e?t.toLowerCase().slice(2):t.slice(2),e.l||(e.l={}),e.l[t+a]=n,n?i||e.addEventListener(t,a?Xn:Jn,a):e.removeEventListener(t,a?Xn:Jn,a);else if(t!=="dangerouslySetInnerHTML"){if(o)t=t.replace(/xlink[H:h]/,"h").replace(/sName$/,"s");else if(t!=="href"&&t!=="list"&&t!=="form"&&t!=="tabIndex"&&t!=="download"&&t in e)try{e[t]=n==null?"":n;break e}catch{}typeof n=="function"||(n!=null&&(n!==!1||t[0]==="a"&&t[1]==="r")?e.setAttribute(t,n):e.removeAttribute(t))}}function Jn(e){this.l[e.type+!1](b.event?b.event(e):e)}function Xn(e){this.l[e.type+!0](b.event?b.event(e):e)}function pn(e,t,n,i,o,a,s,l,d){var u,r,f,h,c,m,p,g,w,v,_,y=t.type;if(t.constructor!==void 0)return null;n.__h!=null&&(d=n.__h,l=t.__e=n.__e,t.__h=null,a=[l]),(u=b.__b)&&u(t);try{e:if(typeof y=="function"){if(g=t.props,w=(u=y.contextType)&&i[u.__c],v=u?w?w.props.value:u.__:i,n.__c?p=(r=t.__c=n.__c).__=r.__E:("prototype"in y&&y.prototype.render?t.__c=r=new y(g,v):(t.__c=r=new H(g,v),r.constructor=y,r.render=ls),w&&w.sub(r),r.props=g,r.state||(r.state={}),r.context=v,r.__n=i,f=r.__d=!0,r.__h=[]),r.__s==null&&(r.__s=r.state),y.getDerivedStateFromProps!=null&&(r.__s==r.state&&(r.__s=ne({},r.__s)),ne(r.__s,y.getDerivedStateFromProps(g,r.__s))),h=r.props,c=r.state,f)y.getDerivedStateFromProps==null&&r.componentWillMount!=null&&r.componentWillMount(),r.componentDidMount!=null&&r.__h.push(r.componentDidMount);else{if(y.getDerivedStateFromProps==null&&g!==h&&r.componentWillReceiveProps!=null&&r.componentWillReceiveProps(g,v),!r.__e&&r.shouldComponentUpdate!=null&&r.shouldComponentUpdate(g,r.__s,v)===!1||t.__v===n.__v){r.props=g,r.state=r.__s,t.__v!==n.__v&&(r.__d=!1),r.__v=t,t.__e=n.__e,t.__k=n.__k,t.__k.forEach(function(x){x&&(x.__=t)}),r.__h.length&&s.push(r);break e}r.componentWillUpdate!=null&&r.componentWillUpdate(g,r.__s,v),r.componentDidUpdate!=null&&r.__h.push(function(){r.componentDidUpdate(h,c,m)})}r.context=v,r.props=g,r.state=r.__s,(u=b.__r)&&u(t),r.__d=!1,r.__v=t,r.__P=e,u=r.render(r.props,r.state,r.context),r.state=r.__s,r.getChildContext!=null&&(i=ne(ne({},i),r.getChildContext())),f||r.getSnapshotBeforeUpdate==null||(m=r.getSnapshotBeforeUpdate(h,c)),_=u!=null&&u.type===Y&&u.key==null?u.props.children:u,Ao(e,Array.isArray(_)?_:[_],t,n,i,o,a,s,l,d),r.base=t.__e,t.__h=null,r.__h.length&&s.push(r),p&&(r.__E=r.__=null),r.__e=!1}else a==null&&t.__v===n.__v?(t.__k=n.__k,t.__e=n.__e):t.__e=hs(n.__e,t,n,i,o,a,s,d);(u=b.diffed)&&u(t)}catch(x){t.__v=null,(d||a!=null)&&(t.__e=l,t.__h=!!d,a[a.indexOf(l)]=null),b.__e(x,t,n)}}function No(e,t){b.__c&&b.__c(t,e),e.some(function(n){try{e=n.__h,n.__h=[],e.some(function(i){i.call(n)})}catch(i){b.__e(i,n.__v)}})}function hs(e,t,n,i,o,a,s,l){var d,u,r,f=n.props,h=t.props,c=t.type,m=0;if(c==="svg"&&(o=!0),a!=null){for(;m<a.length;m++)if((d=a[m])&&(d===e||(c?d.localName==c:d.nodeType==3))){e=d,a[m]=null;break}}if(e==null){if(c===null)return document.createTextNode(h);e=o?document.createElementNS("http://www.w3.org/2000/svg",c):document.createElement(c,h.is&&h),a=null,l=!1}if(c===null)f===h||l&&e.data===h||(e.data=h);else{if(a=a&&Ge.call(e.childNodes),u=(f=n.props||ot).dangerouslySetInnerHTML,r=h.dangerouslySetInnerHTML,!l){if(a!=null)for(f={},m=0;m<e.attributes.length;m++)f[e.attributes[m].name]=e.attributes[m].value;(r||u)&&(r&&(u&&r.__html==u.__html||r.__html===e.innerHTML)||(e.innerHTML=r&&r.__html||""))}if(rs(e,h,f,o,l),r)t.__k=[];else if(m=t.props.children,Ao(e,Array.isArray(m)?m:[m],t,n,i,o&&c!=="foreignObject",a,s,a?a[0]:n.__k&&ve(n,0),l),a!=null)for(m=a.length;m--;)a[m]!=null&&_o(a[m]);l||("value"in h&&(m=h.value)!==void 0&&(m!==e.value||c==="progress"&&!m)&&st(e,"value",m,f.value,!1),"checked"in h&&(m=h.checked)!==void 0&&m!==e.checked&&st(e,"checked",m,f.checked,!1))}return e}function Ho(e,t,n){try{typeof e=="function"?e(t):e.current=t}catch(i){b.__e(i,n)}}function Co(e,t,n){var i,o;if(b.unmount&&b.unmount(e),(i=e.ref)&&(i.current&&i.current!==e.__e||Ho(i,null,t)),(i=e.__c)!=null){if(i.componentWillUnmount)try{i.componentWillUnmount()}catch(a){b.__e(a,t)}i.base=i.__P=null}if(i=e.__k)for(o=0;o<i.length;o++)i[o]&&Co(i[o],t,typeof e.type!="function");n||e.__e==null||_o(e.__e),e.__e=e.__d=void 0}function ls(e,t,n){return this.constructor(e,n)}function de(e,t,n){var i,o,a;b.__&&b.__(e,t),o=(i=typeof n=="function")?null:n&&n.__k||t.__k,a=[],pn(t,e=(!i&&n||t).__k=J(Y,null,[e]),o||ot,ot,t.ownerSVGElement!==void 0,!i&&n?[n]:o?null:t.firstChild?Ge.call(t.childNodes):null,a,!i&&n?n:o?o.__e:t.firstChild,i),No(a,e)}function gn(e,t){de(e,t,gn)}function Oo(e,t,n){var i,o,a,s=ne({},e.props);for(a in t)a=="key"?i=t[a]:a=="ref"?o=t[a]:s[a]=t[a];return arguments.length>2&&(s.children=arguments.length>3?Ge.call(arguments,2):n),Le(e.type,s,i||e.key,o||e.ref,null)}function Po(e,t){var n={__c:t="__cC"+To++,__:e,Consumer:function(i,o){return i.children(o)},Provider:function(i){var o,a;return this.getChildContext||(o=[],(a={})[t]=this,this.getChildContext=function(){return a},this.shouldComponentUpdate=function(s){this.props.value!==s.value&&o.some(Vt)},this.sub=function(s){o.push(s);var l=s.componentWillUnmount;s.componentWillUnmount=function(){o.splice(o.indexOf(s),1),l&&l.call(s)}}),i.children}};return n.Provider.__=n.Consumer.contextType=n}Ge=ko.slice,b={__e:function(e,t){for(var n,i,o;t=t.__;)if((n=t.__c)&&!n.__)try{if((i=n.constructor)&&i.getDerivedStateFromError!=null&&(n.setState(i.getDerivedStateFromError(e)),o=n.__d),n.componentDidCatch!=null&&(n.componentDidCatch(e),o=n.__d),o)return n.__E=n}catch(a){e=a}throw e}},bo=0,yo=function(e){return e!=null&&e.constructor===void 0},H.prototype.setState=function(e,t){var n;n=this.__s!=null&&this.__s!==this.state?this.__s:this.__s=ne({},this.state),typeof e=="function"&&(e=e(ne({},n),this.props)),e&&ne(n,e),e!=null&&this.__v&&(t&&this.__h.push(t),Vt(this))},H.prototype.forceUpdate=function(e){this.__v&&(this.__e=!0,e&&this.__h.push(e),Vt(this))},H.prototype.render=Y,Fe=[],vo=typeof Promise=="function"?Promise.prototype.then.bind(Promise.resolve()):setTimeout,at.__r=0,To=0;var us=Object.freeze(Object.defineProperty({__proto__:null,render:de,hydrate:gn,createElement:J,h:J,Fragment:Y,createRef:xo,get isValidElement(){return yo},Component:H,cloneElement:Oo,createContext:Po,toChildArray:Q,get options(){return b}},Symbol.toStringTag,{value:"Module"})),ds=0;function T(e,t,n,i,o){var a,s,l={};for(s in t)s=="ref"?a=t[s]:l[s]=t[s];var d={type:e,props:l,key:n,ref:a,__k:null,__:null,__b:0,__e:null,__d:void 0,__c:null,__h:null,constructor:void 0,__v:--ds,__source:i,__self:o};if(typeof e=="function"&&(a=e.defaultProps))for(s in a)l[s]===void 0&&(l[s]=a[s]);return b.vnode&&b.vnode(d),d}typeof window!="undefined"&&window.__PREACT_DEVTOOLS__&&window.__PREACT_DEVTOOLS__.attachPreact("10.5.15",b,{Fragment:Y,Component:H});var Qn={};function se(e){return e.type===Y?"Fragment":typeof e.type=="function"?e.type.displayName||e.type.name:typeof e.type=="string"?e.type:"#text"}var Me=[],be=[];function $o(){return Me.length>0?Me[Me.length-1]:null}var Zn=!1;function jt(e){return typeof e.type=="function"&&e.type!=Y}function F(e){for(var t=[e],n=e;n.__o!=null;)t.push(n.__o),n=n.__o;return t.reduce(function(i,o){i+="  in "+se(o);var a=o.__source;return a?i+=" (at "+a.fileName+":"+a.lineNumber+")":Zn||(Zn=!0,console.warn("Add @babel/plugin-transform-react-jsx-source to get a more detailed component stack. Note that you should not add it to production builds of your App for bundle size reasons.")),i+`
`},"")}var cs=typeof WeakMap=="function",fs=H.prototype.setState;H.prototype.setState=function(e,t){return this.__v==null?this.state==null&&console.warn(`Calling "this.setState" inside the constructor of a component is a no-op and might be a bug in your application. Instead, set "this.state = {}" directly.

`+F($o())):this.__P==null&&console.warn(`Can't call "this.setState" on an unmounted component. This is a no-op, but it indicates a memory leak in your application. To fix, cancel all subscriptions and asynchronous tasks in the componentWillUnmount method.

`+F(this.__v)),fs.call(this,e,t)};var ms=H.prototype.forceUpdate;function te(e){var t=e.props,n=se(e),i="";for(var o in t)if(t.hasOwnProperty(o)&&o!=="children"){var a=t[o];typeof a=="function"&&(a="function "+(a.displayName||a.name)+"() {}"),a=Object(a)!==a||a.toString?a+"":Object.prototype.toString.call(a),i+=" "+o+"="+JSON.stringify(a)}var s=t.children;return"<"+n+i+(s&&s.length?">..</"+n+">":" />")}H.prototype.forceUpdate=function(e){return this.__v==null?console.warn(`Calling "this.forceUpdate" inside the constructor of a component is a no-op and might be a bug in your application.

`+F($o())):this.__P==null&&console.warn(`Can't call "this.forceUpdate" on an unmounted component. This is a no-op, but it indicates a memory leak in your application. To fix, cancel all subscriptions and asynchronous tasks in the componentWillUnmount method.

`+F(this.__v)),ms.call(this,e)},function(){(function(){var h=b.__b,c=b.diffed,m=b.__,p=b.vnode,g=b.__r;b.diffed=function(w){jt(w)&&be.pop(),Me.pop(),c&&c(w)},b.__b=function(w){jt(w)&&Me.push(w),h&&h(w)},b.__=function(w,v){be=[],m&&m(w,v)},b.vnode=function(w){w.__o=be.length>0?be[be.length-1]:null,p&&p(w)},b.__r=function(w){jt(w)&&be.push(w),g&&g(w)}})();var e=!1,t=b.__b,n=b.diffed,i=b.vnode,o=b.__e,a=b.__,s=b.__h,l=cs?{useEffect:new WeakMap,useLayoutEffect:new WeakMap,lazyPropTypes:new WeakMap}:null,d=[];b.__e=function(h,c,m){if(c&&c.__c&&typeof h.then=="function"){var p=h;h=new Error("Missing Suspense. The throwing component was: "+se(c));for(var g=c;g;g=g.__)if(g.__c&&g.__c.__c){h=p;break}if(h instanceof Error)throw h}try{o(h,c,m),typeof h.then!="function"&&setTimeout(function(){throw h})}catch(w){throw w}},b.__=function(h,c){if(!c)throw new Error(`Undefined parent passed to render(), this is the second argument.
Check if the element is available in the DOM/has the correct id.`);var m;switch(c.nodeType){case 1:case 11:case 9:m=!0;break;default:m=!1}if(!m){var p=se(h);throw new Error("Expected a valid HTML node as a second argument to render.	Received "+c+" instead: render(<"+p+" />, "+c+");")}a&&a(h,c)},b.__b=function(h){var c=h.type,m=function _(y){return y?typeof y.type=="function"?_(y.__):y:{}}(h.__);if(e=!0,c===void 0)throw new Error(`Undefined component passed to createElement()

You likely forgot to export your component or might have mixed up default and named imports`+te(h)+`

`+F(h));if(c!=null&&typeof c=="object")throw c.__k!==void 0&&c.__e!==void 0?new Error("Invalid type passed to createElement(): "+c+`
...
`+F(h)):new Error("Invalid type passed to createElement(): "+(Array.isArray(c)?"array":c));if(c!=="thead"&&c!=="tfoot"&&c!=="tbody"||m.type==="table"?c==="tr"&&m.type!=="thead"&&m.type!=="tfoot"&&m.type!=="tbody"&&m.type!=="table"?console.error("Improper nesting of table. Your <tr> should have a <thead/tbody/tfoot/table> parent."+te(h)+`

`+F(h)):c==="td"&&m.type!=="tr"?console.error("Improper nesting of table. Your <td> should have a <tr> parent."+te(h)+`

`+F(h)):c==="th"&&m.type!=="tr"&&console.error("Improper nesting of table. Your <th> should have a <tr>."+te(h)+`

`+F(h)):console.error("Improper nesting of table. Your <thead/tbody/tfoot> should have a <table> parent."+te(h)+`

`+F(h)),h.ref!==void 0&&typeof h.ref!="function"&&typeof h.ref!="object"&&!("$$typeof"in h))throw new Error(`Component's "ref" property should be a function, or an object created by createRef(), but got [`+typeof h.ref+`] instead
`+te(h)+`

`+F(h));if(typeof h.type=="string"){for(var p in h.props)if(p[0]==="o"&&p[1]==="n"&&typeof h.props[p]!="function"&&h.props[p]!=null)throw new Error(`Component's "`+p+'" property should be a function, but got ['+typeof h.props[p]+`] instead
`+te(h)+`

`+F(h))}if(typeof h.type=="function"&&h.type.propTypes){if(h.type.displayName==="Lazy"&&l&&!l.lazyPropTypes.has(h.type)){var g="PropTypes are not supported on lazy(). Use propTypes on the wrapped component itself. ";try{var w=h.type();l.lazyPropTypes.set(h.type,!0),console.warn(g+"Component wrapped in lazy() is "+se(w))}catch{console.warn(g+"We will log the wrapped component's name once it is loaded.")}}var v=h.props;h.type.__f&&delete(v=function(_,y){for(var x in y)_[x]=y[x];return _}({},v)).ref,function(_,y,x,C,O){Object.keys(_).forEach(function(M){var j;try{j=_[M](y,M,C,"prop",null,"SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED")}catch(U){j=U}!j||j.message in Qn||(Qn[j.message]=!0,console.error("Failed prop type: "+j.message+(O&&`
`+O()||"")))})}(h.type.propTypes,v,0,se(h),function(){return F(h)})}t&&t(h)},b.__h=function(h,c,m){if(!h||!e)throw new Error("Hook can only be invoked from render methods.");s&&s(h,c,m)};var u=function(h,c){return{get:function(){var m="get"+h+c;d&&d.indexOf(m)<0&&(d.push(m),console.warn("getting vnode."+h+" is deprecated, "+c))},set:function(){var m="set"+h+c;d&&d.indexOf(m)<0&&(d.push(m),console.warn("setting vnode."+h+" is not allowed, "+c))}}},r={nodeName:u("nodeName","use vnode.type"),attributes:u("attributes","use vnode.props"),children:u("children","use vnode.props.children")},f=Object.create({},r);b.vnode=function(h){var c=h.props;if(h.type!==null&&c!=null&&("__source"in c||"__self"in c)){var m=h.props={};for(var p in c){var g=c[p];p==="__source"?h.__source=g:p==="__self"?h.__self=g:m[p]=g}}h.__proto__=f,i&&i(h)},b.diffed=function(h){if(h.__k&&h.__k.forEach(function(w){if(w&&w.type===void 0){delete w.__,delete w.__b;var v=Object.keys(w).join(",");throw new Error("Objects are not valid as a child. Encountered an object with the keys {"+v+`}.

`+F(h))}}),e=!1,n&&n(h),h.__k!=null)for(var c=[],m=0;m<h.__k.length;m++){var p=h.__k[m];if(p&&p.key!=null){var g=p.key;if(c.indexOf(g)!==-1){console.error('Following component has two or more children with the same key attribute: "'+g+`". This may cause glitches and misbehavior in rendering process. Component: 

`+te(h)+`

`+F(h));break}c.push(g)}}}}();var Ie,L,ei,Te=0,Jt=[],ti=b.__b,ni=b.__r,ii=b.diffed,oi=b.__c,ai=b.unmount;function qe(e,t){b.__h&&b.__h(L,e,Te||t),Te=0;var n=L.__H||(L.__H={__:[],__h:[]});return e>=n.__.length&&n.__.push({}),n.__[e]}function ps(e){return Te=1,wn(jo,e)}function wn(e,t,n){var i=qe(Ie++,2);return i.t=e,i.__c||(i.__=[n?n(t):jo(void 0,t),function(o){var a=i.t(i.__[0],o);i.__[0]!==a&&(i.__=[a,i.__[1]],i.__c.setState({}))}],i.__c=L),i.__}function bn(e,t){var n=qe(Ie++,3);!b.__s&&vn(n.__H,t)&&(n.__=e,n.__H=t,L.__H.__h.push(n))}function yn(e,t){var n=qe(Ie++,4);!b.__s&&vn(n.__H,t)&&(n.__=e,n.__H=t,L.__h.push(n))}function Be(e){return Te=5,G(function(){return{current:e}},[])}function gs(e,t,n){Te=6,yn(function(){typeof e=="function"?e(t()):e&&(e.current=t())},n==null?n:n.concat(e))}function G(e,t){var n=qe(Ie++,7);return vn(n.__H,t)&&(n.__=e(),n.__H=t,n.__h=e),n.__}function ws(e,t){return Te=8,G(function(){return e},t)}function Ro(e){var t=L.context[e.__c],n=qe(Ie++,9);return n.c=e,t?(n.__==null&&(n.__=!0,t.sub(L)),t.props.value):e.__}function bs(e,t){b.useDebugValue&&b.useDebugValue(t?t(e):e)}function ys(){Jt.forEach(function(e){if(e.__P)try{e.__H.__h.forEach(Ze),e.__H.__h.forEach(Xt),e.__H.__h=[]}catch(t){e.__H.__h=[],b.__e(t,e.__v)}}),Jt=[]}b.__b=function(e){L=null,ti&&ti(e)},b.__r=function(e){ni&&ni(e),Ie=0;var t=(L=e.__c).__H;t&&(t.__h.forEach(Ze),t.__h.forEach(Xt),t.__h=[])},b.diffed=function(e){ii&&ii(e);var t=e.__c;t&&t.__H&&t.__H.__h.length&&(Jt.push(t)!==1&&ei===b.requestAnimationFrame||((ei=b.requestAnimationFrame)||function(n){var i,o=function(){clearTimeout(a),si&&cancelAnimationFrame(i),setTimeout(n)},a=setTimeout(o,100);si&&(i=requestAnimationFrame(o))})(ys)),L=null},b.__c=function(e,t){t.some(function(n){try{n.__h.forEach(Ze),n.__h=n.__h.filter(function(i){return!i.__||Xt(i)})}catch(i){t.some(function(o){o.__h&&(o.__h=[])}),t=[],b.__e(i,n.__v)}}),oi&&oi(e,t)},b.unmount=function(e){ai&&ai(e);var t=e.__c;if(t&&t.__H)try{t.__H.__.forEach(Ze)}catch(n){b.__e(n,t.__v)}};var si=typeof requestAnimationFrame=="function";function Ze(e){var t=L;typeof e.__c=="function"&&e.__c(),L=t}function Xt(e){var t=L;e.__c=e.__(),L=t}function vn(e,t){return!e||e.length!==t.length||t.some(function(n,i){return n!==e[i]})}function jo(e,t){return typeof t=="function"?t(e):t}function Bo(e,t){for(var n in t)e[n]=t[n];return e}function Qt(e,t){for(var n in e)if(n!=="__source"&&!(n in t))return!0;for(var i in t)if(i!=="__source"&&e[i]!==t[i])return!0;return!1}function Zt(e){this.props=e}function vs(e,t){function n(o){var a=this.props.ref,s=a==o.ref;return!s&&a&&(a.call?a(null):a.current=null),t?!t(this.props,o)||!s:Qt(this.props,o)}function i(o){return this.shouldComponentUpdate=n,J(e,o)}return i.displayName="Memo("+(e.displayName||e.name)+")",i.prototype.isReactComponent=!0,i.__f=!0,i}(Zt.prototype=new H).isPureReactComponent=!0,Zt.prototype.shouldComponentUpdate=function(e,t){return Qt(this.props,e)||Qt(this.state,t)};var ri=b.__b;b.__b=function(e){e.type&&e.type.__f&&e.ref&&(e.props.ref=e.ref,e.ref=null),ri&&ri(e)};var Ts=typeof Symbol!="undefined"&&Symbol.for&&Symbol.for("react.forward_ref")||3911;function ks(e){function t(n,i){var o=Bo({},n);return delete o.ref,e(o,(i=n.ref||i)&&(typeof i!="object"||"current"in i)?i:null)}return t.$$typeof=Ts,t.render=t,t.prototype.isReactComponent=t.__f=!0,t.displayName="ForwardRef("+(e.displayName||e.name)+")",t}var hi=function(e,t){return e==null?null:Q(Q(e).map(t))},_s={map:hi,forEach:hi,count:function(e){return e?Q(e).length:0},only:function(e){var t=Q(e);if(t.length!==1)throw"Children.only";return t[0]},toArray:Q},xs=b.__e;b.__e=function(e,t,n){if(e.then){for(var i,o=t;o=o.__;)if((i=o.__c)&&i.__c)return t.__e==null&&(t.__e=n.__e,t.__k=n.__k),i.__c(e,t)}xs(e,t,n)};var li=b.unmount;function et(){this.__u=0,this.t=null,this.__b=null}function Wo(e){var t=e.__.__c;return t&&t.__e&&t.__e(e)}function Is(e){var t,n,i;function o(a){if(t||(t=e()).then(function(s){n=s.default||s},function(s){i=s}),i)throw i;if(!n)throw t;return J(n,a)}return o.displayName="Lazy",o.__f=!0,o}function We(){this.u=null,this.o=null}b.unmount=function(e){var t=e.__c;t&&t.__R&&t.__R(),t&&e.__h===!0&&(e.type=null),li&&li(e)},(et.prototype=new H).__c=function(e,t){var n=t.__c,i=this;i.t==null&&(i.t=[]),i.t.push(n);var o=Wo(i.__v),a=!1,s=function(){a||(a=!0,n.__R=null,o?o(l):l())};n.__R=s;var l=function(){if(!--i.__u){if(i.state.__e){var u=i.state.__e;i.__v.__k[0]=function f(h,c,m){return h&&(h.__v=null,h.__k=h.__k&&h.__k.map(function(p){return f(p,c,m)}),h.__c&&h.__c.__P===c&&(h.__e&&m.insertBefore(h.__e,h.__d),h.__c.__e=!0,h.__c.__P=m)),h}(u,u.__c.__P,u.__c.__O)}var r;for(i.setState({__e:i.__b=null});r=i.t.pop();)r.forceUpdate()}},d=t.__h===!0;i.__u++||d||i.setState({__e:i.__b=i.__v.__k[0]}),e.then(s,s)},et.prototype.componentWillUnmount=function(){this.t=[]},et.prototype.render=function(e,t){if(this.__b){if(this.__v.__k){var n=document.createElement("div"),i=this.__v.__k[0].__c;this.__v.__k[0]=function a(s,l,d){return s&&(s.__c&&s.__c.__H&&(s.__c.__H.__.forEach(function(u){typeof u.__c=="function"&&u.__c()}),s.__c.__H=null),(s=Bo({},s)).__c!=null&&(s.__c.__P===d&&(s.__c.__P=l),s.__c=null),s.__k=s.__k&&s.__k.map(function(u){return a(u,l,d)})),s}(this.__b,n,i.__O=i.__P)}this.__b=null}var o=t.__e&&J(Y,null,e.fallback);return o&&(o.__h=null),[J(Y,null,t.__e?null:e.children),o]};var ui=function(e,t,n){if(++n[1]===n[0]&&e.o.delete(t),e.props.revealOrder&&(e.props.revealOrder[0]!=="t"||!e.o.size))for(n=e.u;n;){for(;n.length>3;)n.pop()();if(n[1]<n[0])break;e.u=n=n[2]}};function As(e){return this.getChildContext=function(){return e.context},e.children}function Es(e){var t=this,n=e.i;t.componentWillUnmount=function(){de(null,t.l),t.l=null,t.i=null},t.i&&t.i!==n&&t.componentWillUnmount(),e.__v?(t.l||(t.i=n,t.l={nodeType:1,parentNode:n,childNodes:[],appendChild:function(i){this.childNodes.push(i),t.i.appendChild(i)},insertBefore:function(i,o){this.childNodes.push(i),t.i.appendChild(i)},removeChild:function(i){this.childNodes.splice(this.childNodes.indexOf(i)>>>1,1),t.i.removeChild(i)}}),de(J(As,{context:t.context},e.__v),t.l)):t.l&&t.componentWillUnmount()}function Ss(e,t){return J(Es,{__v:e,i:t})}(We.prototype=new H).__e=function(e){var t=this,n=Wo(t.__v),i=t.o.get(e);return i[0]++,function(o){var a=function(){t.props.revealOrder?(i.push(o),ui(t,e,i)):o()};n?n(a):a()}},We.prototype.render=function(e){this.u=null,this.o=new Map;var t=Q(e.children);e.revealOrder&&e.revealOrder[0]==="b"&&t.reverse();for(var n=t.length;n--;)this.o.set(t[n],this.u=[1,0,this.u]);return e.children},We.prototype.componentDidUpdate=We.prototype.componentDidMount=function(){var e=this;this.o.forEach(function(t,n){ui(e,n,t)})};var Fo=typeof Symbol!="undefined"&&Symbol.for&&Symbol.for("react.element")||60103,Ns=/^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|marker(?!H|W|U)|overline|paint|stop|strikethrough|stroke|text(?!L)|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/,Hs=typeof document!="undefined",Cs=function(e){return(typeof Symbol!="undefined"&&typeof Symbol()=="symbol"?/fil|che|rad/i:/fil|che|ra/i).test(e)};function Os(e,t,n){return t.__k==null&&(t.textContent=""),de(e,t),typeof n=="function"&&n(),e?e.__c:null}function Ps(e,t,n){return gn(e,t),typeof n=="function"&&n(),e?e.__c:null}H.prototype.isReactComponent={},["componentWillMount","componentWillReceiveProps","componentWillUpdate"].forEach(function(e){Object.defineProperty(H.prototype,e,{configurable:!0,get:function(){return this["UNSAFE_"+e]},set:function(t){Object.defineProperty(this,e,{configurable:!0,writable:!0,value:t})}})});var di=b.event;function $s(){}function Rs(){return this.cancelBubble}function js(){return this.defaultPrevented}b.event=function(e){return di&&(e=di(e)),e.persist=$s,e.isPropagationStopped=Rs,e.isDefaultPrevented=js,e.nativeEvent=e};var Lo,ci={configurable:!0,get:function(){return this.class}},fi=b.vnode;b.vnode=function(e){var t=e.type,n=e.props,i=n;if(typeof t=="string"){var o=t.indexOf("-")===-1;for(var a in i={},n){var s=n[a];Hs&&a==="children"&&t==="noscript"||a==="value"&&"defaultValue"in n&&s==null||(a==="defaultValue"&&"value"in n&&n.value==null?a="value":a==="download"&&s===!0?s="":/ondoubleclick/i.test(a)?a="ondblclick":/^onchange(textarea|input)/i.test(a+t)&&!Cs(n.type)?a="oninput":/^on(Ani|Tra|Tou|BeforeInp)/.test(a)?a=a.toLowerCase():o&&Ns.test(a)?a=a.replace(/[A-Z0-9]/,"-$&").toLowerCase():s===null&&(s=void 0),i[a]=s)}t=="select"&&i.multiple&&Array.isArray(i.value)&&(i.value=Q(n.children).forEach(function(l){l.props.selected=i.value.indexOf(l.props.value)!=-1})),t=="select"&&i.defaultValue!=null&&(i.value=Q(n.children).forEach(function(l){l.props.selected=i.multiple?i.defaultValue.indexOf(l.props.value)!=-1:i.defaultValue==l.props.value})),e.props=i}t&&n.class!=n.className&&(ci.enumerable="className"in n,n.className!=null&&(i.class=n.className),Object.defineProperty(i,"className",ci)),e.$$typeof=Fo,fi&&fi(e)};var mi=b.__r;b.__r=function(e){mi&&mi(e),Lo=e.__c};var Bs={ReactCurrentDispatcher:{current:{readContext:function(e){return Lo.__n[e.__c].props.value}}}};function Ws(e){return J.bind(null,e)}function Mo(e){return!!e&&e.$$typeof===Fo}function Fs(e){return Mo(e)?Oo.apply(null,arguments):e}function Ls(e){return!!e.__k&&(de(null,e),!0)}function Ms(e){return e&&(e.base||e.nodeType===1&&e)||null}var Do=function(e,t){return e(t)},Ds=function(e,t){return e(t)},I={useState:ps,useReducer:wn,useEffect:bn,useLayoutEffect:yn,useRef:Be,useImperativeHandle:gs,useMemo:G,useCallback:ws,useContext:Ro,useDebugValue:bs,version:"17.0.2",Children:_s,render:Os,hydrate:Ps,unmountComponentAtNode:Ls,createPortal:Ss,createElement:J,createContext:Po,createFactory:Ws,cloneElement:Fs,createRef:xo,Fragment:Y,isValidElement:Mo,findDOMNode:Ms,Component:H,PureComponent:Zt,memo:vs,forwardRef:ks,flushSync:Ds,unstable_batchedUpdates:Do,StrictMode:Y,Suspense:et,SuspenseList:We,lazy:Is,__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:Bs},Je=typeof globalThis!="undefined"?globalThis:typeof window!="undefined"?window:typeof global!="undefined"?global:typeof self!="undefined"?self:{},Go={exports:{}},Gs="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED",qs=Gs,Us=qs;function qo(){}function Uo(){}Uo.resetWarningCache=qo;var Ks=function(){function e(i,o,a,s,l,d){if(d!==Us){var u=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");throw u.name="Invariant Violation",u}}e.isRequired=e;function t(){return e}var n={array:e,bool:e,func:e,number:e,object:e,string:e,symbol:e,any:e,arrayOf:t,element:e,elementType:e,instanceOf:t,node:e,objectOf:t,oneOf:t,oneOfType:t,shape:t,exact:t,checkPropTypes:Uo,resetWarningCache:qo};return n.PropTypes=n,n};Go.exports=Ks();var pi=Go.exports,Ko=I.createContext(null);function zs(e){e()}var zo=zs,Ys=function(t){return zo=t},Vs=function(){return zo},gi={notify:function(){}};function Js(){var e=Vs(),t=null,n=null;return{clear:function(){t=null,n=null},notify:function(){e(function(){for(var o=t;o;)o.callback(),o=o.next})},get:function(){for(var o=[],a=t;a;)o.push(a),a=a.next;return o},subscribe:function(o){var a=!0,s=n={callback:o,next:null,prev:n};return s.prev?s.prev.next=s:t=s,function(){!a||t===null||(a=!1,s.next?s.next.prev=s.prev:n=s.prev,s.prev?s.prev.next=s.next:t=s.next)}}}}var Yo=function(){function e(n,i){this.store=n,this.parentSub=i,this.unsubscribe=null,this.listeners=gi,this.handleChangeWrapper=this.handleChangeWrapper.bind(this)}var t=e.prototype;return t.addNestedSub=function(i){return this.trySubscribe(),this.listeners.subscribe(i)},t.notifyNestedSubs=function(){this.listeners.notify()},t.handleChangeWrapper=function(){this.onStateChange&&this.onStateChange()},t.isSubscribed=function(){return Boolean(this.unsubscribe)},t.trySubscribe=function(){this.unsubscribe||(this.unsubscribe=this.parentSub?this.parentSub.addNestedSub(this.handleChangeWrapper):this.store.subscribe(this.handleChangeWrapper),this.listeners=Js())},t.tryUnsubscribe=function(){this.unsubscribe&&(this.unsubscribe(),this.unsubscribe=null,this.listeners.clear(),this.listeners=gi)},e}();function Xs(e){var t=e.store,n=e.context,i=e.children,o=G(function(){var l=new Yo(t);return l.onStateChange=l.notifyNestedSubs,{store:t,subscription:l}},[t]),a=G(function(){return t.getState()},[t]);bn(function(){var l=o.subscription;return l.trySubscribe(),a!==t.getState()&&l.notifyNestedSubs(),function(){l.tryUnsubscribe(),l.onStateChange=null}},[o,a]);var s=n||Ko;return I.createElement(s.Provider,{value:o},i)}function B(){return B=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&(e[i]=n[i])}return e},B.apply(this,arguments)}function ce(e,t){if(e==null)return{};var n={},i=Object.keys(e),o,a;for(a=0;a<i.length;a++)o=i[a],!(t.indexOf(o)>=0)&&(n[o]=e[o]);return n}var Tn={exports:{}},A={};/** @license React v16.13.1
 ...
 */var $=typeof Symbol=="function"&&Symbol.for,kn=$?Symbol.for("react.element"):60103,_n=$?Symbol.for("react.portal"):60106,ft=$?Symbol.for("react.fragment"):60107,mt=$?Symbol.for("react.strict_mode"):60108,pt=$?Symbol.for("react.profiler"):60114,gt=$?Symbol.for("react.provider"):60109,wt=$?Symbol.for("react.context"):60110,xn=$?Symbol.for("react.async_mode"):60111,bt=$?Symbol.for("react.concurrent_mode"):60111,yt=$?Symbol.for("react.forward_ref"):60112,vt=$?Symbol.for("react.suspense"):60113,Qs=$?Symbol.for("react.suspense_list"):60120,Tt=$?Symbol.for("react.memo"):60115,kt=$?Symbol.for("react.lazy"):60116,Zs=$?Symbol.for("react.block"):60121,er=$?Symbol.for("react.fundamental"):60117,tr=$?Symbol.for("react.responder"):60118,nr=$?Symbol.for("react.scope"):60119;function q(e){if(typeof e=="object"&&e!==null){var t=e.$$typeof;switch(t){case kn:switch(e=e.type,e){case xn:case bt:case ft:case pt:case mt:case vt:return e;default:switch(e=e&&e.$$typeof,e){case wt:case yt:case kt:case Tt:case gt:return e;default:return t}}case _n:return t}}}function Vo(e){return q(e)===bt}A.AsyncMode=xn;A.ConcurrentMode=bt;A.ContextConsumer=wt;A.ContextProvider=gt;A.Element=kn;A.ForwardRef=yt;A.Fragment=ft;A.Lazy=kt;A.Memo=Tt;A.Portal=_n;A.Profiler=pt;A.StrictMode=mt;A.Suspense=vt;A.isAsyncMode=function(e){return Vo(e)||q(e)===xn};A.isConcurrentMode=Vo;A.isContextConsumer=function(e){return q(e)===wt};A.isContextProvider=function(e){return q(e)===gt};A.isElement=function(e){return typeof e=="object"&&e!==null&&e.$$typeof===kn};A.isForwardRef=function(e){return q(e)===yt};A.isFragment=function(e){return q(e)===ft};A.isLazy=function(e){return q(e)===kt};A.isMemo=function(e){return q(e)===Tt};A.isPortal=function(e){return q(e)===_n};A.isProfiler=function(e){return q(e)===pt};A.isStrictMode=function(e){return q(e)===mt};A.isSuspense=function(e){return q(e)===vt};A.isValidElementType=function(e){return typeof e=="string"||typeof e=="function"||e===ft||e===bt||e===pt||e===mt||e===vt||e===Qs||typeof e=="object"&&e!==null&&(e.$$typeof===kt||e.$$typeof===Tt||e.$$typeof===gt||e.$$typeof===wt||e.$$typeof===yt||e.$$typeof===er||e.$$typeof===tr||e.$$typeof===nr||e.$$typeof===Zs)};A.typeOf=q;Tn.exports=A;var In=Tn.exports,ir={childContextTypes:!0,contextType:!0,contextTypes:!0,defaultProps:!0,displayName:!0,getDefaultProps:!0,getDerivedStateFromError:!0,getDerivedStateFromProps:!0,mixins:!0,propTypes:!0,type:!0},or={name:!0,length:!0,prototype:!0,caller:!0,callee:!0,arguments:!0,arity:!0},ar={$$typeof:!0,render:!0,defaultProps:!0,displayName:!0,propTypes:!0},Jo={$$typeof:!0,compare:!0,defaultProps:!0,displayName:!0,propTypes:!0,type:!0},An={};An[In.ForwardRef]=ar;An[In.Memo]=Jo;function wi(e){return In.isMemo(e)?Jo:An[e.$$typeof]||ir}var sr=Object.defineProperty,rr=Object.getOwnPropertyNames,bi=Object.getOwnPropertySymbols,hr=Object.getOwnPropertyDescriptor,lr=Object.getPrototypeOf,yi=Object.prototype;function Xo(e,t,n){if(typeof t!="string"){if(yi){var i=lr(t);i&&i!==yi&&Xo(e,i,n)}var o=rr(t);bi&&(o=o.concat(bi(t)));for(var a=wi(e),s=wi(t),l=0;l<o.length;++l){var d=o[l];if(!or[d]&&!(n&&n[d])&&!(s&&s[d])&&!(a&&a[d])){var u=hr(t,d);try{sr(e,d,u)}catch{}}}}return e}var vi=Xo,ur=typeof window!="undefined"&&typeof window.document!="undefined"&&typeof window.document.createElement!="undefined"?yn:bn,dr=[],cr=[null,null];function fr(e,t){var n=e[1];return[t.payload,n+1]}function Ti(e,t,n){ur(function(){return e.apply(void 0,t)},n)}function mr(e,t,n,i,o,a,s){e.current=i,t.current=o,n.current=!1,a.current&&(a.current=null,s())}function pr(e,t,n,i,o,a,s,l,d,u){if(!!e){var r=!1,f=null,h=function(){if(!r){var p=t.getState(),g,w;try{g=i(p,o.current)}catch(v){w=v,f=v}w||(f=null),g===a.current?s.current||d():(a.current=g,l.current=g,s.current=!0,u({type:"STORE_UPDATED",payload:{error:w}}))}};n.onStateChange=h,n.trySubscribe(),h();var c=function(){if(r=!0,n.tryUnsubscribe(),n.onStateChange=null,f)throw f};return c}}var gr=function(){return[null,0]};function wr(e,t){t===void 0&&(t={});var n=t,i=n.getDisplayName,o=i===void 0?function(_){return"ConnectAdvanced("+_+")"}:i,a=n.methodName,s=a===void 0?"connectAdvanced":a,l=n.renderCountProp,d=l===void 0?void 0:l,u=n.shouldHandleStateChanges,r=u===void 0?!0:u,f=n.storeKey,h=f===void 0?"store":f;n.withRef;var c=n.forwardRef,m=c===void 0?!1:c,p=n.context,g=p===void 0?Ko:p,w=ce(n,["getDisplayName","methodName","renderCountProp","shouldHandleStateChanges","storeKey","withRef","forwardRef","context"]),v=g;return function(y){var x=y.displayName||y.name||"Component",C=o(x),O=B({},w,{getDisplayName:o,methodName:s,renderCountProp:d,shouldHandleStateChanges:r,storeKey:h,displayName:C,wrappedComponentName:x,WrappedComponent:y}),M=w.pure;function j(P){return e(P.dispatch,O)}var U=M?G:function(P){return P()};function Z(P){var K=G(function(){var Pe=P.forwardedRef,Rt=ce(P,["forwardedRef"]);return[P.context,Pe,Rt]},[P]),D=K[0],pe=K[1],he=K[2],W=G(function(){return D&&D.Consumer&&Tn.exports.isContextConsumer(I.createElement(D.Consumer,null))?D:v},[D,v]),k=Ro(W),S=Boolean(P.store)&&Boolean(P.store.getState)&&Boolean(P.store.dispatch);Boolean(k)&&Boolean(k.store);var E=S?P.store:k.store,R=G(function(){return j(E)},[E]),ee=G(function(){if(!r)return cr;var Pe=new Yo(E,S?null:k.subscription),Rt=Pe.notifyNestedSubs.bind(Pe);return[Pe,Rt]},[E,S,k]),z=ee[0],ae=ee[1],ge=G(function(){return S?k:B({},k,{subscription:z})},[S,k,z]),le=wn(fr,dr,gr),ze=le[0],Ye=ze[0],Xa=le[1];if(Ye&&Ye.error)throw Ye.error;var Un=Be(),Ot=Be(he),Ve=Be(),Kn=Be(!1),Pt=U(function(){return Ve.current&&he===Ot.current?Ve.current:R(E.getState(),he)},[E,Ye,he]);Ti(mr,[Ot,Un,Kn,he,Pt,Ve,ae]),Ti(pr,[r,E,z,R,Ot,Un,Kn,Ve,ae,Xa],[E,z,R]);var $t=G(function(){return I.createElement(y,B({},Pt,{ref:pe}))},[pe,y,Pt]),Qa=G(function(){return r?I.createElement(W.Provider,{value:ge},$t):$t},[W,$t,ge]);return Qa}var oe=M?I.memo(Z):Z;if(oe.WrappedComponent=y,oe.displayName=C,m){var re=I.forwardRef(function(K,D){return I.createElement(oe,B({},K,{forwardedRef:D}))});return re.displayName=C,re.WrappedComponent=y,vi(re,y)}return vi(oe,y)}}function ki(e,t){return e===t?e!==0||t!==0||1/e===1/t:e!==e&&t!==t}function Bt(e,t){if(ki(e,t))return!0;if(typeof e!="object"||e===null||typeof t!="object"||t===null)return!1;var n=Object.keys(e),i=Object.keys(t);if(n.length!==i.length)return!1;for(var o=0;o<n.length;o++)if(!Object.prototype.hasOwnProperty.call(t,n[o])||!ki(e[n[o]],t[n[o]]))return!1;return!0}var br=typeof global=="object"&&global&&global.Object===Object&&global,yr=br,vr=typeof self=="object"&&self&&self.Object===Object&&self,Tr=yr||vr||Function("return this")(),kr=Tr,_r=kr.Symbol,rt=_r,Qo=Object.prototype,xr=Qo.hasOwnProperty,Ir=Qo.toString,$e=rt?rt.toStringTag:void 0;function Ar(e){var t=xr.call(e,$e),n=e[$e];try{e[$e]=void 0;var i=!0}catch{}var o=Ir.call(e);return i&&(t?e[$e]=n:delete e[$e]),o}var Er=Object.prototype,Sr=Er.toString;function Nr(e){return Sr.call(e)}var Hr="[object Null]",Cr="[object Undefined]",_i=rt?rt.toStringTag:void 0;function Or(e){return e==null?e===void 0?Cr:Hr:_i&&_i in Object(e)?Ar(e):Nr(e)}function Pr(e,t){return function(n){return e(t(n))}}var $r=Pr(Object.getPrototypeOf,Object),Rr=$r;function jr(e){return e!=null&&typeof e=="object"}var Br="[object Object]",Wr=Function.prototype,Fr=Object.prototype,Zo=Wr.toString,Lr=Fr.hasOwnProperty,Mr=Zo.call(Object);function Dr(e){if(!jr(e)||Or(e)!=Br)return!1;var t=Rr(e);if(t===null)return!0;var n=Lr.call(t,"constructor")&&t.constructor;return typeof n=="function"&&n instanceof n&&Zo.call(n)==Mr}function Gr(e){var t,n=e.Symbol;return typeof n=="function"?n.observable?t=n.observable:(t=n("observable"),n.observable=t):t="@@observable",t}var ye;typeof self!="undefined"?ye=self:typeof window!="undefined"?ye=window:typeof global!="undefined"?ye=global:typeof mn!="undefined"?ye=mn:ye=Function("return this")();var xi=Gr(ye),ht={INIT:"@@redux/INIT"};function ea(e,t,n){var i;if(typeof t=="function"&&typeof n=="undefined"&&(n=t,t=void 0),typeof n!="undefined"){if(typeof n!="function")throw new Error("Expected the enhancer to be a function.");return n(ea)(e,t)}if(typeof e!="function")throw new Error("Expected the reducer to be a function.");var o=e,a=t,s=[],l=s,d=!1;function u(){l===s&&(l=s.slice())}function r(){return a}function f(p){if(typeof p!="function")throw new Error("Expected listener to be a function.");var g=!0;return u(),l.push(p),function(){if(!!g){g=!1,u();var v=l.indexOf(p);l.splice(v,1)}}}function h(p){if(!Dr(p))throw new Error("Actions must be plain objects. Use custom middleware for async actions.");if(typeof p.type=="undefined")throw new Error('Actions may not have an undefined "type" property. Have you misspelled a constant?');if(d)throw new Error("Reducers may not dispatch actions.");try{d=!0,a=o(a,p)}finally{d=!1}for(var g=s=l,w=0;w<g.length;w++){var v=g[w];v()}return p}function c(p){if(typeof p!="function")throw new Error("Expected the nextReducer to be a function.");o=p,h({type:ht.INIT})}function m(){var p,g=f;return p={subscribe:function(v){if(typeof v!="object")throw new TypeError("Expected the observer to be an object.");function _(){v.next&&v.next(r())}_();var y=g(_);return{unsubscribe:y}}},p[xi]=function(){return this},p}return h({type:ht.INIT}),i={dispatch:h,subscribe:f,getState:r,replaceReducer:c},i[xi]=m,i}function qr(e,t){var n=t&&t.type,i=n&&'"'+n.toString()+'"'||"an action";return"Given action "+i+', reducer "'+e+'" returned undefined. To ignore an action, you must explicitly return the previous state. If you want this reducer to hold no value, you can return null instead of undefined.'}function Ur(e){Object.keys(e).forEach(function(t){var n=e[t],i=n(void 0,{type:ht.INIT});if(typeof i=="undefined")throw new Error('Reducer "'+t+`" returned undefined during initialization. If the state passed to the reducer is undefined, you must explicitly return the initial state. The initial state may not be undefined. If you don't want to set a value for this reducer, you can use null instead of undefined.`);var o="@@redux/PROBE_UNKNOWN_ACTION_"+Math.random().toString(36).substring(7).split("").join(".");if(typeof n(void 0,{type:o})=="undefined")throw new Error('Reducer "'+t+'" returned undefined when probed with a random type. '+("Don't try to handle "+ht.INIT+' or other actions in "redux/*" ')+"namespace. They are considered private. Instead, you must return the current state for any unknown actions, unless it is undefined, in which case you must return the initial state, regardless of the action type. The initial state may not be undefined, but can be null.")})}function Kr(e){for(var t=Object.keys(e),n={},i=0;i<t.length;i++){var o=t[i];typeof e[o]=="function"&&(n[o]=e[o])}var a=Object.keys(n),s=void 0;try{Ur(n)}catch(l){s=l}return function(){var d=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},u=arguments[1];if(s)throw s;for(var r=!1,f={},h=0;h<a.length;h++){var c=a[h],m=n[c],p=d[c],g=m(p,u);if(typeof g=="undefined"){var w=qr(c,u);throw new Error(w)}f[c]=g,r=r||g!==p}return r?f:d}}function Ii(e,t){return function(){return t(e.apply(void 0,arguments))}}function zr(e,t){if(typeof e=="function")return Ii(e,t);if(typeof e!="object"||e===null)throw new Error("bindActionCreators expected an object or a function, instead received "+(e===null?"null":typeof e)+'. Did you write "import ActionCreators from" instead of "import * as ActionCreators from"?');for(var n=Object.keys(e),i={},o=0;o<n.length;o++){var a=n[o],s=e[a];typeof s=="function"&&(i[a]=Ii(s,t))}return i}function ta(){for(var e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n];return t.length===0?function(i){return i}:t.length===1?t[0]:t.reduce(function(i,o){return function(){return i(o.apply(void 0,arguments))}})}var Yr=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&(e[i]=n[i])}return e};function Vr(){for(var e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n];return function(i){return function(o,a,s){var l=i(o,a,s),d=l.dispatch,u=[],r={getState:l.getState,dispatch:function(h){return d(h)}};return u=t.map(function(f){return f(r)}),d=ta.apply(void 0,u)(l.dispatch),Yr({},l,{dispatch:d})}}}function En(e){return function(n,i){var o=e(n,i);function a(){return o}return a.dependsOnOwnProps=!1,a}}function Ai(e){return e.dependsOnOwnProps!==null&&e.dependsOnOwnProps!==void 0?Boolean(e.dependsOnOwnProps):e.length!==1}function na(e,t){return function(i,o){o.displayName;var a=function(l,d){return a.dependsOnOwnProps?a.mapToProps(l,d):a.mapToProps(l)};return a.dependsOnOwnProps=!0,a.mapToProps=function(l,d){a.mapToProps=e,a.dependsOnOwnProps=Ai(e);var u=a(l,d);return typeof u=="function"&&(a.mapToProps=u,a.dependsOnOwnProps=Ai(u),u=a(l,d)),u},a}}function Jr(e){return typeof e=="function"?na(e):void 0}function Xr(e){return e?void 0:En(function(t){return{dispatch:t}})}function Qr(e){return e&&typeof e=="object"?En(function(t){return zr(e,t)}):void 0}var Zr=[Jr,Xr,Qr];function eh(e){return typeof e=="function"?na(e):void 0}function th(e){return e?void 0:En(function(){return{}})}var nh=[eh,th];function ih(e,t,n){return B({},n,{},e,{},t)}function oh(e){return function(n,i){i.displayName;var o=i.pure,a=i.areMergedPropsEqual,s=!1,l;return function(u,r,f){var h=e(u,r,f);return s?(!o||!a(h,l))&&(l=h):(s=!0,l=h),l}}}function ah(e){return typeof e=="function"?oh(e):void 0}function sh(e){return e?void 0:function(){return ih}}var rh=[ah,sh];function hh(e,t,n,i){return function(a,s){return n(e(a,s),t(i,s),s)}}function lh(e,t,n,i,o){var a=o.areStatesEqual,s=o.areOwnPropsEqual,l=o.areStatePropsEqual,d=!1,u,r,f,h,c;function m(_,y){return u=_,r=y,f=e(u,r),h=t(i,r),c=n(f,h,r),d=!0,c}function p(){return f=e(u,r),t.dependsOnOwnProps&&(h=t(i,r)),c=n(f,h,r),c}function g(){return e.dependsOnOwnProps&&(f=e(u,r)),t.dependsOnOwnProps&&(h=t(i,r)),c=n(f,h,r),c}function w(){var _=e(u,r),y=!l(_,f);return f=_,y&&(c=n(f,h,r)),c}function v(_,y){var x=!s(y,r),C=!a(_,u);return u=_,r=y,x&&C?p():x?g():C?w():c}return function(y,x){return d?v(y,x):m(y,x)}}function uh(e,t){var n=t.initMapStateToProps,i=t.initMapDispatchToProps,o=t.initMergeProps,a=ce(t,["initMapStateToProps","initMapDispatchToProps","initMergeProps"]),s=n(e,a),l=i(e,a),d=o(e,a),u=a.pure?lh:hh;return u(s,l,d,e,a)}function Wt(e,t,n){for(var i=t.length-1;i>=0;i--){var o=t[i](e);if(o)return o}return function(a,s){throw new Error("Invalid value of type "+typeof e+" for "+n+" argument when connecting component "+s.wrappedComponentName+".")}}function dh(e,t){return e===t}function ch(e){var t=e===void 0?{}:e,n=t.connectHOC,i=n===void 0?wr:n,o=t.mapStateToPropsFactories,a=o===void 0?nh:o,s=t.mapDispatchToPropsFactories,l=s===void 0?Zr:s,d=t.mergePropsFactories,u=d===void 0?rh:d,r=t.selectorFactory,f=r===void 0?uh:r;return function(c,m,p,g){g===void 0&&(g={});var w=g,v=w.pure,_=v===void 0?!0:v,y=w.areStatesEqual,x=y===void 0?dh:y,C=w.areOwnPropsEqual,O=C===void 0?Bt:C,M=w.areStatePropsEqual,j=M===void 0?Bt:M,U=w.areMergedPropsEqual,Z=U===void 0?Bt:U,oe=ce(w,["pure","areStatesEqual","areOwnPropsEqual","areStatePropsEqual","areMergedPropsEqual"]),re=Wt(c,a,"mapStateToProps"),P=Wt(m,l,"mapDispatchToProps"),K=Wt(p,u,"mergeProps");return i(f,B({methodName:"connect",getDisplayName:function(pe){return"Connect("+pe+")"},shouldHandleStateChanges:Boolean(c),initMapStateToProps:re,initMapDispatchToProps:P,initMergeProps:K,pure:_,areStatesEqual:x,areOwnPropsEqual:O,areStatePropsEqual:j,areMergedPropsEqual:Z},oe))}}var ia=ch();Ys(Do);function oa(e){return function(t){var n=t.dispatch,i=t.getState;return function(o){return function(a){return typeof a=="function"?a(n,i,e):o(a)}}}}var aa=oa();aa.withExtraArgument=oa;function en(e){this.options=e,!e.deferSetup&&this.setup()}en.prototype={constructor:en,setup:function(){this.options.setup&&this.options.setup(),this.initialised=!0},on:function(){!this.initialised&&this.setup(),this.options.match&&this.options.match()},off:function(){this.options.unmatch&&this.options.unmatch()},destroy:function(){this.options.destroy?this.options.destroy():this.off()},equals:function(e){return this.options===e||this.options.match===e}};var fh=en;function mh(e,t){var n=0,i=e.length,o;for(n;n<i&&(o=t(e[n],n),o!==!1);n++);}function ph(e){return Object.prototype.toString.apply(e)==="[object Array]"}function gh(e){return typeof e=="function"}var sa={isFunction:gh,isArray:ph,each:mh},wh=fh,Ft=sa.each;function tn(e,t){this.query=e,this.isUnconditional=t,this.handlers=[],this.mql=window.matchMedia(e);var n=this;this.listener=function(i){n.mql=i.currentTarget||i,n.assess()},this.mql.addListener(this.listener)}tn.prototype={constuctor:tn,addHandler:function(e){var t=new wh(e);this.handlers.push(t),this.matches()&&t.on()},removeHandler:function(e){var t=this.handlers;Ft(t,function(n,i){if(n.equals(e))return n.destroy(),!t.splice(i,1)})},matches:function(){return this.mql.matches||this.isUnconditional},clear:function(){Ft(this.handlers,function(e){e.destroy()}),this.mql.removeListener(this.listener),this.handlers.length=0},assess:function(){var e=this.matches()?"on":"off";Ft(this.handlers,function(t){t[e]()})}};var bh=tn,yh=bh,Sn=sa,vh=Sn.each,Ei=Sn.isFunction,Th=Sn.isArray;function nn(){if(!window.matchMedia)throw new Error("matchMedia not present, legacy browsers require a polyfill");this.queries={},this.browserIsIncapable=!window.matchMedia("only all").matches}nn.prototype={constructor:nn,register:function(e,t,n){var i=this.queries,o=n&&this.browserIsIncapable;return i[e]||(i[e]=new yh(e,o)),Ei(t)&&(t={match:t}),Th(t)||(t=[t]),vh(t,function(a){Ei(a)&&(a={match:a}),i[e].addHandler(a)}),this},unregister:function(e,t){var n=this.queries[e];return n&&(t?n.removeHandler(t):(n.clear(),delete this.queries[e])),this}};var kh=nn,_h=kh,Lt=new _h;const Si={play_hexagram:-1,details_hexagram:-1,book_loaded:!1,preferences:{enable_gongosound:!1}};function _t(e){var t=[],n=0;if(this.trie=this.createTrie(e.patterns),this.leftMin=e.leftmin,this.rightMin=e.rightmin,this.exceptions={},e.exceptions)for(t=e.exceptions.split(/,\s?/g);n<t.length;n+=1)this.exceptions[t[n].replace(/\u2027/g,"").toLowerCase()]=new RegExp("("+t[n].split("\u2027").join(")(")+")","i")}_t.prototype.createTrie=function(e){var t=0,n=0,i=0,o=0,a=null,s=null,l=null,d=null,u={_points:[]},r;for(t in e)if(e.hasOwnProperty(t))for(r=e[t].match(new RegExp(".{1,"+ +t+"}","g")),n=0;n<r.length;n+=1){for(a=r[n].replace(/[0-9]/g,"").split(""),s=r[n].split(/\D/),d=u,i=0;i<a.length;i+=1)l=a[i].charCodeAt(0),d[l]||(d[l]={}),d=d[l];for(d._points=[],o=0;o<s.length;o+=1)d._points[o]=s[o]||0}return u};_t.prototype.hyphenateText=function(e,t){t=t||4;for(var n=e.split(/([a-zA-Z0-9_\u0027\u00AD\u00DF-\u00EA\u00EB\u00EC-\u00EF\u00F1-\u00F6\u00F8-\u00FD\u0101\u0103\u0105\u0107\u0109\u010D\u010F\u0111\u0113\u0117\u0119\u011B\u011D\u011F\u0123\u0125\u012B\u012F\u0131\u0135\u0137\u013C\u013E\u0142\u0144\u0146\u0148\u0151\u0153\u0155\u0159\u015B\u015D\u015F\u0161\u0165\u016B\u016D\u016F\u0171\u0173\u017A\u017C\u017E\u017F\u0219\u021B\u02BC\u0390\u03AC-\u03CE\u03F2\u0401\u0410-\u044F\u0451\u0454\u0456\u0457\u045E\u0491\u0531-\u0556\u0561-\u0587\u0902\u0903\u0905-\u090B\u090E-\u0910\u0912\u0914-\u0928\u092A-\u0939\u093E-\u0943\u0946-\u0948\u094A-\u094D\u0982\u0983\u0985-\u098B\u098F\u0990\u0994-\u09A8\u09AA-\u09B0\u09B2\u09B6-\u09B9\u09BE-\u09C3\u09C7\u09C8\u09CB-\u09CD\u09D7\u0A02\u0A03\u0A05-\u0A0A\u0A0F\u0A10\u0A14-\u0A28\u0A2A-\u0A30\u0A32\u0A33\u0A35\u0A36\u0A38\u0A39\u0A3E-\u0A42\u0A47\u0A48\u0A4B-\u0A4D\u0A82\u0A83\u0A85-\u0A8B\u0A8F\u0A90\u0A94-\u0AA8\u0AAA-\u0AB0\u0AB2\u0AB3\u0AB5-\u0AB9\u0ABE-\u0AC3\u0AC7\u0AC8\u0ACB-\u0ACD\u0B02\u0B03\u0B05-\u0B0B\u0B0F\u0B10\u0B14-\u0B28\u0B2A-\u0B30\u0B32\u0B33\u0B35-\u0B39\u0B3E-\u0B43\u0B47\u0B48\u0B4B-\u0B4D\u0B57\u0B82\u0B83\u0B85-\u0B8A\u0B8E-\u0B90\u0B92-\u0B95\u0B99\u0B9A\u0B9C\u0B9E\u0B9F\u0BA3\u0BA4\u0BA8-\u0BAA\u0BAE-\u0BB5\u0BB7-\u0BB9\u0BBE-\u0BC2\u0BC6-\u0BC8\u0BCA-\u0BCD\u0BD7\u0C02\u0C03\u0C05-\u0C0B\u0C0E-\u0C10\u0C12\u0C14-\u0C28\u0C2A-\u0C33\u0C35-\u0C39\u0C3E-\u0C43\u0C46-\u0C48\u0C4A-\u0C4D\u0C82\u0C83\u0C85-\u0C8B\u0C8E-\u0C90\u0C92\u0C94-\u0CA8\u0CAA-\u0CB3\u0CB5-\u0CB9\u0CBE-\u0CC3\u0CC6-\u0CC8\u0CCA-\u0CCD\u0D02\u0D03\u0D05-\u0D0C\u0D0E-\u0D10\u0D12-\u0D28\u0D2A-\u0D39\u0D3E-\u0D43\u0D46-\u0D48\u0D4A-\u0D4D\u0D57\u0D60\u0D61\u0D7A-\u0D7F\u1F00-\u1F07\u1F10-\u1F15\u1F20-\u1F27\u1F30-\u1F37\u1F40-\u1F45\u1F50-\u1F57\u1F60-\u1F67\u1F70-\u1F7D\u1F80-\u1F87\u1F90-\u1F97\u1FA0-\u1FA7\u1FB2-\u1FB4\u1FB6\u1FB7\u1FBD\u1FBF\u1FC2-\u1FC4\u1FC6\u1FC7\u1FD2\u1FD3\u1FD6\u1FD7\u1FE2-\u1FE7\u1FF2-\u1FF4\u1FF6\u1FF7\u200D\u2019]+)/gi),i=0;i<n.length;i+=1)n[i].indexOf("/")!==-1?i!==0&&i!==n.length-1&&!/\s+\/|\/\s+/.test(n[i])&&(n[i]+="\u200B"):n[i].length>t&&(n[i]=this.hyphenate(n[i]).join("\xAD"));return n.join("")};_t.prototype.hyphenate=function(e){var t,n=[],i,o,a,s,l,d=[],u,r=e.toLowerCase(),f,h,c=Math.max,m=this.trie,p=[""];if(this.exceptions.hasOwnProperty(r))return e.match(this.exceptions[r]).slice(1);if(e.indexOf("\xAD")!==-1)return[e];for(e="_"+e+"_",t=e.toLowerCase().split(""),i=e.split(""),u=t.length,o=0;o<u;o+=1)d[o]=0,n[o]=t[o].charCodeAt(0);for(o=0;o<u;o+=1)for(l=m,a=o;a<u&&(l=l[n[a]],l);a+=1)if(f=l._points,f)for(s=0,h=f.length;s<h;s+=1)d[o+s]=c(d[o+s],f[s]);for(o=1;o<u-1;o+=1)o>this.leftMin&&o<u-this.rightMin&&d[o]%2?p.push(i[o]):p[p.length-1]+=i[o];return p};var xh=_t;function ra(e){return`${e}`}function Ih(e){let t=e.indexOf("?");if(t===-1)return[];let n=e.substring(t+1).split("&");const i=decodeURIComponent;let o={};for(let a=n.length-1;a>=0;a--){let s=n[a].split("=");o[i(s[0])]=i(s[1]||"")}return o}const Ah=wo(()=>import("./en-us.41904c48.js").then(function(e){return e.e}),[]);let Eh=new xh(Ah);function Ni(e){return Eh.hyphenateText(e)}function Sh(e,t=150){const n=e.match(/[^.!?]*[.!?]/g)||[],i=[];let o=[],a=0;return n.forEach(s=>{const l=s.split(/\s+/).length;a+l>t&&(i.push(o.join(" ")),o=[],a=0),o.push(s),a+=l}),o.length>0&&i.push(o.join(" ")),i}function on(e,t){return on=Object.setPrototypeOf||function(i,o){return i.__proto__=o,i},on(e,t)}function ke(e,t){e.prototype=Object.create(t.prototype),e.prototype.constructor=e,on(e,t)}function Xe(e){return e.charAt(0)==="/"}function Mt(e,t){for(var n=t,i=n+1,o=e.length;i<o;n+=1,i+=1)e[n]=e[i];e.pop()}function Nh(e,t){t===void 0&&(t="");var n=e&&e.split("/")||[],i=t&&t.split("/")||[],o=e&&Xe(e),a=t&&Xe(t),s=o||a;if(e&&Xe(e)?i=n:n.length&&(i.pop(),i=i.concat(n)),!i.length)return"/";var l;if(i.length){var d=i[i.length-1];l=d==="."||d===".."||d===""}else l=!1;for(var u=0,r=i.length;r>=0;r--){var f=i[r];f==="."?Mt(i,r):f===".."?(Mt(i,r),u++):u&&(Mt(i,r),u--)}if(!s)for(;u--;u)i.unshift("..");s&&i[0]!==""&&(!i[0]||!Xe(i[0]))&&i.unshift("");var h=i.join("/");return l&&h.substr(-1)!=="/"&&(h+="/"),h}var Hh=!0,Hi="Invariant failed";function Ue(e,t){if(!e)throw Hh?new Error(Hi):new Error(Hi+": "+(t||""))}function tt(e){return e.charAt(0)==="/"?e:"/"+e}function Ci(e){return e.charAt(0)==="/"?e.substr(1):e}function Ch(e,t){return e.toLowerCase().indexOf(t.toLowerCase())===0&&"/?#".indexOf(e.charAt(t.length))!==-1}function Oh(e,t){return Ch(e,t)?e.substr(t.length):e}function Ph(e){return e.charAt(e.length-1)==="/"?e.slice(0,-1):e}function $h(e){var t=e||"/",n="",i="",o=t.indexOf("#");o!==-1&&(i=t.substr(o),t=t.substr(0,o));var a=t.indexOf("?");return a!==-1&&(n=t.substr(a),t=t.substr(0,a)),{pathname:t,search:n==="?"?"":n,hash:i==="#"?"":i}}function V(e){var t=e.pathname,n=e.search,i=e.hash,o=t||"/";return n&&n!=="?"&&(o+=n.charAt(0)==="?"?n:"?"+n),i&&i!=="#"&&(o+=i.charAt(0)==="#"?i:"#"+i),o}function nt(e,t,n,i){var o;typeof e=="string"?(o=$h(e),o.state=t):(o=B({},e),o.pathname===void 0&&(o.pathname=""),o.search?o.search.charAt(0)!=="?"&&(o.search="?"+o.search):o.search="",o.hash?o.hash.charAt(0)!=="#"&&(o.hash="#"+o.hash):o.hash="",t!==void 0&&o.state===void 0&&(o.state=t));try{o.pathname=decodeURI(o.pathname)}catch(a){throw a instanceof URIError?new URIError('Pathname "'+o.pathname+'" could not be decoded. This is likely caused by an invalid percent-encoding.'):a}return n&&(o.key=n),i?o.pathname?o.pathname.charAt(0)!=="/"&&(o.pathname=Nh(o.pathname,i.pathname)):o.pathname=i.pathname:o.pathname||(o.pathname="/"),o}function Rh(){var e=null;function t(s){return e=s,function(){e===s&&(e=null)}}function n(s,l,d,u){if(e!=null){var r=typeof e=="function"?e(s,l):e;typeof r=="string"?typeof d=="function"?d(r,u):u(!0):u(r!==!1)}else u(!0)}var i=[];function o(s){var l=!0;function d(){l&&s.apply(void 0,arguments)}return i.push(d),function(){l=!1,i=i.filter(function(u){return u!==d})}}function a(){for(var s=arguments.length,l=new Array(s),d=0;d<s;d++)l[d]=arguments[d];i.forEach(function(u){return u.apply(void 0,l)})}return{setPrompt:t,confirmTransitionTo:n,appendListener:o,notifyListeners:a}}var jh=!!(typeof window!="undefined"&&window.document&&window.document.createElement);function Bh(e,t){t(window.confirm(e))}function Wh(){return window.navigator.userAgent.indexOf("Firefox")===-1}var Oi="hashchange",Fh={hashbang:{encodePath:function(t){return t.charAt(0)==="!"?t:"!/"+Ci(t)},decodePath:function(t){return t.charAt(0)==="!"?t.substr(1):t}},noslash:{encodePath:Ci,decodePath:tt},slash:{encodePath:tt,decodePath:tt}};function ha(e){var t=e.indexOf("#");return t===-1?e:e.slice(0,t)}function Re(){var e=window.location.href,t=e.indexOf("#");return t===-1?"":e.substring(t+1)}function Lh(e){window.location.hash=e}function Dt(e){window.location.replace(ha(window.location.href)+"#"+e)}function Mh(e){e===void 0&&(e={}),jh||Ue(!1);var t=window.history;Wh();var n=e,i=n.getUserConfirmation,o=i===void 0?Bh:i,a=n.hashType,s=a===void 0?"slash":a,l=e.basename?Ph(tt(e.basename)):"",d=Fh[s],u=d.encodePath,r=d.decodePath;function f(){var k=r(Re());return l&&(k=Oh(k,l)),nt(k)}var h=Rh();function c(k){B(W,k),W.length=t.length,h.notifyListeners(W.location,W.action)}var m=!1,p=null;function g(k,S){return k.pathname===S.pathname&&k.search===S.search&&k.hash===S.hash}function w(){var k=Re(),S=u(k);if(k!==S)Dt(S);else{var E=f(),R=W.location;if(!m&&g(R,E)||p===V(E))return;p=null,v(E)}}function v(k){if(m)m=!1,c();else{var S="POP";h.confirmTransitionTo(k,S,o,function(E){E?c({action:S,location:k}):_(k)})}}function _(k){var S=W.location,E=O.lastIndexOf(V(S));E===-1&&(E=0);var R=O.lastIndexOf(V(k));R===-1&&(R=0);var ee=E-R;ee&&(m=!0,Z(ee))}var y=Re(),x=u(y);y!==x&&Dt(x);var C=f(),O=[V(C)];function M(k){var S=document.querySelector("base"),E="";return S&&S.getAttribute("href")&&(E=ha(window.location.href)),E+"#"+u(l+V(k))}function j(k,S){var E="PUSH",R=nt(k,void 0,void 0,W.location);h.confirmTransitionTo(R,E,o,function(ee){if(!!ee){var z=V(R),ae=u(l+z),ge=Re()!==ae;if(ge){p=z,Lh(ae);var le=O.lastIndexOf(V(W.location)),ze=O.slice(0,le+1);ze.push(z),O=ze,c({action:E,location:R})}else c()}})}function U(k,S){var E="REPLACE",R=nt(k,void 0,void 0,W.location);h.confirmTransitionTo(R,E,o,function(ee){if(!!ee){var z=V(R),ae=u(l+z),ge=Re()!==ae;ge&&(p=z,Dt(ae));var le=O.indexOf(V(W.location));le!==-1&&(O[le]=z),c({action:E,location:R})}})}function Z(k){t.go(k)}function oe(){Z(-1)}function re(){Z(1)}var P=0;function K(k){P+=k,P===1&&k===1?window.addEventListener(Oi,w):P===0&&window.removeEventListener(Oi,w)}var D=!1;function pe(k){k===void 0&&(k=!1);var S=h.setPrompt(k);return D||(K(1),D=!0),function(){return D&&(D=!1,K(-1)),S()}}function he(k){var S=h.appendListener(k);return K(1),function(){K(-1),S()}}var W={length:t.length,action:"POP",location:C,createHref:M,push:j,replace:U,go:Z,goBack:oe,goForward:re,block:pe,listen:he};return W}var Gt=1073741823,Pi=typeof globalThis!="undefined"?globalThis:typeof window!="undefined"?window:typeof global!="undefined"?global:{};function Dh(){var e="__global_unique_id__";return Pi[e]=(Pi[e]||0)+1}function Gh(e,t){return e===t?e!==0||1/e===1/t:e!==e&&t!==t}function qh(e){var t=[];return{on:function(i){t.push(i)},off:function(i){t=t.filter(function(o){return o!==i})},get:function(){return e},set:function(i,o){e=i,t.forEach(function(a){return a(e,o)})}}}function Uh(e){return Array.isArray(e)?e[0]:e}function Kh(e,t){var n,i,o="__create-react-context-"+Dh()+"__",a=function(l){ke(d,l);function d(){var r;return r=l.apply(this,arguments)||this,r.emitter=qh(r.props.value),r}var u=d.prototype;return u.getChildContext=function(){var f;return f={},f[o]=this.emitter,f},u.componentWillReceiveProps=function(f){if(this.props.value!==f.value){var h=this.props.value,c=f.value,m;Gh(h,c)?m=0:(m=typeof t=="function"?t(h,c):Gt,m|=0,m!==0&&this.emitter.set(f.value,m))}},u.render=function(){return this.props.children},d}(H);a.childContextTypes=(n={},n[o]=pi.object.isRequired,n);var s=function(l){ke(d,l);function d(){var r;return r=l.apply(this,arguments)||this,r.state={value:r.getValue()},r.onUpdate=function(f,h){var c=r.observedBits|0;(c&h)!==0&&r.setState({value:r.getValue()})},r}var u=d.prototype;return u.componentWillReceiveProps=function(f){var h=f.observedBits;this.observedBits=h==null?Gt:h},u.componentDidMount=function(){this.context[o]&&this.context[o].on(this.onUpdate);var f=this.props.observedBits;this.observedBits=f==null?Gt:f},u.componentWillUnmount=function(){this.context[o]&&this.context[o].off(this.onUpdate)},u.getValue=function(){return this.context[o]?this.context[o].get():e},u.render=function(){return Uh(this.props.children)(this.state.value)},d}(H);return s.contextTypes=(i={},i[o]=pi.object,i),{Provider:a,Consumer:s}}var zh=I.createContext||Kh,Ae={exports:{}},Yh=Array.isArray||function(e){return Object.prototype.toString.call(e)=="[object Array]"},lt=Yh;Ae.exports=da;Ae.exports.parse=Nn;Ae.exports.compile=Jh;Ae.exports.tokensToFunction=la;Ae.exports.tokensToRegExp=ua;var Vh=new RegExp(["(\\\\.)","([\\/.])?(?:(?:\\:(\\w+)(?:\\(((?:\\\\.|[^\\\\()])+)\\))?|\\(((?:\\\\.|[^\\\\()])+)\\))([+*?])?|(\\*))"].join("|"),"g");function Nn(e,t){for(var n=[],i=0,o=0,a="",s=t&&t.delimiter||"/",l;(l=Vh.exec(e))!=null;){var d=l[0],u=l[1],r=l.index;if(a+=e.slice(o,r),o=r+d.length,u){a+=u[1];continue}var f=e[o],h=l[2],c=l[3],m=l[4],p=l[5],g=l[6],w=l[7];a&&(n.push(a),a="");var v=h!=null&&f!=null&&f!==h,_=g==="+"||g==="*",y=g==="?"||g==="*",x=l[2]||s,C=m||p;n.push({name:c||i++,prefix:h||"",delimiter:x,optional:y,repeat:_,partial:v,asterisk:!!w,pattern:C?Zh(C):w?".*":"[^"+it(x)+"]+?"})}return o<e.length&&(a+=e.substr(o)),a&&n.push(a),n}function Jh(e,t){return la(Nn(e,t),t)}function Xh(e){return encodeURI(e).replace(/[\/?#]/g,function(t){return"%"+t.charCodeAt(0).toString(16).toUpperCase()})}function Qh(e){return encodeURI(e).replace(/[?#]/g,function(t){return"%"+t.charCodeAt(0).toString(16).toUpperCase()})}function la(e,t){for(var n=new Array(e.length),i=0;i<e.length;i++)typeof e[i]=="object"&&(n[i]=new RegExp("^(?:"+e[i].pattern+")$",Cn(t)));return function(o,a){for(var s="",l=o||{},d=a||{},u=d.pretty?Xh:encodeURIComponent,r=0;r<e.length;r++){var f=e[r];if(typeof f=="string"){s+=f;continue}var h=l[f.name],c;if(h==null)if(f.optional){f.partial&&(s+=f.prefix);continue}else throw new TypeError('Expected "'+f.name+'" to be defined');if(lt(h)){if(!f.repeat)throw new TypeError('Expected "'+f.name+'" to not repeat, but received `'+JSON.stringify(h)+"`");if(h.length===0){if(f.optional)continue;throw new TypeError('Expected "'+f.name+'" to not be empty')}for(var m=0;m<h.length;m++){if(c=u(h[m]),!n[r].test(c))throw new TypeError('Expected all "'+f.name+'" to match "'+f.pattern+'", but received `'+JSON.stringify(c)+"`");s+=(m===0?f.prefix:f.delimiter)+c}continue}if(c=f.asterisk?Qh(h):u(h),!n[r].test(c))throw new TypeError('Expected "'+f.name+'" to match "'+f.pattern+'", but received "'+c+'"');s+=f.prefix+c}return s}}function it(e){return e.replace(/([.+*?=^!:${}()[\]|\/\\])/g,"\\$1")}function Zh(e){return e.replace(/([=!:$\/()])/g,"\\$1")}function Hn(e,t){return e.keys=t,e}function Cn(e){return e&&e.sensitive?"":"i"}function el(e,t){var n=e.source.match(/\((?!\?)/g);if(n)for(var i=0;i<n.length;i++)t.push({name:i,prefix:null,delimiter:null,optional:!1,repeat:!1,partial:!1,asterisk:!1,pattern:null});return Hn(e,t)}function tl(e,t,n){for(var i=[],o=0;o<e.length;o++)i.push(da(e[o],t,n).source);var a=new RegExp("(?:"+i.join("|")+")",Cn(n));return Hn(a,t)}function nl(e,t,n){return ua(Nn(e,n),t,n)}function ua(e,t,n){lt(t)||(n=t||n,t=[]),n=n||{};for(var i=n.strict,o=n.end!==!1,a="",s=0;s<e.length;s++){var l=e[s];if(typeof l=="string")a+=it(l);else{var d=it(l.prefix),u="(?:"+l.pattern+")";t.push(l),l.repeat&&(u+="(?:"+d+u+")*"),l.optional?l.partial?u=d+"("+u+")?":u="(?:"+d+"("+u+"))?":u=d+"("+u+")",a+=u}}var r=it(n.delimiter||"/"),f=a.slice(-r.length)===r;return i||(a=(f?a.slice(0,-r.length):a)+"(?:"+r+"(?=$))?"),o?a+="$":a+=i&&f?"":"(?="+r+"|$)",Hn(new RegExp("^"+a,Cn(n)),t)}function da(e,t,n){return lt(t)||(n=t||n,t=[]),n=n||{},e instanceof RegExp?el(e,t):lt(e)?tl(e,t,n):nl(e,t,n)}var il=Ae.exports,ca=function(t){var n=zh();return n.displayName=t,n},ol=ca("Router-History"),_e=ca("Router"),al=function(e){ke(t,e),t.computeRootMatch=function(o){return{path:"/",url:"/",params:{},isExact:o==="/"}};function t(i){var o;return o=e.call(this,i)||this,o.state={location:i.history.location},o._isMounted=!1,o._pendingLocation=null,i.staticContext||(o.unlisten=i.history.listen(function(a){o._isMounted?o.setState({location:a}):o._pendingLocation=a})),o}var n=t.prototype;return n.componentDidMount=function(){this._isMounted=!0,this._pendingLocation&&this.setState({location:this._pendingLocation})},n.componentWillUnmount=function(){this.unlisten&&(this.unlisten(),this._isMounted=!1,this._pendingLocation=null)},n.render=function(){return I.createElement(_e.Provider,{value:{history:this.props.history,location:this.state.location,match:t.computeRootMatch(this.state.location.pathname),staticContext:this.props.staticContext}},I.createElement(ol.Provider,{children:this.props.children||null,value:this.props.history}))},t}(I.Component),$i={},sl=1e4,Ri=0;function rl(e,t){var n=""+t.end+t.strict+t.sensitive,i=$i[n]||($i[n]={});if(i[e])return i[e];var o=[],a=il(e,o,t),s={regexp:a,keys:o};return Ri<sl&&(i[e]=s,Ri++),s}function On(e,t){t===void 0&&(t={}),(typeof t=="string"||Array.isArray(t))&&(t={path:t});var n=t,i=n.path,o=n.exact,a=o===void 0?!1:o,s=n.strict,l=s===void 0?!1:s,d=n.sensitive,u=d===void 0?!1:d,r=[].concat(i);return r.reduce(function(f,h){if(!h&&h!=="")return null;if(f)return f;var c=rl(h,{end:a,strict:l,sensitive:u}),m=c.regexp,p=c.keys,g=m.exec(e);if(!g)return null;var w=g[0],v=g.slice(1),_=e===w;return a&&!_?null:{path:h,url:h==="/"&&w===""?"/":w,isExact:_,params:p.reduce(function(y,x,C){return y[x.name]=v[C],y},{})}},null)}function hl(e){return I.Children.count(e)===0}var qt=function(e){ke(t,e);function t(){return e.apply(this,arguments)||this}var n=t.prototype;return n.render=function(){var o=this;return I.createElement(_e.Consumer,null,function(a){a||Ue(!1);var s=o.props.location||a.location,l=o.props.computedMatch?o.props.computedMatch:o.props.path?On(s.pathname,o.props):a.match,d=B({},a,{location:s,match:l}),u=o.props,r=u.children,f=u.component,h=u.render;return Array.isArray(r)&&hl(r)&&(r=null),I.createElement(_e.Provider,{value:d},d.match?r?typeof r=="function"?r(d):r:f?I.createElement(f,d):h?h(d):null:typeof r=="function"?r(d):null)})},t}(I.Component),ll=function(e){ke(t,e);function t(){return e.apply(this,arguments)||this}var n=t.prototype;return n.render=function(){var o=this;return I.createElement(_e.Consumer,null,function(a){a||Ue(!1);var s=o.props.location||a.location,l,d;return I.Children.forEach(o.props.children,function(u){if(d==null&&I.isValidElement(u)){l=u;var r=u.props.path||u.props.from;d=r?On(s.pathname,B({},u.props,{path:r})):a.match}}),d?I.cloneElement(l,{location:s,computedMatch:d}):null})},t}(I.Component),ul=function(e){ke(t,e);function t(){for(var i,o=arguments.length,a=new Array(o),s=0;s<o;s++)a[s]=arguments[s];return i=e.call.apply(e,[this].concat(a))||this,i.history=Mh(i.props),i}var n=t.prototype;return n.render=function(){return I.createElement(al,{history:this.history,children:this.props.children})},t}(I.Component),an=function(t,n){return typeof t=="function"?t(n):t},sn=function(t,n){return typeof t=="string"?nt(t,null,null,n):t},Pn=function(t){return t},xe=I.forwardRef;typeof xe=="undefined"&&(xe=Pn);function dl(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}var cl=xe(function(e,t){var n=e.innerRef,i=e.navigate,o=e.onClick,a=ce(e,["innerRef","navigate","onClick"]),s=a.target,l=B({},a,{onClick:function(u){try{o&&o(u)}catch(r){throw u.preventDefault(),r}!u.defaultPrevented&&u.button===0&&(!s||s==="_self")&&!dl(u)&&(u.preventDefault(),i())}});return Pn!==xe?l.ref=t||n:l.ref=n,I.createElement("a",l)}),fl=xe(function(e,t){var n=e.component,i=n===void 0?cl:n,o=e.replace,a=e.to,s=e.innerRef,l=ce(e,["component","replace","to","innerRef"]);return I.createElement(_e.Consumer,null,function(d){d||Ue(!1);var u=d.history,r=sn(an(a,d.location),d.location),f=r?u.createHref(r):"",h=B({},l,{href:f,navigate:function(){var m=an(a,d.location),p=V(d.location)===V(sn(m)),g=o||p?u.replace:u.push;g(m)}});return Pn!==xe?h.ref=t||s:h.innerRef=s,I.createElement(i,h)})}),fa=function(t){return t},ut=I.forwardRef;typeof ut=="undefined"&&(ut=fa);function ml(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];return t.filter(function(i){return i}).join(" ")}ut(function(e,t){var n=e["aria-current"],i=n===void 0?"page":n,o=e.activeClassName,a=o===void 0?"active":o,s=e.activeStyle,l=e.className,d=e.exact,u=e.isActive,r=e.location,f=e.sensitive,h=e.strict,c=e.style,m=e.to,p=e.innerRef,g=ce(e,["aria-current","activeClassName","activeStyle","className","exact","isActive","location","sensitive","strict","style","to","innerRef"]);return I.createElement(_e.Consumer,null,function(w){w||Ue(!1);var v=r||w.location,_=sn(an(m,v),v),y=_.pathname,x=y&&y.replace(/([.+*?=^!:${}()[\]|/\\])/g,"\\$1"),C=x?On(v.pathname,{path:x,exact:d,sensitive:f,strict:h}):null,O=!!(u?u(C,v):C),M=typeof l=="function"?l(O):l,j=typeof c=="function"?c(O):c;O&&(M=ml(M,a),j=B({},j,s));var U=B({"aria-current":O&&i||null,className:M,style:j,to:_},g);return fa!==ut?U.ref=t||p:U.innerRef=p,I.createElement(fl,U)})});class ma extends H{componentWillUpdate(){this.scrollToTop()}render(){return T("div",{className:"content",ref:t=>{this.content=t},children:T(ul,{children:T(ll,{children:[T(qt,{exact:!0,path:"/",component:iy}),T(qt,{path:"/about",component:ay}),T(qt,{path:"/details/:number",component:Ja})]})})})}scrollToTop(){let t=this.content;t.scrollTop=0}}ma.defaultProps={isMobile:!0};var pl=Object.prototype;function gl(e){var t=e&&e.constructor,n=typeof t=="function"&&t.prototype||pl;return e===n}var pa=gl;function wl(e,t){return function(n){return e(t(n))}}var bl=wl,yl=bl,vl=yl(Object.keys,Object),Tl=vl,kl=pa,_l=Tl,xl=Object.prototype,Il=xl.hasOwnProperty;function Al(e){if(!kl(e))return _l(e);var t=[];for(var n in Object(e))Il.call(e,n)&&n!="constructor"&&t.push(n);return t}var ga=Al,El=typeof Je=="object"&&Je&&Je.Object===Object&&Je,wa=El,Sl=wa,Nl=typeof self=="object"&&self&&self.Object===Object&&self,Hl=Sl||Nl||Function("return this")(),ie=Hl,Cl=ie,Ol=Cl.Symbol,xt=Ol,ji=xt,ba=Object.prototype,Pl=ba.hasOwnProperty,$l=ba.toString,je=ji?ji.toStringTag:void 0;function Rl(e){var t=Pl.call(e,je),n=e[je];try{e[je]=void 0;var i=!0}catch{}var o=$l.call(e);return i&&(t?e[je]=n:delete e[je]),o}var jl=Rl,Bl=Object.prototype,Wl=Bl.toString;function Fl(e){return Wl.call(e)}var Ll=Fl,Bi=xt,Ml=jl,Dl=Ll,Gl="[object Null]",ql="[object Undefined]",Wi=Bi?Bi.toStringTag:void 0;function Ul(e){return e==null?e===void 0?ql:Gl:Wi&&Wi in Object(e)?Ml(e):Dl(e)}var fe=Ul;function Kl(e){var t=typeof e;return e!=null&&(t=="object"||t=="function")}var Ke=Kl,zl=fe,Yl=Ke,Vl="[object AsyncFunction]",Jl="[object Function]",Xl="[object GeneratorFunction]",Ql="[object Proxy]";function Zl(e){if(!Yl(e))return!1;var t=zl(e);return t==Jl||t==Xl||t==Vl||t==Ql}var ya=Zl,eu=ie,tu=eu["__core-js_shared__"],nu=tu,Ut=nu,Fi=function(){var e=/[^.]+$/.exec(Ut&&Ut.keys&&Ut.keys.IE_PROTO||"");return e?"Symbol(src)_1."+e:""}();function iu(e){return!!Fi&&Fi in e}var ou=iu,au=Function.prototype,su=au.toString;function ru(e){if(e!=null){try{return su.call(e)}catch{}try{return e+""}catch{}}return""}var va=ru,hu=ya,lu=ou,uu=Ke,du=va,cu=/[\\^$.*+?()[\]{}|]/g,fu=/^\[object .+?Constructor\]$/,mu=Function.prototype,pu=Object.prototype,gu=mu.toString,wu=pu.hasOwnProperty,bu=RegExp("^"+gu.call(wu).replace(cu,"\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,"$1.*?")+"$");function yu(e){if(!uu(e)||lu(e))return!1;var t=hu(e)?bu:fu;return t.test(du(e))}var vu=yu;function Tu(e,t){return e==null?void 0:e[t]}var ku=Tu,_u=vu,xu=ku;function Iu(e,t){var n=xu(e,t);return _u(n)?n:void 0}var Ee=Iu,Au=Ee,Eu=ie,Su=Au(Eu,"DataView"),Nu=Su,Hu=Ee,Cu=ie,Ou=Hu(Cu,"Map"),$n=Ou,Pu=Ee,$u=ie,Ru=Pu($u,"Promise"),ju=Ru,Bu=Ee,Wu=ie,Fu=Bu(Wu,"Set"),Lu=Fu,Mu=Ee,Du=ie,Gu=Mu(Du,"WeakMap"),qu=Gu,rn=Nu,hn=$n,ln=ju,un=Lu,dn=qu,Ta=fe,Se=va,Li="[object Map]",Uu="[object Object]",Mi="[object Promise]",Di="[object Set]",Gi="[object WeakMap]",qi="[object DataView]",Ku=Se(rn),zu=Se(hn),Yu=Se(ln),Vu=Se(un),Ju=Se(dn),ue=Ta;(rn&&ue(new rn(new ArrayBuffer(1)))!=qi||hn&&ue(new hn)!=Li||ln&&ue(ln.resolve())!=Mi||un&&ue(new un)!=Di||dn&&ue(new dn)!=Gi)&&(ue=function(e){var t=Ta(e),n=t==Uu?e.constructor:void 0,i=n?Se(n):"";if(i)switch(i){case Ku:return qi;case zu:return Li;case Yu:return Mi;case Vu:return Di;case Ju:return Gi}return t});var ka=ue;function Xu(e){return e!=null&&typeof e=="object"}var me=Xu,Qu=fe,Zu=me,ed="[object Arguments]";function td(e){return Zu(e)&&Qu(e)==ed}var nd=td,Ui=nd,id=me,_a=Object.prototype,od=_a.hasOwnProperty,ad=_a.propertyIsEnumerable,sd=Ui(function(){return arguments}())?Ui:function(e){return id(e)&&od.call(e,"callee")&&!ad.call(e,"callee")},Rn=sd,rd=Array.isArray,X=rd,hd=9007199254740991;function ld(e){return typeof e=="number"&&e>-1&&e%1==0&&e<=hd}var jn=ld,ud=ya,dd=jn;function cd(e){return e!=null&&dd(e.length)&&!ud(e)}var Bn=cd,De={exports:{}};function fd(){return!1}var md=fd;(function(e,t){var n=ie,i=md,o=t&&!t.nodeType&&t,a=o&&!0&&e&&!e.nodeType&&e,s=a&&a.exports===o,l=s?n.Buffer:void 0,d=l?l.isBuffer:void 0,u=d||i;e.exports=u})(De,De.exports);var pd=fe,gd=jn,wd=me,bd="[object Arguments]",yd="[object Array]",vd="[object Boolean]",Td="[object Date]",kd="[object Error]",_d="[object Function]",xd="[object Map]",Id="[object Number]",Ad="[object Object]",Ed="[object RegExp]",Sd="[object Set]",Nd="[object String]",Hd="[object WeakMap]",Cd="[object ArrayBuffer]",Od="[object DataView]",Pd="[object Float32Array]",$d="[object Float64Array]",Rd="[object Int8Array]",jd="[object Int16Array]",Bd="[object Int32Array]",Wd="[object Uint8Array]",Fd="[object Uint8ClampedArray]",Ld="[object Uint16Array]",Md="[object Uint32Array]",N={};N[Pd]=N[$d]=N[Rd]=N[jd]=N[Bd]=N[Wd]=N[Fd]=N[Ld]=N[Md]=!0;N[bd]=N[yd]=N[Cd]=N[vd]=N[Od]=N[Td]=N[kd]=N[_d]=N[xd]=N[Id]=N[Ad]=N[Ed]=N[Sd]=N[Nd]=N[Hd]=!1;function Dd(e){return wd(e)&&gd(e.length)&&!!N[pd(e)]}var Gd=Dd;function qd(e){return function(t){return e(t)}}var Ud=qd,cn={exports:{}};(function(e,t){var n=wa,i=t&&!t.nodeType&&t,o=i&&!0&&e&&!e.nodeType&&e,a=o&&o.exports===i,s=a&&n.process,l=function(){try{var d=o&&o.require&&o.require("util").types;return d||s&&s.binding&&s.binding("util")}catch{}}();e.exports=l})(cn,cn.exports);var Kd=Gd,zd=Ud,Ki=cn.exports,zi=Ki&&Ki.isTypedArray,Yd=zi?zd(zi):Kd,Wn=Yd,Vd=ga,Jd=ka,Xd=Rn,Qd=X,Zd=Bn,ec=De.exports,tc=pa,nc=Wn,ic="[object Map]",oc="[object Set]",ac=Object.prototype,sc=ac.hasOwnProperty;function rc(e){if(e==null)return!0;if(Zd(e)&&(Qd(e)||typeof e=="string"||typeof e.splice=="function"||ec(e)||nc(e)||Xd(e)))return!e.length;var t=Jd(e);if(t==ic||t==oc)return!e.size;if(tc(e))return!Vd(e).length;for(var n in e)if(sc.call(e,n))return!1;return!0}var hc=rc;function lc(){this.__data__=[],this.size=0}var uc=lc;function dc(e,t){return e===t||e!==e&&t!==t}var xa=dc,cc=xa;function fc(e,t){for(var n=e.length;n--;)if(cc(e[n][0],t))return n;return-1}var It=fc,mc=It,pc=Array.prototype,gc=pc.splice;function wc(e){var t=this.__data__,n=mc(t,e);if(n<0)return!1;var i=t.length-1;return n==i?t.pop():gc.call(t,n,1),--this.size,!0}var bc=wc,yc=It;function vc(e){var t=this.__data__,n=yc(t,e);return n<0?void 0:t[n][1]}var Tc=vc,kc=It;function _c(e){return kc(this.__data__,e)>-1}var xc=_c,Ic=It;function Ac(e,t){var n=this.__data__,i=Ic(n,e);return i<0?(++this.size,n.push([e,t])):n[i][1]=t,this}var Ec=Ac,Sc=uc,Nc=bc,Hc=Tc,Cc=xc,Oc=Ec;function Ne(e){var t=-1,n=e==null?0:e.length;for(this.clear();++t<n;){var i=e[t];this.set(i[0],i[1])}}Ne.prototype.clear=Sc;Ne.prototype.delete=Nc;Ne.prototype.get=Hc;Ne.prototype.has=Cc;Ne.prototype.set=Oc;var At=Ne,Pc=At;function $c(){this.__data__=new Pc,this.size=0}var Rc=$c;function jc(e){var t=this.__data__,n=t.delete(e);return this.size=t.size,n}var Bc=jc;function Wc(e){return this.__data__.get(e)}var Fc=Wc;function Lc(e){return this.__data__.has(e)}var Mc=Lc,Dc=Ee,Gc=Dc(Object,"create"),Et=Gc,Yi=Et;function qc(){this.__data__=Yi?Yi(null):{},this.size=0}var Uc=qc;function Kc(e){var t=this.has(e)&&delete this.__data__[e];return this.size-=t?1:0,t}var zc=Kc,Yc=Et,Vc="__lodash_hash_undefined__",Jc=Object.prototype,Xc=Jc.hasOwnProperty;function Qc(e){var t=this.__data__;if(Yc){var n=t[e];return n===Vc?void 0:n}return Xc.call(t,e)?t[e]:void 0}var Zc=Qc,ef=Et,tf=Object.prototype,nf=tf.hasOwnProperty;function of(e){var t=this.__data__;return ef?t[e]!==void 0:nf.call(t,e)}var af=of,sf=Et,rf="__lodash_hash_undefined__";function hf(e,t){var n=this.__data__;return this.size+=this.has(e)?0:1,n[e]=sf&&t===void 0?rf:t,this}var lf=hf,uf=Uc,df=zc,cf=Zc,ff=af,mf=lf;function He(e){var t=-1,n=e==null?0:e.length;for(this.clear();++t<n;){var i=e[t];this.set(i[0],i[1])}}He.prototype.clear=uf;He.prototype.delete=df;He.prototype.get=cf;He.prototype.has=ff;He.prototype.set=mf;var pf=He,Vi=pf,gf=At,wf=$n;function bf(){this.size=0,this.__data__={hash:new Vi,map:new(wf||gf),string:new Vi}}var yf=bf;function vf(e){var t=typeof e;return t=="string"||t=="number"||t=="symbol"||t=="boolean"?e!=="__proto__":e===null}var Tf=vf,kf=Tf;function _f(e,t){var n=e.__data__;return kf(t)?n[typeof t=="string"?"string":"hash"]:n.map}var St=_f,xf=St;function If(e){var t=xf(this,e).delete(e);return this.size-=t?1:0,t}var Af=If,Ef=St;function Sf(e){return Ef(this,e).get(e)}var Nf=Sf,Hf=St;function Cf(e){return Hf(this,e).has(e)}var Of=Cf,Pf=St;function $f(e,t){var n=Pf(this,e),i=n.size;return n.set(e,t),this.size+=n.size==i?0:1,this}var Rf=$f,jf=yf,Bf=Af,Wf=Nf,Ff=Of,Lf=Rf;function Ce(e){var t=-1,n=e==null?0:e.length;for(this.clear();++t<n;){var i=e[t];this.set(i[0],i[1])}}Ce.prototype.clear=jf;Ce.prototype.delete=Bf;Ce.prototype.get=Wf;Ce.prototype.has=Ff;Ce.prototype.set=Lf;var Fn=Ce,Mf=At,Df=$n,Gf=Fn,qf=200;function Uf(e,t){var n=this.__data__;if(n instanceof Mf){var i=n.__data__;if(!Df||i.length<qf-1)return i.push([e,t]),this.size=++n.size,this;n=this.__data__=new Gf(i)}return n.set(e,t),this.size=n.size,this}var Kf=Uf,zf=At,Yf=Rc,Vf=Bc,Jf=Fc,Xf=Mc,Qf=Kf;function Oe(e){var t=this.__data__=new zf(e);this.size=t.size}Oe.prototype.clear=Yf;Oe.prototype.delete=Vf;Oe.prototype.get=Jf;Oe.prototype.has=Xf;Oe.prototype.set=Qf;var Ia=Oe,Zf="__lodash_hash_undefined__";function em(e){return this.__data__.set(e,Zf),this}var tm=em;function nm(e){return this.__data__.has(e)}var im=nm,om=Fn,am=tm,sm=im;function dt(e){var t=-1,n=e==null?0:e.length;for(this.__data__=new om;++t<n;)this.add(e[t])}dt.prototype.add=dt.prototype.push=am;dt.prototype.has=sm;var rm=dt;function hm(e,t){for(var n=-1,i=e==null?0:e.length;++n<i;)if(t(e[n],n,e))return!0;return!1}var lm=hm;function um(e,t){return e.has(t)}var dm=um,cm=rm,fm=lm,mm=dm,pm=1,gm=2;function wm(e,t,n,i,o,a){var s=n&pm,l=e.length,d=t.length;if(l!=d&&!(s&&d>l))return!1;var u=a.get(e),r=a.get(t);if(u&&r)return u==t&&r==e;var f=-1,h=!0,c=n&gm?new cm:void 0;for(a.set(e,t),a.set(t,e);++f<l;){var m=e[f],p=t[f];if(i)var g=s?i(p,m,f,t,e,a):i(m,p,f,e,t,a);if(g!==void 0){if(g)continue;h=!1;break}if(c){if(!fm(t,function(w,v){if(!mm(c,v)&&(m===w||o(m,w,n,i,a)))return c.push(v)})){h=!1;break}}else if(!(m===p||o(m,p,n,i,a))){h=!1;break}}return a.delete(e),a.delete(t),h}var Aa=wm,bm=ie,ym=bm.Uint8Array,vm=ym;function Tm(e){var t=-1,n=Array(e.size);return e.forEach(function(i,o){n[++t]=[o,i]}),n}var km=Tm;function _m(e){var t=-1,n=Array(e.size);return e.forEach(function(i){n[++t]=i}),n}var xm=_m,Ji=xt,Xi=vm,Im=xa,Am=Aa,Em=km,Sm=xm,Nm=1,Hm=2,Cm="[object Boolean]",Om="[object Date]",Pm="[object Error]",$m="[object Map]",Rm="[object Number]",jm="[object RegExp]",Bm="[object Set]",Wm="[object String]",Fm="[object Symbol]",Lm="[object ArrayBuffer]",Mm="[object DataView]",Qi=Ji?Ji.prototype:void 0,Kt=Qi?Qi.valueOf:void 0;function Dm(e,t,n,i,o,a,s){switch(n){case Mm:if(e.byteLength!=t.byteLength||e.byteOffset!=t.byteOffset)return!1;e=e.buffer,t=t.buffer;case Lm:return!(e.byteLength!=t.byteLength||!a(new Xi(e),new Xi(t)));case Cm:case Om:case Rm:return Im(+e,+t);case Pm:return e.name==t.name&&e.message==t.message;case jm:case Wm:return e==t+"";case $m:var l=Em;case Bm:var d=i&Nm;if(l||(l=Sm),e.size!=t.size&&!d)return!1;var u=s.get(e);if(u)return u==t;i|=Hm,s.set(e,t);var r=Am(l(e),l(t),i,o,a,s);return s.delete(e),r;case Fm:if(Kt)return Kt.call(e)==Kt.call(t)}return!1}var Gm=Dm;function qm(e,t){for(var n=-1,i=t.length,o=e.length;++n<i;)e[o+n]=t[n];return e}var Um=qm,Km=Um,zm=X;function Ym(e,t,n){var i=t(e);return zm(e)?i:Km(i,n(e))}var Vm=Ym;function Jm(e,t){for(var n=-1,i=e==null?0:e.length,o=0,a=[];++n<i;){var s=e[n];t(s,n,e)&&(a[o++]=s)}return a}var Xm=Jm;function Qm(){return[]}var Zm=Qm,ep=Xm,tp=Zm,np=Object.prototype,ip=np.propertyIsEnumerable,Zi=Object.getOwnPropertySymbols,op=Zi?function(e){return e==null?[]:(e=Object(e),ep(Zi(e),function(t){return ip.call(e,t)}))}:tp,ap=op;function sp(e,t){for(var n=-1,i=Array(e);++n<e;)i[n]=t(n);return i}var Ea=sp,rp=9007199254740991,hp=/^(?:0|[1-9]\d*)$/;function lp(e,t){var n=typeof e;return t=t==null?rp:t,!!t&&(n=="number"||n!="symbol"&&hp.test(e))&&e>-1&&e%1==0&&e<t}var Sa=lp,up=Ea,dp=Rn,cp=X,fp=De.exports,mp=Sa,pp=Wn,gp=Object.prototype,wp=gp.hasOwnProperty;function bp(e,t){var n=cp(e),i=!n&&dp(e),o=!n&&!i&&fp(e),a=!n&&!i&&!o&&pp(e),s=n||i||o||a,l=s?up(e.length,String):[],d=l.length;for(var u in e)(t||wp.call(e,u))&&!(s&&(u=="length"||o&&(u=="offset"||u=="parent")||a&&(u=="buffer"||u=="byteLength"||u=="byteOffset")||mp(u,d)))&&l.push(u);return l}var yp=bp,vp=yp,Tp=ga,kp=Bn;function _p(e){return kp(e)?vp(e):Tp(e)}var Ln=_p,xp=Vm,Ip=ap,Ap=Ln;function Ep(e){return xp(e,Ap,Ip)}var Sp=Ep,eo=Sp,Np=1,Hp=Object.prototype,Cp=Hp.hasOwnProperty;function Op(e,t,n,i,o,a){var s=n&Np,l=eo(e),d=l.length,u=eo(t),r=u.length;if(d!=r&&!s)return!1;for(var f=d;f--;){var h=l[f];if(!(s?h in t:Cp.call(t,h)))return!1}var c=a.get(e),m=a.get(t);if(c&&m)return c==t&&m==e;var p=!0;a.set(e,t),a.set(t,e);for(var g=s;++f<d;){h=l[f];var w=e[h],v=t[h];if(i)var _=s?i(v,w,h,t,e,a):i(w,v,h,e,t,a);if(!(_===void 0?w===v||o(w,v,n,i,a):_)){p=!1;break}g||(g=h=="constructor")}if(p&&!g){var y=e.constructor,x=t.constructor;y!=x&&"constructor"in e&&"constructor"in t&&!(typeof y=="function"&&y instanceof y&&typeof x=="function"&&x instanceof x)&&(p=!1)}return a.delete(e),a.delete(t),p}var Pp=Op,zt=Ia,$p=Aa,Rp=Gm,jp=Pp,to=ka,no=X,io=De.exports,Bp=Wn,Wp=1,oo="[object Arguments]",ao="[object Array]",Qe="[object Object]",Fp=Object.prototype,so=Fp.hasOwnProperty;function Lp(e,t,n,i,o,a){var s=no(e),l=no(t),d=s?ao:to(e),u=l?ao:to(t);d=d==oo?Qe:d,u=u==oo?Qe:u;var r=d==Qe,f=u==Qe,h=d==u;if(h&&io(e)){if(!io(t))return!1;s=!0,r=!1}if(h&&!r)return a||(a=new zt),s||Bp(e)?$p(e,t,n,i,o,a):Rp(e,t,d,n,i,o,a);if(!(n&Wp)){var c=r&&so.call(e,"__wrapped__"),m=f&&so.call(t,"__wrapped__");if(c||m){var p=c?e.value():e,g=m?t.value():t;return a||(a=new zt),o(p,g,n,i,a)}}return h?(a||(a=new zt),jp(e,t,n,i,o,a)):!1}var Mp=Lp,Dp=Mp,ro=me;function Na(e,t,n,i,o){return e===t?!0:e==null||t==null||!ro(e)&&!ro(t)?e!==e&&t!==t:Dp(e,t,n,i,Na,o)}var Mn=Na,Gp=Ia,qp=Mn,Up=1,Kp=2;function zp(e,t,n,i){var o=n.length,a=o,s=!i;if(e==null)return!a;for(e=Object(e);o--;){var l=n[o];if(s&&l[2]?l[1]!==e[l[0]]:!(l[0]in e))return!1}for(;++o<a;){l=n[o];var d=l[0],u=e[d],r=l[1];if(s&&l[2]){if(u===void 0&&!(d in e))return!1}else{var f=new Gp;if(i)var h=i(u,r,d,e,t,f);if(!(h===void 0?qp(r,u,Up|Kp,i,f):h))return!1}}return!0}var Yp=zp,Vp=Ke;function Jp(e){return e===e&&!Vp(e)}var Ha=Jp,Xp=Ha,Qp=Ln;function Zp(e){for(var t=Qp(e),n=t.length;n--;){var i=t[n],o=e[i];t[n]=[i,o,Xp(o)]}return t}var eg=Zp;function tg(e,t){return function(n){return n==null?!1:n[e]===t&&(t!==void 0||e in Object(n))}}var Ca=tg,ng=Yp,ig=eg,og=Ca;function ag(e){var t=ig(e);return t.length==1&&t[0][2]?og(t[0][0],t[0][1]):function(n){return n===e||ng(n,e,t)}}var sg=ag,rg=fe,hg=me,lg="[object Symbol]";function ug(e){return typeof e=="symbol"||hg(e)&&rg(e)==lg}var Nt=ug,dg=X,cg=Nt,fg=/\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,mg=/^\w*$/;function pg(e,t){if(dg(e))return!1;var n=typeof e;return n=="number"||n=="symbol"||n=="boolean"||e==null||cg(e)?!0:mg.test(e)||!fg.test(e)||t!=null&&e in Object(t)}var Dn=pg,Oa=Fn,gg="Expected a function";function Gn(e,t){if(typeof e!="function"||t!=null&&typeof t!="function")throw new TypeError(gg);var n=function(){var i=arguments,o=t?t.apply(this,i):i[0],a=n.cache;if(a.has(o))return a.get(o);var s=e.apply(this,i);return n.cache=a.set(o,s)||a,s};return n.cache=new(Gn.Cache||Oa),n}Gn.Cache=Oa;var wg=Gn,bg=wg,yg=500;function vg(e){var t=bg(e,function(i){return n.size===yg&&n.clear(),i}),n=t.cache;return t}var Tg=vg,kg=Tg,_g=/[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g,xg=/\\(\\)?/g,Ig=kg(function(e){var t=[];return e.charCodeAt(0)===46&&t.push(""),e.replace(_g,function(n,i,o,a){t.push(o?a.replace(xg,"$1"):i||n)}),t}),Ag=Ig;function Eg(e,t){for(var n=-1,i=e==null?0:e.length,o=Array(i);++n<i;)o[n]=t(e[n],n,e);return o}var Sg=Eg,ho=xt,Ng=Sg,Hg=X,Cg=Nt,Og=1/0,lo=ho?ho.prototype:void 0,uo=lo?lo.toString:void 0;function Pa(e){if(typeof e=="string")return e;if(Hg(e))return Ng(e,Pa)+"";if(Cg(e))return uo?uo.call(e):"";var t=e+"";return t=="0"&&1/e==-Og?"-0":t}var Pg=Pa,$g=Pg;function Rg(e){return e==null?"":$g(e)}var jg=Rg,Bg=X,Wg=Dn,Fg=Ag,Lg=jg;function Mg(e,t){return Bg(e)?e:Wg(e,t)?[e]:Fg(Lg(e))}var $a=Mg,Dg=Nt,Gg=1/0;function qg(e){if(typeof e=="string"||Dg(e))return e;var t=e+"";return t=="0"&&1/e==-Gg?"-0":t}var Ht=qg,Ug=$a,Kg=Ht;function zg(e,t){t=Ug(t,e);for(var n=0,i=t.length;e!=null&&n<i;)e=e[Kg(t[n++])];return n&&n==i?e:void 0}var Ra=zg,Yg=Ra;function Vg(e,t,n){var i=e==null?void 0:Yg(e,t);return i===void 0?n:i}var Jg=Vg;function Xg(e,t){return e!=null&&t in Object(e)}var Qg=Xg,Zg=$a,ew=Rn,tw=X,nw=Sa,iw=jn,ow=Ht;function aw(e,t,n){t=Zg(t,e);for(var i=-1,o=t.length,a=!1;++i<o;){var s=ow(t[i]);if(!(a=e!=null&&n(e,s)))break;e=e[s]}return a||++i!=o?a:(o=e==null?0:e.length,!!o&&iw(o)&&nw(s,o)&&(tw(e)||ew(e)))}var sw=aw,rw=Qg,hw=sw;function lw(e,t){return e!=null&&hw(e,t,rw)}var uw=lw,dw=Mn,cw=Jg,fw=uw,mw=Dn,pw=Ha,gw=Ca,ww=Ht,bw=1,yw=2;function vw(e,t){return mw(e)&&pw(t)?gw(ww(e),t):function(n){var i=cw(n,e);return i===void 0&&i===t?fw(n,e):dw(t,i,bw|yw)}}var Tw=vw;function kw(e){return e}var ja=kw;function _w(e){return function(t){return t==null?void 0:t[e]}}var xw=_w,Iw=Ra;function Aw(e){return function(t){return Iw(t,e)}}var Ew=Aw,Sw=xw,Nw=Ew,Hw=Dn,Cw=Ht;function Ow(e){return Hw(e)?Sw(Cw(e)):Nw(e)}var Pw=Ow,$w=sg,Rw=Tw,jw=ja,Bw=X,Ww=Pw;function Fw(e){return typeof e=="function"?e:e==null?jw:typeof e=="object"?Bw(e)?Rw(e[0],e[1]):$w(e):Ww(e)}var Ba=Fw,Lw=Ba,Mw=Bn,Dw=Ln;function Gw(e){return function(t,n,i){var o=Object(t);if(!Mw(t)){var a=Lw(n);t=Dw(t),n=function(l){return a(o[l],l,o)}}var s=e(t,n,i);return s>-1?o[a?t[s]:s]:void 0}}var qw=Gw;function Uw(e,t,n,i){for(var o=e.length,a=n+(i?1:-1);i?a--:++a<o;)if(t(e[a],a,e))return a;return-1}var Kw=Uw,zw=/\s/;function Yw(e){for(var t=e.length;t--&&zw.test(e.charAt(t)););return t}var Vw=Yw,Jw=Vw,Xw=/^\s+/;function Qw(e){return e&&e.slice(0,Jw(e)+1).replace(Xw,"")}var Zw=Qw,eb=Zw,co=Ke,tb=Nt,fo=0/0,nb=/^[-+]0x[0-9a-f]+$/i,ib=/^0b[01]+$/i,ob=/^0o[0-7]+$/i,ab=parseInt;function sb(e){if(typeof e=="number")return e;if(tb(e))return fo;if(co(e)){var t=typeof e.valueOf=="function"?e.valueOf():e;e=co(t)?t+"":t}if(typeof e!="string")return e===0?e:+e;e=eb(e);var n=ib.test(e);return n||ob.test(e)?ab(e.slice(2),n?2:8):nb.test(e)?fo:+e}var Wa=sb,rb=Wa,mo=1/0,hb=17976931348623157e292;function lb(e){if(!e)return e===0?e:0;if(e=rb(e),e===mo||e===-mo){var t=e<0?-1:1;return t*hb}return e===e?e:0}var ub=lb,db=ub;function cb(e){var t=db(e),n=t%1;return t===t?n?t-n:t:0}var Fa=cb,fb=Kw,mb=Ba,pb=Fa,gb=Math.max;function wb(e,t,n){var i=e==null?0:e.length;if(!i)return-1;var o=n==null?0:pb(n);return o<0&&(o=gb(i+o,0)),fb(e,mb(t),o)}var bb=wb,yb=qw,vb=bb,Tb=yb(vb),Ct=Tb,kb=ja;function _b(e){return typeof e=="function"?e:kb}var xb=_b,Ib=Ea,Ab=xb,Eb=Fa,Sb=9007199254740991,Yt=4294967295,Nb=Math.min;function Hb(e,t){if(e=Eb(e),e<1||e>Sb)return[];var n=Yt,i=Nb(e,Yt);t=Ab(t),e-=Yt;for(var o=Ib(i,t);++n<e;)t(n);return o}var La=Hb,Cb=fe,Ob=me,Pb="[object Number]";function $b(e){return typeof e=="number"||Ob(e)&&Cb(e)==Pb}var Ma=$b,Rb=fe,jb=X,Bb=me,Wb="[object String]";function Fb(e){return typeof e=="string"||!jb(e)&&Bb(e)&&Rb(e)==Wb}var fn=Fb,Lb=Mn;function Mb(e,t){return Lb(e,t)}var Db=Mb;function Da(){return window.Book}const Ga=[{trigrams:[0,0,0],image:"\u2601\uFE0F",image_name:"cloud",name:"chien",structure:"Sense",motivation:"Creative",body:"head",animal:"\u{1F434}",animal_name:"horse",wilhelm:"Heaven"},{trigrams:[0,0,1],image:"\u{1F4A6}",image_name:"sweat_drops",structure:"Feel",motivation:"Serene",name:"tui",body:"mouth",animal:"\u{1F410}",animal_name:"goat",wilhelm:"Lake"},{trigrams:[0,1,0],image:"\u{1F525}",image_name:"fire",structure:"Think",motivation:"Attaching",name:"li",body:"eye",animal:"\u{1F426}",animal_name:"bird",wilhelm:"Flame"},{trigrams:[0,1,1],image:"\u26A1",image_name:"thunder",name:"chen",structure:"Spirit",motivation:"Exciting",body:"foot",animal:"\u{1F409}",animal_name:"dragon",wilhelm:"Thunder"},{trigrams:[1,0,0],image:"\u{1F32C}\uFE0F",image_name:"leaves",structure:"Sense",motivation:"Soft, Penetrating",name:"sun",body:"thigh",animal:"\u{1F413}",animal_name:"rooster",wilhelm:"Wind/Wood"},{trigrams:[1,0,1],image:"\u{1F30A}\uFE0F",image_name:"ocean",structure:"Soul",motivation:"Danger, Abyss",name:"kan",body:"ear",animal:"\u{1F416}",animal_name:"pig2",wilhelm:"Water"},{trigrams:[1,1,0],image:"\u{1F5FB}",image_name:"mount_fuji",name:"ken",structure:"Body",motivation:"Keeping still",body:"hand",animal:"\u{1F415}",animal_name:"dog2",wilhelm:"Mountain"},{trigrams:[1,1,1],image:"\u{1F30D}",image_name:":earth_africa",structure:"Will",motivation:"Recepetive",name:"kun",body:"belly",animal:"\u{1F404}",animal_name:":cow2",wilhelm:"Earth"}],po={chien:[1,43,14,34,9,5,26,11],tui:[10,58,38,54,61,60,41,19],li:[13,49,30,55,37,63,22,36],chen:[25,17,21,51,42,3,27,24],sun:[44,28,50,32,57,48,18,46],kan:[6,47,64,40,59,29,4,7],ken:[33,31,56,62,53,39,52,15],kun:[12,45,35,16,20,8,23,2]};function go(e){return Ct(Ga,t=>Db(t.trigrams,e))}function ct(e){return Ct(Ga,t=>t.name===e)}function qa(e){if(e.length>=1&&Ke(e[0])&&(e=e.map(l=>l.yin)),e.length!==6)throw Error("getHexagramNumberByKuas: Invalid kuas arrays.");let t=e.slice(0,3),n=e.slice(3),i=go(t),o=go(n),a=Object.keys(po).indexOf(o.name);return po[i.name][a]}function Gb(e){let t=Ct(Da(),{name:e});return t?t.number:-1}function Ua(e){let t=0;if(X(e))t=qa(e);else if(Ma(e))t=e;else if(fn(e))t=Gb(e);else throw Error("getHexagram",`Argument ${e} is not of valid type
            (Number,Name or Array of Kuas)`);return Ct(Da(),{number:t})}function qb(){return Math.random()>=.5}function Ub(e){switch(e){case 9:return"old-yang";case 8:return"young-yang";case 7:return"young-yin";case 6:return"old-yin";default:return"shit"}}function Kb(e){return e===9&&8||(e===6?7:e)}function zb(){const n=La(3,qb).map(s=>s?3:2).reduce((s,l)=>s+l);let i=Ub(n),a=Kb(n)===7?1:0;return{value:n,name:i,yin:a}}const Ka="PLAY_SET_HEXAGRAM",za="PLAY_CLEAR_HEXAGRAM",Yb="DETAILS_SET_HEXAGRAM",Vb="ICHING_BOOK_LOADED",Jb="PREFERENCES_SET";function Xb(e){return{type:Ka,payload:e}}function Qb(){return{type:za}}function Zb(){return(e,t)=>{const n=La(6,zb);return e(Xb(n)),Promise.resolve(n)}}function ey(){return T("div",{className:"yin",children:T("span",{})})}function ty(){return T("div",{className:"yang",children:[T("span",{}),T("span",{})]})}class ny extends H{render(){let{below:t,above:n}=this.props;(fn(t.title)||fn(n.title))&&(t=ct(t.title),n=ct(n.title));let i=n?this.trigramImage(n).reverse():"",o=t?this.trigramImage(t).reverse():"";return T("div",{className:"hex-img",children:[i,T("div",{className:"spacer"}),o]})}trigramImage(t){return t.trigrams.map(this.kuaTag)}kuaTag(t,n){return t?T(ty,{}):T(ey,{})}}class qn extends H{constructor(){super(...arguments);we(this,"state",{popover_open:!1,trigram:{name:"",wilhelm:"",body:"",animal:"",animal_name:"",image:"",image_name:""}})}render(){let{name:n,number:i,description:o,trigrams:a}=this.props.hexagram,s=this.innerTrigrams(this.props.display_trigrams||!1);return T("div",{className:"hexagram-card",onClick:this.props.onClick,children:[s,T("h1",{className:"title",children:o}),T(ny,{below:a.below,above:a.above})]})}innerTrigrams(n){let i=ct(this.props.hexagram.trigrams.above.title),o=ct(this.props.hexagram.trigrams.below.title);return n?T("div",{className:"trigrams",children:[T("div",{className:"above",children:T("div",{className:"label",children:i&&i.image})}),T("div",{className:"below",children:T("div",{className:"label",children:o&&o.image})})]}):T("div",{})}handleRequestClose(){this.setState({popover_open:!1})}}qn.defaultProps={onClick:()=>{},hexagram:{name:"",number:0,description:"",trigrams:{above:{title:""},below:{title:""}}}};class Ya extends H{constructor(){super(...arguments);we(this,"onGongoHold",n=>{this.gongo.className="gongo down",window.addEventListener("pointerup",this.onGongoRelease)});we(this,"onGongoRelease",n=>{if(window.removeEventListener("pointerup",this.onGongoRelease),this.gongo.className="gongo hit",this.props.preferences.enable_gongosound){let i=this.gongosound;i.play&&(i.currentTime=0,i.play())}this.throwDices()});we(this,"throwDices",n=>(n&&(n.preventDefault(),n.stopPropagation()),this.props.clearHexagram(),setTimeout(()=>{this.props.generateHexagram().then(i=>{this.setState({already_played:!0}),this.goToHexagram()})},this.props.animation_timeout),!1));we(this,"goToHexagram",()=>{this.props.history.push(`/details/${this.props.hexagram.number}`)})}getInitialState(){return{already_played:!1}}componentDidMount(){this.props.hexagram!==-1&&(this.props.clearHexagram(),this.textarea.value=""),this.setFocus()}render(){return T("div",{className:"playpage-container",children:T("form",{className:"canvas",action:"/",onSubmit:this.throwDices,children:[T("div",{className:"infoArea",children:[T("div",{className:"lblquestion",children:T("h2",{className:"title lblquestion-appear lblquestion-appear-active",children:T("label",{htmlFor:"question",children:"Ask a question"})})}),T("div",{className:"question",children:T("input",{ref:n=>this.textarea=n,id:"question",type:"text",className:"text",inputMode:"text",spellCheck:"false",autoFocus:!0})})]}),T("div",{className:"ichingDragArea",children:[T("input",{type:"submit",className:"gongo",value:" ",ref:n=>this.gongo=n,onPointerDown:this.onGongoHold,"aria-label":"Play"}),T("audio",{ref:n=>this.gongosound=n,src:ra("audio/bell-resonanceG.mp3"),preload:"auto"})]})]})})}setFocus(){this.textarea&&this.textarea.focus()}renderPreviewCard(n={}){let{hexagram:i}=this.props;return hc(i)?!1:T(qn,{hexagram:i,display_trigrams:!0,...n},i.number)}}Ya.defaultProps={hexagram:{},animation_timeout:30};var iy=ia(e=>({hexagram:Ua(e.play_hexagram),preferences:e.preferences}),e=>({generateHexagram:()=>e(Zb()),clearHexagram:()=>{e(Qb())}}))(Ya);class oy extends H{render(){return T("div",{className:"aboutpage-container",children:T("h1",{children:"About Page"})})}}var ay=ia(e=>({}))(oy),Va={exports:{}};/*!
  Copyright (c) 2018 Jed Watson.
  Licensed under the MIT License (MIT), see
  http://jedwatson.github.io/classnames
*/(function(e){(function(){var t={}.hasOwnProperty;function n(){for(var i=[],o=0;o<arguments.length;o++){var a=arguments[o];if(!!a){var s=typeof a;if(s==="string"||s==="number")i.push(a);else if(Array.isArray(a)){if(a.length){var l=n.apply(null,a);l&&i.push(l)}}else if(s==="object")if(a.toString===Object.prototype.toString)for(var d in a)t.call(a,d)&&a[d]&&i.push(d);else i.push(a.toString())}}return i.join(" ")}e.exports?(n.default=n,e.exports=n):window.classNames=n})()})(Va);var sy=Va.exports;class Ja extends H{render(){let t=Wa(this.props.match.params.number),n=Ua(t),i=ra(`img/tarot/Tao_${n.number}.jpg`);return T("div",{className:sy("detailspage-container"),children:[T(qn,{hexagram:n,display_trigrams:!0}),T("div",{className:"interpretation",children:[T("div",{className:"highlight",children:T("div",{className:"tarot",children:T("img",{src:i,alt:n.description})})}),this.formatText(n.interpretation.resume),T("h3",{children:"The Image"}),T("q",{className:"subQuote",children:this.formatQuote(n.interpretation.image.oracle)}),this.formatText(n.interpretation.image.image),T("h3",{children:"The Judgement"}),T("q",{className:"subQuote",children:this.formatQuote(n.interpretation.oracle)}),this.formatText(n.interpretation.judgment)]})]})}lineId(t){return t.split(`
`)[0].toLowerCase()}formatText(t){return t.split(`

`).map(a=>a.replace(/\n/g,"").trim()).map(a=>Sh(a,100)).flat(1/0).map(Ni).map(a=>T("p",{children:a}))}formatQuote(t){let n=t.replace(/\t/g,"");return Ni(n).split(`
`).join(`
`)}}Ja.defaultProps={hexagram:{number:0,name:"",description:"",trigrams:{above:{title:"",description:""},below:{title:"",description:""}},interpretation:{oracle:"",resume:"",judgment:"",image:{oracle:"",image:""},lines:[{poem:"",expl:""}]}}};function ry(e={},t){switch(t.type){case Jb:return Object.assign({[t.payload.name]:t.payload.value},e);default:return e}}function hy(e=-1,t){switch(t.type){case Ka:return Ma(t.payload)?t.payload:qa(t.payload);case za:return-1;default:return e}}function ly(e=-1,t){switch(t.type){case Yb:return t.payload;default:return e}}function uy(e=!1,t){switch(t.type){case Vb:return!0;default:return e}}var dy=Kr({preferences:ry,play_hexagram:hy,details_hexagram:ly,book_loaded:uy});wo(()=>Promise.resolve({}),["assets/index.089246e1.css"]);function cy(e){return ta(Vr(aa))(ea)(dy,e)}function fy(e=!1){const t=o=>()=>document.body.classList.add(`media-${o}`),n=o=>()=>document.body.classList.remove(`media-${o}`),i=o=>({match:t(o),unmatch:n(o)});e!==!1?t(e)():(Lt.register("screen and (min-width: 320px) and (max-width: 767px)",i("small")),Lt.register("screen and (min-width: 768px) and (max-width: 1223px)",i("medium")),Lt.register("screen and (min-width: 1224px)",i("large")))}function my(){let e=de(T(Xs,{store:window.store,children:T(ma,{})}),document.querySelector("#app-mount > .app-wrap"));return console.log("Load complete: ",performance.now()),document.getElementById("loading"),requestAnimationFrame(()=>{document.body.classList.toggle("loaded")}),e}function py(){const e=Ih(location.toString());let t=JSON.parse(localStorage.getItem("preferences")||"{}"),n=Object.assign(Si.preferences,t),i=Object.assign(Si,{preferences:n});window.store=cy(i),fy(e.media||!1);const o=()=>{window.react=us,window.app=my()};window.requestIdleCallback?requestIdleCallback(o):o()}py()});export default gy();
